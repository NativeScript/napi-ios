class NativeApiPointerHostObject final
 ...
 public:
  NativeApiPointerHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
    ...
    if (property == "toString") {
      ...
      return Function::createFromHostFunction(
          ...
          [pointer, kind](Runtime& runtime, const Value&, const Value*,
            ...
            return makeString(runtime, "[NativeApiQuickJS " + kind + " " +
                                           std::string(address) + "]");
          });
    }
...
class NativeApiReferenceHostObject final : public HostObject {
 public:
  NativeApiReferenceHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
                               NativeApiQuickJSType type, void* data, bool ownsData,
                               size_t byteLength = 0,
  ...
  const NativeApiQuickJSType& type() const { return type_; }
  void ensureStorage(Runtime& runtime, NativeApiQuickJSType type,
                     NativeApiQuickJSArgumentFrame& frame, size_t elements = 1);
...
class NativeApiStructObjectHostObject final : public HostObject {
 public:
  NativeApiStructObjectHostObject(
      ...
      std::shared_ptr<NativeApiQuickJSAggregateInfo> info,
  ...
  void* data() const { return data_; }
  std::shared_ptr<NativeApiQuickJSAggregateInfo> info() const { return info_; }
 ...
 private:
  std::shared_ptr<NativeApiQuickJSBridge> bridge_;
  std::shared_ptr<NativeApiQuickJSAggregateInfo> info_;
...
class NativeApiFastEnumerationIteratorHostObject final : public HostObject {
 public:
  NativeApiFastEnumerationIteratorHostObject(
      std::shared_ptr<NativeApiQuickJSBridge> bridge, id<NSFastEnumeration> collection)
 ...
 private:
  Value next(Runtime& runtime) {
    ...
    NativeApiQuickJSType valueType = nativeObjectReturnTypeForClass(object_getClass(value));
...
class NativeApiSuperHostObject final : public HostObject {
 public:
  NativeApiSuperHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
    ...
    if (property == "toString") {
      return Function::createFromHostFunction(
          ...
          [](Runtime& runtime, const Value&, const Value*, size_t) -> Value {
            return makeString(runtime, "[NativeApiQuickJSSuper]");
          });
    }
...
struct NativeApiQuickJSRuntimeMember {
  std::string name;
  std::string selectorName;
  size_t argumentCount = 0;
};

std::vector<NativeApiQuickJSRuntimeMember> runtimeMembersForClass(Class cls,
                                                                 bool staticMembers) {
  std::vector<NativeApiQuickJSRuntimeMember> members;
  if (cls == Nil) {
    return members;
  }
  ...
  while (current != Nil) {
    ...
    for (unsigned int i = 0; i < methodCount; i++) {
      ...
      members.push_back(NativeApiQuickJSRuntimeMember{
          .name = std::move(name),
...
class NativeApiObjectHostObject final
 ...
 public:
  NativeApiObjectHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
      ...
      if (resultObject != nil && classWrapper) {
        ...
        if (result.isObject()) {
          ...
          if (prototypeValue.isObject()) {
            ...
            SetNativeApiQuickJSObjectPrototype(runtime, resultValue, prototype);
          }
        }
      }
    }
      ...
      if (property == "objectAtIndex") {
        ...
        Function function = Function::createFromHostFunction(
            ...
            [bridge, weakSelf](Runtime& runtime, const Value&,
              ...
              NativeApiQuickJSType elementType = nativeObjectReturnType();
...
class NativeApiClassHostObject final : public HostObject {
 public:
  NativeApiClassHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
                           NativeApiSymbol symbol)
    ...
    if (property == "toString") {
      return Function::createFromHostFunction(
          ...
          [symbol = symbol_](Runtime& runtime, const Value&,
            ...
            return makeString(runtime,
                              "[NativeApiQuickJSClass " + symbol.name + "]");
          });
    }
...
Value makeNativeObjectValue(Runtime& runtime,
  ...
  if (prototypeValue.isObject()) {
    Object prototype = prototypeValue.asObject(runtime);
    SetNativeApiQuickJSObjectPrototype(runtime, result, prototype);
  }
...
class NativeApiProtocolHostObject final : public HostObject {
 public:
  NativeApiProtocolHostObject(std::shared_ptr<NativeApiQuickJSBridge> bridge,
                              NativeApiSymbol symbol)
      : bridge_(std::move(bridge)), symbol_(std::move(symbol)) {}
    ...
    if (property == "toString") {
      ...
      return Function::createFromHostFunction(
          ...
          [symbol](Runtime& runtime, const Value&, const Value*, size_t) -> Value {
            return makeString(runtime,
                              "[NativeApiQuickJSProtocol " + symbol.name + "]");
          });
    }
