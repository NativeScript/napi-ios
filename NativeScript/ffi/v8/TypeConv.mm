...
id objectFromEngineValue(Runtime& runtime,
                      ...
                      const Value& value, NativeApiV8ArgumentFrame& frame,
                      bool mutableString) {
...
size_t referenceElementStride(const NativeApiV8Type& type) {
...
void convertEngineFfiArgument(Runtime& runtime,
                           ...
                           void* target, NativeApiV8ArgumentFrame& frame) {
...
void NativeApiReferenceHostObject::ensureStorage(
    Runtime& runtime, NativeApiV8Type type, NativeApiV8ArgumentFrame& frame,
    size_t elements) {
  size_t elementCount = std::max<size_t>(elements, 1);
  NativeApiV8Type storageType = std::move(type);
...
std::optional<NativeApiV8Type> primitiveInteropTypeFromCode(int32_t code) {
...
std::optional<NativeApiV8Type> interopTypeFromValue(
  ...
  constructor.setProperty(
      ...
      Function::createFromHostFunction(
          ...
          [bridge, info](Runtime& runtime, const Value&, const Value* args,
            ...
            try {
              NativeApiV8ArgumentFrame leftFrame(1);
              convertAggregateArgument(runtime, bridge, type, args[0],
                                       left.data(), leftFrame);
              NativeApiV8ArgumentFrame rightFrame(1);
...
Object createInteropObject(Runtime& runtime,
  ...
  Function referenceConstructor = Function::createFromHostFunction(
      ...
      [bridge](Runtime& runtime, const Value&, const Value* args,
               size_t count) -> Value {
            NativeApiV8Type type = primitiveInteropType(metagen::mdTypePointer);
            ...
            std::optional<NativeApiV8Type> requestedType =
                firstArgumentIsType
