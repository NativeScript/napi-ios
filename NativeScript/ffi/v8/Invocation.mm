...
class NativeApiV8ReturnStorage {
 public:
  explicit NativeApiV8ReturnStorage(size_t size)
...
class NativeApiV8PointerFrame {
 public:
  explicit NativeApiV8PointerFrame(size_t count) : count_(count) {
...
Value constantToValue(Runtime& runtime,
  ...
  switch (evalKind) {
    ...
    case metagen::mdEvalString: {
      ...
      NativeApiV8Type stringObjectType;
  ...
  NativeApiV8Type type = parseMetadataEngineType(metadata, &typeOffset, bridge.get());
...
void prepareEngineArgument(Runtime& runtime,
                        const std::shared_ptr<NativeApiV8Bridge>& bridge,
                        const NativeApiV8Type& type, const Value& arg,
                        size_t index, NativeApiV8ArgumentFrame& frame) {
...
inline uint64_t dispatchIdForEngineSignature(
    const NativeApiV8Signature& signature, SignatureCallKind kind) {
...
bool tryCallFastEngineCFunction(
    ...
    void* function, const NativeApiV8Signature& signature, const Value* args,
    size_t count, Value* result);

Value callNativeFunctionPointer(
    Runtime& runtime, const std::shared_ptr<NativeApiV8Bridge>& bridge,
    const NativeApiV8Type& type, void* pointer, bool block, const Value* args,
    size_t count) {
  if (pointer == nullptr) {
  ...
  NativeApiV8PointerFrame values(signature->argumentTypes.size() + 1);
  if (block) {
  ...
  if (block) {
    auto literal = static_cast<NativeApiV8BlockLiteral*>(pointer);
...
Value wrapNativeFunctionPointer(Runtime& runtime,
                                ...
                                bool block) {
  const char* functionName = block ? "NativeApiV8Block" : "NativeApiV8FunctionPointer";
...
Value callCFunction(Runtime& runtime,
  ...
  NativeApiV8Signature& signature = prepared->signature;
  Value fastResult;
...
bool isFastEngineObjectType(const NativeApiV8Type& type) {
  switch (type.kind) {
...
bool isFastEngineSignedIntegerType(const NativeApiV8Type& type) {
  switch (type.kind) {
...
bool isFastEngineUnsignedIntegerType(const NativeApiV8Type& type) {
  switch (type.kind) {
...
bool readFastEngineObjectArgument(
    Runtime& runtime, const std::shared_ptr<NativeApiV8Bridge>& bridge,
    const NativeApiV8Type& type, const Value& value,
    NativeApiV8ArgumentFrame& frame, id* result) {
  if (result == nullptr) {
    return false;
  }
...
Value callFastEngineCFunctionWithReturn(
    Runtime& runtime, const std::shared_ptr<NativeApiV8Bridge>& bridge,
    void* function, NativeApiV8Type returnType, Args... nativeArgs) {
  bool dispatchingNativeCallToUI = shouldDispatchNativeCallToUI();
  bool retainedReturn = false;

  auto finalizeObjectReturn = [&](id object) -> Value {
    NativeApiV8Type effectiveReturnType = returnType;
...
bool isFastEngineCallableReturnType(const NativeApiV8Type& returnType) {
...
bool tryCallFastEngineCFunction(
  ...
  NativeApiV8ArgumentFrame frame(count);
...
Value callFastEngineObjCWithReturn(
    Runtime& runtime, const std::shared_ptr<NativeApiV8Bridge>& bridge,
    id receiver, SEL selector, NativeApiV8Type returnType,
...
Value callFastEngineObjC1(
    Runtime& runtime, const std::shared_ptr<NativeApiV8Bridge>& bridge,
    id receiver, SEL selector, const NativeApiV8Type& returnType,
...
prepareNativeApiV8ObjCInvocation(
  ...
  std::optional<NativeApiV8Signature> signature;
  std::optional<NativeApiV8Signature> runtimeSignature;
  if (member != nullptr &&
  ...
  auto prepared = std::make_shared<NativeApiV8PreparedObjCInvocation>();
...
Value callObjCSelector(Runtime& runtime,
  ...
  NativeApiV8PreparedObjCInvocation engineInvocation;
