...
id objectFromEngineValue(Runtime& runtime,
                      ...
                      const Value& value, NativeApiJSCArgumentFrame& frame,
                      bool mutableString) {
...
size_t referenceElementStride(const NativeApiJSCType& type) {
...
void convertEngineFfiArgument(Runtime& runtime,
                           ...
                           void* target, NativeApiJSCArgumentFrame& frame) {
...
void NativeApiReferenceHostObject::ensureStorage(
    Runtime& runtime, NativeApiJSCType type, NativeApiJSCArgumentFrame& frame,
    size_t elements) {
  size_t elementCount = std::max<size_t>(elements, 1);
  NativeApiJSCType storageType = std::move(type);
...
std::optional<NativeApiJSCType> primitiveInteropTypeFromCode(int32_t code) {
...
std::optional<NativeApiJSCType> interopTypeFromValue(
  ...
  constructor.setProperty(
      ...
      Function::createFromHostFunction(
          ...
          [bridge, info](Runtime& runtime, const Value&, const Value* args,
            ...
            try {
              NativeApiJSCArgumentFrame leftFrame(1);
              convertAggregateArgument(runtime, bridge, type, args[0],
                                       left.data(), leftFrame);
              NativeApiJSCArgumentFrame rightFrame(1);
...
Object createInteropObject(Runtime& runtime,
  ...
  Function referenceConstructor = Function::createFromHostFunction(
      ...
      [bridge](Runtime& runtime, const Value&, const Value* args,
               size_t count) -> Value {
            NativeApiJSCType type = primitiveInteropType(metagen::mdTypePointer);
            ...
            std::optional<NativeApiJSCType> requestedType =
                firstArgumentIsType
