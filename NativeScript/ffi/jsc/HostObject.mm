#ifndef NATIVESCRIPT_NATIVE_API_JSC_BACKEND_NAME
#define NATIVESCRIPT_NATIVE_API_JSC_BACKEND_NAME "jsc"
#endif

#ifndef NATIVESCRIPT_NATIVE_API_JSC_RUNTIME_NAME
#define NATIVESCRIPT_NATIVE_API_JSC_RUNTIME_NAME "jsc"
#endif

#ifndef NATIVESCRIPT_NATIVE_API_HAS_ENGINE_LAZY_GLOBALS
inline bool InstallNativeApiJSCLazyGlobal(
    Runtime&, std::shared_ptr<NativeApiJSCBridge>, const std::string&,
    const std::string&, bool) {
  return false;
}
#endif

struct NativeApiJSCSelectorGroupEntry {
...
class NativeApiHostObject final : public HostObject {
 public:
  explicit NativeApiHostObject(std::shared_ptr<NativeApiJSCBridge> bridge)
      : bridge_(std::move(bridge)) {}

  Value get(Runtime& runtime, const PropNameID& name) override {
    std::string property = name.utf8(runtime);
    if (property == "runtime") {
      return makeString(runtime, NATIVESCRIPT_NATIVE_API_JSC_RUNTIME_NAME);
    }
    if (property == "backend") {
      return makeString(runtime, NATIVESCRIPT_NATIVE_API_JSC_BACKEND_NAME);
    }
    ...
    if (property == "__defineLazyGlobal") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            return InstallNativeApiJSCLazyGlobal(runtime, bridge, name, kind,
                                                    force);
          });
    }
#endif
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            if (scheduler == nullptr) {
              throw JSError(
                  runtime,
                  "NativeApiJSC was installed without a UI scheduler.");
            }
    ...
    if (property == "__extendClass") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
                   size_t count) -> Value {
            return extendNativeApiJSCClass(runtime, bridge, args, count);
          });
    }
    if (property == "__invokeBase") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
                   size_t count) -> Value {
            return invokeNativeApiJSCBaseMethod(runtime, bridge, args, count);
          });
    }
    if (property == "__makeSelectorGroupFunction") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            auto selectors =
                std::make_shared<
                    std::vector<NativeApiJSCSelectorGroupEntry>>(
                    selectorCount);
            ...
            return CreateNativeApiJSCSelectorGroupFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            if (args[1].isObject()) {
              ...
              if (prototypeValue.isObject()) {
                ...
                SetNativeApiJSCObjectPrototype(runtime, instanceObject,
                                                 prototype);
              }
            }
            return Value::undefined();
    ...
    if (property == "CC_SHA256") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            NativeApiJSCArgumentFrame frame(3);
    ...
    if (property == "getFunction") {
      ...
      return Function::createFromHostFunction(
          ...
          [bridge](Runtime& runtime, const Value&, const Value* args,
            ...
            auto prepared =
                std::make_shared<NativeApiJSCPreparedCFunctionInvocation>();
