class NativeApiPointerHostObject final
 ...
 public:
  NativeApiPointerHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
    ...
    if (property == "toString") {
      ...
      return Function::createFromHostFunction(
          ...
          [pointer, kind](Runtime& runtime, const Value&, const Value*,
            ...
            return makeString(runtime, "[NativeApiHermes " + kind + " " +
                                           std::string(address) + "]");
          });
    }
...
class NativeApiReferenceHostObject final : public HostObject {
 public:
  NativeApiReferenceHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
                               NativeApiHermesType type, void* data, bool ownsData,
                               size_t byteLength = 0,
  ...
  const NativeApiHermesType& type() const { return type_; }
  void ensureStorage(Runtime& runtime, NativeApiHermesType type,
                     NativeApiHermesArgumentFrame& frame, size_t elements = 1);
...
class NativeApiStructObjectHostObject final : public HostObject {
 public:
  NativeApiStructObjectHostObject(
      ...
      std::shared_ptr<NativeApiHermesAggregateInfo> info,
  ...
  void* data() const { return data_; }
  std::shared_ptr<NativeApiHermesAggregateInfo> info() const { return info_; }
 ...
 private:
  std::shared_ptr<NativeApiHermesBridge> bridge_;
  std::shared_ptr<NativeApiHermesAggregateInfo> info_;
...
class NativeApiFastEnumerationIteratorHostObject final : public HostObject {
 public:
  NativeApiFastEnumerationIteratorHostObject(
      std::shared_ptr<NativeApiHermesBridge> bridge, id<NSFastEnumeration> collection)
 ...
 private:
  Value next(Runtime& runtime) {
    ...
    NativeApiHermesType valueType = nativeObjectReturnTypeForClass(object_getClass(value));
...
class NativeApiSuperHostObject final : public HostObject {
 public:
  NativeApiSuperHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
    ...
    if (property == "toString") {
      return Function::createFromHostFunction(
          ...
          [](Runtime& runtime, const Value&, const Value*, size_t) -> Value {
            return makeString(runtime, "[NativeApiHermesSuper]");
          });
    }
...
struct NativeApiHermesRuntimeMember {
  std::string name;
  std::string selectorName;
  size_t argumentCount = 0;
};

std::vector<NativeApiHermesRuntimeMember> runtimeMembersForClass(Class cls,
                                                                 bool staticMembers) {
  std::vector<NativeApiHermesRuntimeMember> members;
  if (cls == Nil) {
    return members;
  }
  ...
  while (current != Nil) {
    ...
    for (unsigned int i = 0; i < methodCount; i++) {
      ...
      members.push_back(NativeApiHermesRuntimeMember{
          .name = std::move(name),
...
class NativeApiObjectHostObject final
 ...
 public:
  NativeApiObjectHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
      ...
      if (resultObject != nil && classWrapper) {
        ...
        if (result.isObject()) {
          ...
          if (prototypeValue.isObject()) {
            ...
            SetNativeApiHermesObjectPrototype(runtime, resultValue, prototype);
          }
        }
      }
    }
      ...
      if (property == "objectAtIndex") {
        ...
        Function function = Function::createFromHostFunction(
            ...
            [bridge, weakSelf](Runtime& runtime, const Value&,
              ...
              NativeApiHermesType elementType = nativeObjectReturnType();
...
class NativeApiClassHostObject final : public HostObject {
 public:
  NativeApiClassHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
                           NativeApiSymbol symbol)
    ...
    if (property == "toString") {
      return Function::createFromHostFunction(
          ...
          [symbol = symbol_](Runtime& runtime, const Value&,
            ...
            return makeString(runtime,
                              "[NativeApiHermesClass " + symbol.name + "]");
          });
    }
...
Value makeNativeObjectValue(Runtime& runtime,
  ...
  if (prototypeValue.isObject()) {
    Object prototype = prototypeValue.asObject(runtime);
    SetNativeApiHermesObjectPrototype(runtime, result, prototype);
  }
...
class NativeApiProtocolHostObject final : public HostObject {
 public:
  NativeApiProtocolHostObject(std::shared_ptr<NativeApiHermesBridge> bridge,
                              NativeApiSymbol symbol)
      : bridge_(std::move(bridge)), symbol_(std::move(symbol)) {}
    ...
    if (property == "toString") {
      ...
      return Function::createFromHostFunction(
          ...
          [symbol](Runtime& runtime, const Value&, const Value*, size_t) -> Value {
            return makeString(runtime,
                              "[NativeApiHermesProtocol " + symbol.name + "]");
          });
    }
