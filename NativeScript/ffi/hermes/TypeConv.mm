...
id objectFromEngineValue(Runtime& runtime,
                      ...
                      const Value& value, NativeApiHermesArgumentFrame& frame,
                      bool mutableString) {
...
size_t referenceElementStride(const NativeApiHermesType& type) {
...
void convertEngineFfiArgument(Runtime& runtime,
                           ...
                           void* target, NativeApiHermesArgumentFrame& frame) {
...
Value convertNativeReturnValue(Runtime& runtime,
  ...
  switch (type.kind) {
    ...
    case metagen::mdTypeString: {
      ...
      NativeApiHermesType cStringType =
...
void NativeApiReferenceHostObject::ensureStorage(
    Runtime& runtime, NativeApiHermesType type, NativeApiHermesArgumentFrame& frame,
    size_t elements) {
  size_t elementCount = std::max<size_t>(elements, 1);
  NativeApiHermesType storageType = std::move(type);
...
std::optional<NativeApiHermesType> primitiveInteropTypeFromCode(int32_t code) {
...
std::optional<NativeApiHermesType> interopTypeFromValue(
  ...
  constructor.setProperty(
      ...
      Function::createFromHostFunction(
          ...
          [bridge, info](Runtime& runtime, const Value&, const Value* args,
            ...
            try {
              NativeApiHermesArgumentFrame leftFrame(1);
              convertAggregateArgument(runtime, bridge, type, args[0],
                                       left.data(), leftFrame);
              NativeApiHermesArgumentFrame rightFrame(1);
...
Object createInteropObject(Runtime& runtime,
  ...
  Function referenceConstructor = Function::createFromHostFunction(
      ...
      [bridge](Runtime& runtime, const Value&, const Value* args,
               size_t count) -> Value {
            NativeApiHermesType type = primitiveInteropType(metagen::mdTypePointer);
            ...
            std::optional<NativeApiHermesType> requestedType =
                firstArgumentIsType
