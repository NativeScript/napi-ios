...
v8::Local<v8::String> WrapModuleContent(v8::Isolate* isolate, const std::string& path) {
  ...
  if (IsJSONModule(path)) {
    ...
    return v8::String::NewFromUtf8(isolate, wrappedJsonModule.c_str()).ToLocalChecked();
  }
...
v8::MaybeLocal<v8::Module> CompileVirtualESModule(v8::Isolate* isolate,
  ...
  v8::ScriptOrigin origin(
      isolate,
      v8::String::NewFromUtf8(isolate, moduleId.c_str()).ToLocalChecked(),
...
void InitializeESModuleSystem(v8::Isolate* isolate) {
  ...
  isolate->SetHostInitializeImportMetaObjectCallback(
      [](v8::Local<v8::Context> context, v8::Local<v8::Module> module,
        ...
        v8::Isolate* isolate = context->GetIsolate();
        const std::string modulePath = GetModulePathFromRegistry(isolate, module);
        if (modulePath.empty()) {
          return;
        }
        ...
        v8::Local<v8::String> value =
            v8::String::NewFromUtf8(isolate, moduleURL.c_str()).ToLocalChecked();
