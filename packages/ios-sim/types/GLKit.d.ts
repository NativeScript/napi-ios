...
declare const GLKViewDrawableStencilFormat: {
  FormatNone: 0,
  Format8: 1,
};
...
declare const GLKViewDrawableMultisample: {
  MultisampleNone: 0,
  Multisample4X: 1,
};
...
declare class unnamed_12582821479479568070 {
  constructor(init?: unnamed_12582821479479568070);
  r: number;
  g: number;
  b: number;
}

declare class unnamed_12340535976615101828 {
  constructor(init?: unnamed_12340535976615101828);
  x: number;
  y: number;
  z: number;
}

declare class unnamed_2197886238850459225 {
  constructor(init?: unnamed_2197886238850459225);
  s: number;
  t: number;
}

declare class unnamed_13172991500963889220 {
  constructor(init?: unnamed_13172991500963889220);
  s: number;
  t: number;
  p: number;
}

declare class unnamed_10319513598835551847 {
  constructor(init?: unnamed_10319513598835551847);
  r: number;
  g: number;
  b: number;
  a: number;
...
declare class unnamed_10930225947019770746 {
  constructor(init?: unnamed_10930225947019770746);
  v: _GLKVector3;
  s: number;
}

declare class unnamed_4519787401010577554 {
  constructor(init?: unnamed_4519787401010577554);
  m00: number;
  m01: number;
  m02: number;
  m10: number;
...
declare class unnamed_11561157991423726082 {
  constructor(init?: unnamed_11561157991423726082);
  x: number;
  y: number;
  z: number;
  w: number;
...
declare class unnamed_14001846259637370886 {
  constructor(init?: unnamed_14001846259637370886);
  s: number;
  t: number;
  p: number;
  q: number;
...
declare class unnamed_16380904892728329834 {
  constructor(init?: unnamed_16380904892728329834);
  m00: number;
  m01: number;
  m02: number;
  m03: number;
...
declare class unnamed_12456468195855664145 {
  constructor(init?: unnamed_12456468195855664145);
  x: number;
  y: number;
  z: number;
  w: number;
...
declare class unnamed_16121221547445344592 {
  constructor(init?: unnamed_16121221547445344592);
  x: number;
  y: number;
}

declare class unnamed_1218265887733169718 {
  constructor(init?: unnamed_1218265887733169718);
  m00: number;
  m01: number;
  m10: number;
  m11: number;
...
declare interface GLKViewControllerDelegate extends NSObjectProtocol {
...
declare class GLKViewControllerDelegate extends NativeObject implements GLKViewControllerDelegate {
}

declare interface GLKViewDelegate extends NSObjectProtocol {
  glkViewDrawInRect(view: GLKView, rect: CGRect): void;
}

declare class GLKViewDelegate extends NativeObject implements GLKViewDelegate {
}
...
declare class GLKView extends UIView implements NSCoding {
  ...
  drawableColorFormat: interop.Enum<typeof GLKViewDrawableColorFormat>;

  drawableDepthFormat: interop.Enum<typeof GLKViewDrawableDepthFormat>;

  drawableStencilFormat: interop.Enum<typeof GLKViewDrawableStencilFormat>;

  drawableMultisample: interop.Enum<typeof GLKViewDrawableMultisample>;
  ...
  setDelegate(delegate: GLKViewDelegate | null): void;

  setContext(context: EAGLContext): void;

  setDrawableColorFormat(drawableColorFormat: interop.Enum<typeof GLKViewDrawableColorFormat>): void;

  setDrawableDepthFormat(drawableDepthFormat: interop.Enum<typeof GLKViewDrawableDepthFormat>): void;

  setDrawableStencilFormat(drawableStencilFormat: interop.Enum<typeof GLKViewDrawableStencilFormat>): void;

  setDrawableMultisample(drawableMultisample: interop.Enum<typeof GLKViewDrawableMultisample>): void;
...
declare class GLKViewController extends UIViewController implements NSCoding, GLKViewDelegate {
  ...
  setDelegate(delegate: GLKViewControllerDelegate | null): void;
  ...
  setPauseOnWillResignActive(pauseOnWillResignActive: boolean): void;

  setResumeOnDidBecomeActive(resumeOnDidBecomeActive: boolean): void;
