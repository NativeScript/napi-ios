...
declare class AudioUnitEvent {
  ...
  mArgument: unnamed_5011151099795851435;
}
...
declare class unnamed_7498483748601460325 {
  constructor(init?: unnamed_7498483748601460325);
...
declare class unnamed_5619785962953706870 {
  constructor(init?: unnamed_5619785962953706870);
  bufferOffset: number;
  value: number;
}
...
declare class AUNodeInteraction {
  ...
  nodeInteraction: unnamed_3012128869958512076;
}
...
declare class AudioUnitParameterEvent {
  ...
  eventValues: unnamed_12888614052899384184;
}
...
type unnamed_5011151099795851435Descriptor = 
  | { mParameter: AudioUnitParameter }
  | { mProperty: AudioUnitProperty };

declare class unnamed_5011151099795851435 {
  constructor(init?: unnamed_5011151099795851435Descriptor);
  mParameter: AudioUnitParameter;
  mProperty: AudioUnitProperty;
}

type unnamed_3012128869958512076Descriptor = 
  | { connection: AudioUnitNodeConnection }
  | { inputCallback: AUNodeRenderCallback };

declare class unnamed_3012128869958512076 {
  constructor(init?: unnamed_3012128869958512076Descriptor);
  connection: AudioUnitNodeConnection;
  inputCallback: AUNodeRenderCallback;
}
...
type unnamed_12888614052899384184Descriptor = 
  | { ramp: unnamed_7498483748601460325 }
  | { immediate: unnamed_5619785962953706870 };

declare class unnamed_12888614052899384184 {
  constructor(init?: unnamed_12888614052899384184Descriptor);
  ramp: unnamed_7498483748601460325;
  immediate: unnamed_5619785962953706870;
}
