...
declare class AudioUnitEvent {
  ...
  mArgument: unnamed_5555750661070878809;
}
...
declare class unnamed_10970584292751396952 {
  constructor(init?: unnamed_10970584292751396952);
  bufferOffset: number;
  value: number;
}
...
declare class AudioUnitParameterEvent {
  ...
  eventValues: unnamed_14438123811472278623;
}
...
declare class unnamed_681659680267493773 {
  constructor(init?: unnamed_681659680267493773);
...
declare class AUNodeInteraction {
  ...
  nodeInteraction: unnamed_16030958422490936140;
}
...
type unnamed_14438123811472278623Descriptor = 
  | { ramp: unnamed_681659680267493773 }
  | { immediate: unnamed_10970584292751396952 };

declare class unnamed_14438123811472278623 {
  constructor(init?: unnamed_14438123811472278623Descriptor);
  ramp: unnamed_681659680267493773;
  immediate: unnamed_10970584292751396952;
}

type unnamed_5555750661070878809Descriptor = 
  | { mParameter: AudioUnitParameter }
  | { mProperty: AudioUnitProperty };

declare class unnamed_5555750661070878809 {
  constructor(init?: unnamed_5555750661070878809Descriptor);
  mParameter: AudioUnitParameter;
  mProperty: AudioUnitProperty;
}

type unnamed_16030958422490936140Descriptor = 
  | { connection: AudioUnitNodeConnection }
  | { inputCallback: AUNodeRenderCallback };

declare class unnamed_16030958422490936140 {
  constructor(init?: unnamed_16030958422490936140Descriptor);
  connection: AudioUnitNodeConnection;
  inputCallback: AUNodeRenderCallback;
}
