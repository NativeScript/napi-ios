...
declare class NSUserActivity extends NSObject {
  ...
  setExternalMediaContentIdentifier(externalMediaContentIdentifier: string | null): void;
  ...
  setShortcutAvailability(shortcutAvailability: interop.Enum<typeof INShortcutAvailabilityOptions>): void;
...
declare class NSItemProvider extends NSObject implements NSCopying {
  ...
  setTeamData(teamData: NSData): void;

  setPreferredPresentationSize(preferredPresentationSize: CGSize): void;

  setPreferredPresentationStyle(preferredPresentationStyle: interop.Enum<typeof UIPreferredPresentationStyle>): void;
...
declare class NSDate extends NSObject implements NSCopying, NSSecureCoding {
  ...
  static dateWithSRAbsoluteTime<This extends abstract new (...args: any) => any>(this: This, time: number): InstanceType<This>;
...
declare class NSExtensionContext extends NSObject {
  ...
  loadBroadcastingApplicationInfoWithCompletion(handler: (p1: string, p2: string, p3: UIImage) => void | null): void;

  completeRequestWithBroadcastURLBroadcastConfigurationSetupInfo(broadcastURL: NSURL, broadcastConfiguration: RPBroadcastConfiguration, setupInfo: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;
  ...
  widgetLargestAvailableDisplayMode: interop.Enum<typeof NCWidgetDisplayMode>;

  readonly widgetActiveDisplayMode: interop.Enum<typeof NCWidgetDisplayMode>;

  widgetMaximumSizeForDisplayMode(displayMode: interop.Enum<typeof NCWidgetDisplayMode>): CGSize;

  setWidgetLargestAvailableDisplayMode(widgetLargestAvailableDisplayMode: interop.Enum<typeof NCWidgetDisplayMode>): void;
}
...
declare class NSURLSessionConfiguration extends NSObject implements NSCopying {
  ...
  setMultipathServiceType(multipathServiceType: interop.Enum<typeof NSURLSessionMultipathServiceType>): void;
