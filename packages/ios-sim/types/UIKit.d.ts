...
declare interface UIContentView extends NSObjectProtocol {
  ...
  setConfiguration(configuration: UIContentConfiguration): void;
}
...
declare interface UIDragDropSession extends NSObjectProtocol {
  ...
  readonly restrictedToDraggingApplication: boolean;
  ...
  isRestrictedToDraggingApplication(): boolean;
}
...
declare interface UISearchSuggestion extends NSObjectProtocol {
  ...
  setRepresentedObject(representedObject: interop.Object | null): void;
}
...
declare interface UITextPasteConfigurationSupporting extends UIPasteConfigurationSupporting {
  ...
  setPasteDelegate(pasteDelegate: UITextPasteDelegate | null): void;
}
...
declare interface UITextDroppable extends UITextInput, UITextPasteConfigurationSupporting {
  ...
  readonly textDropActive: boolean;

  setTextDropDelegate(textDropDelegate: UITextDropDelegate | null): void;

  isTextDropActive(): boolean;
}
...
declare interface UILookToDictateCapable extends NSObjectProtocol {
  ...
  setLookToDictateEnabled(lookToDictateEnabled: boolean): void;
}
...
declare interface UITextSelectionHandleView extends UICoordinateSpace {
  ...
  setDirection(direction: interop.Enum<typeof NSDirectionalRectEdge>): void;

  isVertical(): boolean;

  setCustomShape(customShape: UIBezierPath | null): void;
}
...
declare interface UITextDraggable extends UITextInput {
  ...
  readonly textDragActive: boolean;

  textDragOptions: interop.Enum<typeof UITextDragOptions>;

  setTextDragDelegate(textDragDelegate: UITextDragDelegate | null): void;

  isTextDragActive(): boolean;

  setTextDragOptions(textDragOptions: interop.Enum<typeof UITextDragOptions>): void;
}
...
declare interface UIPasteConfigurationSupporting extends NSObjectProtocol {
  ...
  setPasteConfiguration(pasteConfiguration: UIPasteConfiguration | null): void;
}
...
declare interface NSTextStorageObserving extends NSObjectProtocol {
  ...
  setTextStorage(textStorage: NSTextStorage | null): void;
}
...
declare interface UIAccessibilityContentSizeCategoryImageAdjusting extends NSObjectProtocol {
  ...
  setAdjustsImageSizeForAccessibilityContentSizeCategory(adjustsImageSizeForAccessibilityContentSizeCategory: boolean): void;
}
...
declare interface UIDragSession extends UIDragDropSession {
  ...
  setLocalContext(localContext: interop.Object | null): void;
}
...
declare interface UIApplicationDelegate extends NSObjectProtocol {
  ...
  setWindow?(window: UIWindow): void;
}
...
declare interface UIDropSession extends UIDragDropSession, NSProgressReporting {
  ...
  setProgressIndicatorStyle(progressIndicatorStyle: interop.Enum<typeof UIDropSessionProgressIndicatorStyle>): void;
}
...
declare interface NSCollectionLayoutVisibleItem extends NSObjectProtocol, UIDynamicItem {
  ...
  setTransform3D(transform3D: CATransform3D): void;
}
...
declare interface UISpringLoadedInteractionContext extends NSObjectProtocol {
  ...
  setTargetView(targetView: UIView | null): void;

  setTargetItem(targetItem: interop.Object | null): void;
}
...
declare interface UIViewAnimating extends NSObjectProtocol {
  ...
  setFractionComplete(fractionComplete: number): void;
}
...
declare interface UIContextMenuInteractionCommitAnimating extends UIContextMenuInteractionAnimating {
  ...
  setPreferredCommitStyle(preferredCommitStyle: interop.Enum<typeof UIContextMenuInteractionCommitStyle>): void;
}
...
declare interface UIMutableTraits extends NSObjectProtocol {
  ...
  setLayoutDirection(layoutDirection: interop.Enum<typeof UITraitEnvironmentLayoutDirection>): void;

  setDisplayScale(displayScale: number): void;

  setHorizontalSizeClass(horizontalSizeClass: interop.Enum<typeof UIUserInterfaceSizeClass>): void;

  setVerticalSizeClass(verticalSizeClass: interop.Enum<typeof UIUserInterfaceSizeClass>): void;

  setForceTouchCapability(forceTouchCapability: interop.Enum<typeof UIForceTouchCapability>): void;

  setPreferredContentSizeCategory(preferredContentSizeCategory: string): void;

  setDisplayGamut(displayGamut: interop.Enum<typeof UIDisplayGamut>): void;

  setAccessibilityContrast(accessibilityContrast: interop.Enum<typeof UIAccessibilityContrast>): void;

  setUserInterfaceLevel(userInterfaceLevel: interop.Enum<typeof UIUserInterfaceLevel>): void;

  setLegibilityWeight(legibilityWeight: interop.Enum<typeof UILegibilityWeight>): void;

  setActiveAppearance(activeAppearance: interop.Enum<typeof UIUserInterfaceActiveAppearance>): void;

  setToolbarItemPresentationSize(toolbarItemPresentationSize: interop.Enum<typeof UINSToolbarItemPresentationSize>): void;

  setImageDynamicRange(imageDynamicRange: interop.Enum<typeof UIImageDynamicRange>): void;

  setSceneCaptureState(sceneCaptureState: interop.Enum<typeof UISceneCaptureState>): void;
...
declare interface UITextInputTraits extends NSObjectProtocol {
  ...
  setSpellCheckingType?(spellCheckingType: interop.Enum<typeof UITextSpellCheckingType>): void;

  setSmartQuotesType?(smartQuotesType: interop.Enum<typeof UITextSmartQuotesType>): void;

  setSmartDashesType?(smartDashesType: interop.Enum<typeof UITextSmartDashesType>): void;

  setSmartInsertDeleteType?(smartInsertDeleteType: interop.Enum<typeof UITextSmartInsertDeleteType>): void;

  setInlinePredictionType?(inlinePredictionType: interop.Enum<typeof UITextInlinePredictionType>): void;

  setMathExpressionCompletionType?(mathExpressionCompletionType: interop.Enum<typeof UITextMathExpressionCompletionType>): void;

  setKeyboardType?(keyboardType: interop.Enum<typeof UIKeyboardType>): void;

  setKeyboardAppearance?(keyboardAppearance: interop.Enum<typeof UIKeyboardAppearance>): void;

  setReturnKeyType?(returnKeyType: interop.Enum<typeof UIReturnKeyType>): void;

  setEnablesReturnKeyAutomatically?(enablesReturnKeyAutomatically: boolean): void;

  isSecureTextEntry?(): boolean;

  setSecureTextEntry?(secureTextEntry: boolean): void;

  setTextContentType?(textContentType: string): void;
...
declare interface UITextSelectionHighlightView extends UICoordinateSpace {
  ...
  setSelectionRects(selectionRects: NSArray<interop.Object> | Array<interop.Object>): void;
}
...
declare interface UITextInput extends UIKeyInput {
  ...
  setMarkedTextStyle(markedTextStyle: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;

  setInputDelegate(inputDelegate: UITextInputDelegate | null): void;

  setSelectionAffinity?(selectionAffinity: interop.Enum<typeof UITextStorageDirection>): void;
...
declare class UIContentUnavailableView extends UIView implements UIContentView {
  ...
  setConfiguration(configuration: UIContentUnavailableConfiguration): void;
...
declare class NSTextContentManager extends NSObject implements NSTextElementProvider, NSSecureCoding {
  ...
  setPrimaryTextLayoutManager(primaryTextLayoutManager: NSTextLayoutManager | null): void;

  setAutomaticallySynchronizesTextLayoutManagers(automaticallySynchronizesTextLayoutManagers: boolean): void;

  setAutomaticallySynchronizesToBackingStore(automaticallySynchronizesToBackingStore: boolean): void;
...
declare class UITableViewDropPlaceholder extends UITableViewPlaceholder {
  ...
  setPreviewParametersProvider(previewParametersProvider: (p1: UITableViewCell) => UIDragPreviewParameters | null): void;
}
...
declare class UIConversationEntry extends NSObject {
  ...
  setSenderIdentifier(senderIdentifier: string): void;

  setSentDate(sentDate: NSDate): void;

  setEntryIdentifier(entryIdentifier: string): void;

  setReplyThreadIdentifier(replyThreadIdentifier: string | null): void;

  setPrimaryRecipientIdentifiers(primaryRecipientIdentifiers: NSSet): void;
}
...
declare class UIView extends UIResponder implements NSCoding, UIAppearance, UIAppearanceContainer, UIDynamicItem, UITraitEnvironment, UICoordinateSpace, UIFocusItem, UIFocusItemContainer, CALayerDelegate {
  ...
  setFocusGroupIdentifier(focusGroupIdentifier: string): void;

  setFocusGroupPriority(focusGroupPriority: number): void;

  setFocusEffect(focusEffect: UIFocusEffect): void;

  setSemanticContentAttribute(semanticContentAttribute: interop.Enum<typeof UISemanticContentAttribute>): void;
  ...
  setContentScaleFactor(contentScaleFactor: number): void;

  setAnchorPoint(anchorPoint: CGPoint): void;

  isMultipleTouchEnabled(): boolean;

  setMultipleTouchEnabled(multipleTouchEnabled: boolean): void;

  isExclusiveTouch(): boolean;

  setExclusiveTouch(exclusiveTouch: boolean): void;

  setAutoresizesSubviews(autoresizesSubviews: boolean): void;

  setAutoresizingMask(autoresizingMask: interop.Enum<typeof UIViewAutoresizing>): void;
  ...
  setLayoutMargins(layoutMargins: UIEdgeInsets): void;

  setDirectionalLayoutMargins(directionalLayoutMargins: NSDirectionalEdgeInsets): void;

  setPreservesSuperviewLayoutMargins(preservesSuperviewLayoutMargins: boolean): void;

  setInsetsLayoutMarginsFromSafeArea(insetsLayoutMarginsFromSafeArea: boolean): void;
  ...
  setClearsContextBeforeDrawing(clearsContextBeforeDrawing: boolean): void;

  isHidden(): boolean;

  setHidden(hidden: boolean): void;

  setContentMode(contentMode: interop.Enum<typeof UIViewContentMode>): void;

  setContentStretch(contentStretch: CGRect): void;

  setMaskView(maskView: UIView): void;

  setTintColor(tintColor: UIColor | null): void;

  setTintAdjustmentMode(tintAdjustmentMode: interop.Enum<typeof UIViewTintAdjustmentMode>): void;
  ...
  setGestureRecognizers(gestureRecognizers: NSArray<interop.Object> | Array<interop.Object>): void;
  ...
  setMotionEffects(motionEffects: NSArray<interop.Object> | Array<interop.Object>): void;
  ...
  setRestorationIdentifier(restorationIdentifier: string): void;
  ...
  setMinimumContentSizeCategory(minimumContentSizeCategory: string): void;

  setMaximumContentSizeCategory(maximumContentSizeCategory: string): void;
  ...
  setInteractions(interactions: NSArray<interop.Object> | Array<interop.Object>): void;

  accessibilityIgnoresInvertColors: boolean;

  setAccessibilityIgnoresInvertColors(accessibilityIgnoresInvertColors: boolean): void;
  ...
  setShowsLargeContentViewer(showsLargeContentViewer: boolean): void;

  setLargeContentTitle(largeContentTitle: string): void;

  setLargeContentImage(largeContentImage: UIImage): void;

  setScalesLargeContentImage(scalesLargeContentImage: boolean): void;

  setLargeContentImageInsets(largeContentImageInsets: UIEdgeInsets): void;

  hoverStyle: UIHoverStyle;

  setHoverStyle(hoverStyle: UIHoverStyle): void;
...
declare class UIListContentTextProperties extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setColorTransformer(colorTransformer: (p1: UIColor) => UIColor | null): void;

  setAlignment(alignment: interop.Enum<typeof UIListContentTextAlignment>): void;
  ...
  setTransform(transform: interop.Enum<typeof UIListContentTextTransform>): void;
...
declare class UILayoutGuide extends NSObject implements NSCoding {
  ...
  setOwningView(owningView: UIView | null): void;
...
declare class UITextFormattingViewControllerFormattingDescriptor extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setFonts(fonts: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setTextColors(textColors: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setLineHeight(lineHeight: number): void;

  setUnderlinePresent(underlinePresent: boolean): void;

  setStrikethroughPresent(strikethroughPresent: boolean): void;

  setTextAlignments(textAlignments: NSSet): void;

  setTextLists(textLists: NSSet): void;

  setHighlights(highlights: NSSet): void;

  setFormattingStyleKey(formattingStyleKey: string | null): void;
...
declare class UITableViewHeaderFooterView extends UIView {
  ...
  setConfigurationUpdateHandler(configurationUpdateHandler: (p1: UITableViewHeaderFooterView, p2: UIViewConfigurationState) => void): void;

  setContentConfiguration(contentConfiguration: UIContentConfiguration): void;

  setAutomaticallyUpdatesContentConfiguration(automaticallyUpdatesContentConfiguration: boolean): void;

  setBackgroundConfiguration(backgroundConfiguration: UIBackgroundConfiguration): void;

  setAutomaticallyUpdatesBackgroundConfiguration(automaticallyUpdatesBackgroundConfiguration: boolean): void;
...
declare class UIAlertController extends UIViewController {
  ...
  setPreferredAction(preferredAction: UIAlertAction): void;

  setTitle(title: string | null): void;

  setMessage(message: string | null): void;

  setSeverity(severity: interop.Enum<typeof UIAlertControllerSeverity>): void;
}
...
declare class UITableView extends UIScrollView implements NSCoding, UIDataSourceTranslating {
  ...
  setPrefetchingEnabled(prefetchingEnabled: boolean): void;

  setDragDelegate(dragDelegate: UITableViewDragDelegate): void;

  setDropDelegate(dropDelegate: UITableViewDropDelegate): void;

  setRowHeight(rowHeight: number): void;

  setSectionHeaderHeight(sectionHeaderHeight: number): void;

  setSectionFooterHeight(sectionFooterHeight: number): void;

  setEstimatedRowHeight(estimatedRowHeight: number): void;

  setEstimatedSectionHeaderHeight(estimatedSectionHeaderHeight: number): void;

  setEstimatedSectionFooterHeight(estimatedSectionFooterHeight: number): void;

  setFillerRowHeight(fillerRowHeight: number): void;

  setSectionHeaderTopPadding(sectionHeaderTopPadding: number): void;

  setSeparatorInset(separatorInset: UIEdgeInsets): void;

  setSeparatorInsetReference(separatorInsetReference: interop.Enum<typeof UITableViewSeparatorInsetReference>): void;

  setSelfSizingInvalidation(selfSizingInvalidation: interop.Enum<typeof UITableViewSelfSizingInvalidation>): void;

  setBackgroundView(backgroundView: UIView): void;
  ...
  setSectionIndexMinimumDisplayRowCount(sectionIndexMinimumDisplayRowCount: number): void;

  setSectionIndexColor(sectionIndexColor: UIColor): void;

  setSectionIndexBackgroundColor(sectionIndexBackgroundColor: UIColor): void;

  setSectionIndexTrackingBackgroundColor(sectionIndexTrackingBackgroundColor: UIColor): void;

  setSeparatorStyle(separatorStyle: interop.Enum<typeof UITableViewCellSeparatorStyle>): void;

  setSeparatorColor(separatorColor: UIColor): void;

  setSeparatorEffect(separatorEffect: UIVisualEffect): void;

  setCellLayoutMarginsFollowReadableWidth(cellLayoutMarginsFollowReadableWidth: boolean): void;

  setInsetsContentViewsToSafeArea(insetsContentViewsToSafeArea: boolean): void;

  setTableHeaderView(tableHeaderView: UIView | null): void;

  setTableFooterView(tableFooterView: UIView | null): void;

  setRemembersLastFocusedIndexPath(remembersLastFocusedIndexPath: boolean): void;

  setSelectionFollowsFocus(selectionFollowsFocus: boolean): void;

  setAllowsFocus(allowsFocus: boolean): void;

  setAllowsFocusDuringEditing(allowsFocusDuringEditing: boolean): void;

  setDragInteractionEnabled(dragInteractionEnabled: boolean): void;

  setContentHuggingElements(contentHuggingElements: interop.Enum<typeof UITableViewContentHuggingElements>): void;
...
declare class NSCollectionLayoutSection extends NSObject implements NSCopying {
  ...
  setInterGroupSpacing(interGroupSpacing: number): void;

  setContentInsetsReference(contentInsetsReference: interop.Enum<typeof UIContentInsetsReference>): void;

  setSupplementaryContentInsetsReference(supplementaryContentInsetsReference: interop.Enum<typeof UIContentInsetsReference>): void;

  setOrthogonalScrollingBehavior(orthogonalScrollingBehavior: interop.Enum<typeof UICollectionLayoutSectionOrthogonalScrollingBehavior>): void;

  setBoundarySupplementaryItems(boundarySupplementaryItems: NSArray<interop.Object> | Array<interop.Object>): void;

  setVisibleItemsInvalidationHandler(visibleItemsInvalidationHandler: (p1: NSArray<interop.Object> | Array<interop.Object>, p2: CGPoint, p3: NSCollectionLayoutEnvironment) => void | null): void;

  setDecorationItems(decorationItems: NSArray<interop.Object> | Array<interop.Object>): void;

  supplementariesFollowContentInsets: boolean;

  setSupplementariesFollowContentInsets(supplementariesFollowContentInsets: boolean): void;
...
declare class UISearchController extends UIViewController implements UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
  ...
  setSearchResultsUpdater(searchResultsUpdater: UISearchResultsUpdating | null): void;

  isActive(): boolean;

  setActive(active: boolean): void;

  setDelegate(delegate: UISearchControllerDelegate | null): void;

  setDimsBackgroundDuringPresentation(dimsBackgroundDuringPresentation: boolean): void;

  setObscuresBackgroundDuringPresentation(obscuresBackgroundDuringPresentation: boolean): void;

  setHidesNavigationBarDuringPresentation(hidesNavigationBarDuringPresentation: boolean): void;

  setAutomaticallyShowsSearchResultsController(automaticallyShowsSearchResultsController: boolean): void;

  setShowsSearchResultsController(showsSearchResultsController: boolean): void;

  setAutomaticallyShowsCancelButton(automaticallyShowsCancelButton: boolean): void;

  setAutomaticallyShowsScopeBar(automaticallyShowsScopeBar: boolean): void;

  setScopeBarActivation(scopeBarActivation: interop.Enum<typeof UISearchControllerScopeBarActivation>): void;

  setSearchSuggestions(searchSuggestions: NSArray<interop.Object> | Array<interop.Object>): void;

  setIgnoresSearchSuggestionsForSearchBarPlacementStacked(ignoresSearchSuggestionsForSearchBarPlacementStacked: boolean): void;
...
declare class UIButton extends UIControl implements NSCoding {
  ...
  setConfiguration(configuration: UIButtonConfiguration): void;

  setConfigurationUpdateHandler(configurationUpdateHandler: (p1: UIButton) => void): void;

  setAutomaticallyUpdatesConfiguration(automaticallyUpdatesConfiguration: boolean): void;
  ...
  setRole(role: interop.Enum<typeof UIButtonRole>): void;

  isPointerInteractionEnabled(): boolean;

  setPointerInteractionEnabled(pointerInteractionEnabled: boolean): void;

  setPointerStyleProvider(pointerStyleProvider: (p1: UIButton, p2: UIPointerEffect, p3: UIPointerShape) => UIPointerStyle): void;
  ...
  setTitleShadowOffset(titleShadowOffset: CGSize): void;

  contentEdgeInsets: UIEdgeInsets;

  setContentEdgeInsets(contentEdgeInsets: UIEdgeInsets): void;

  titleEdgeInsets: UIEdgeInsets;

  setTitleEdgeInsets(titleEdgeInsets: UIEdgeInsets): void;

  imageEdgeInsets: UIEdgeInsets;

  setImageEdgeInsets(imageEdgeInsets: UIEdgeInsets): void;

  reversesTitleShadowWhenHighlighted: boolean;

  setReversesTitleShadowWhenHighlighted(reversesTitleShadowWhenHighlighted: boolean): void;

  adjustsImageWhenHighlighted: boolean;

  setAdjustsImageWhenHighlighted(adjustsImageWhenHighlighted: boolean): void;

  adjustsImageWhenDisabled: boolean;

  setAdjustsImageWhenDisabled(adjustsImageWhenDisabled: boolean): void;

  showsTouchWhenHighlighted: boolean;

  setShowsTouchWhenHighlighted(showsTouchWhenHighlighted: boolean): void;
  ...
  setPreferredBehavioralStyle(preferredBehavioralStyle: interop.Enum<typeof UIBehavioralStyle>): void;
...
declare class UIMessageConversationEntry extends UIConversationEntry {
  ...
  setDataKind(dataKind: interop.Enum<typeof UIMessageConversationEntryDataKind>): void;

  setWasSentBySelf(wasSentBySelf: boolean): void;
}
...
declare class UICellConfigurationState extends UIViewConfigurationState {
  ...
  setCellDragState(cellDragState: interop.Enum<typeof UICellConfigurationDragState>): void;

  setCellDropState(cellDropState: interop.Enum<typeof UICellConfigurationDropState>): void;
}
...
declare class UIMenuDisplayPreferences extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setMaximumNumberOfTitleLines(maximumNumberOfTitleLines: number): void;
...
declare class UITextSelectionDisplayInteraction extends NSObject implements UIInteraction {
  ...
  setCursorView(cursorView: UIView): void;

  setHighlightView(highlightView: UIView): void;

  setHandleViews(handleViews: NSArray<interop.Object> | Array<interop.Object>): void;
...
declare class UICollectionViewController extends UIViewController implements UICollectionViewDelegate, UICollectionViewDataSource {
  ...
  setCollectionView(collectionView: UICollectionView | null): void;

  setClearsSelectionOnViewWillAppear(clearsSelectionOnViewWillAppear: boolean): void;

  setUseLayoutToLayoutNavigationTransitions(useLayoutToLayoutNavigationTransitions: boolean): void;

  setInstallsStandardGestureForInteractiveMovement(installsStandardGestureForInteractiveMovement: boolean): void;
...
declare class UICollectionViewCompositionalLayoutConfiguration extends NSObject implements NSCopying {
  ...
  setScrollDirection(scrollDirection: interop.Enum<typeof UICollectionViewScrollDirection>): void;

  setInterSectionSpacing(interSectionSpacing: number): void;
...
declare class UIPasteControl extends UIControl {
  ...
  setTarget(target: UIPasteConfigurationSupporting | null): void;
}
...
declare class UIDropProposal extends NSObject implements NSCopying {
  ...
  setPrefersFullSizePreview(prefersFullSizePreview: boolean): void;
...
declare class UIPanGestureRecognizer extends UIGestureRecognizer {
  ...
  setMinimumNumberOfTouches(minimumNumberOfTouches: number): void;

  setMaximumNumberOfTouches(maximumNumberOfTouches: number): void;
...
declare class UITextView extends UIScrollView implements UITextInput, UIContentSizeCategoryAdjusting, UILetterformAwareAdjusting {
  ...
  setDataDetectorTypes(dataDetectorTypes: interop.Enum<typeof UIDataDetectorTypes>): void;
  ...
  setInputView(inputView: UIView | null): void;

  setInputAccessoryView(inputAccessoryView: UIView): void;

  setClearsOnInsertion(clearsOnInsertion: boolean): void;

  setTextContainerInset(textContainerInset: UIEdgeInsets): void;

  setLinkTextAttributes(linkTextAttributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;

  setUsesStandardTextScaling(usesStandardTextScaling: boolean): void;

  isFindInteractionEnabled(): boolean;

  setFindInteractionEnabled(findInteractionEnabled: boolean): void;

  setBorderStyle(borderStyle: interop.Enum<typeof UITextViewBorderStyle>): void;

  setTextHighlightAttributes(textHighlightAttributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;
  ...
  setTextFormattingConfiguration(textFormattingConfiguration: UITextFormattingViewControllerConfiguration): void;

  interactionState: interop.Object;

  setInteractionState(interactionState: interop.Object): void;
...
declare class UIMailConversationContext extends UIConversationContext {
  ...
  setResponseSubject(responseSubject: string): void;
...
declare class UIDocumentProperties extends NSObject {
  ...
  setDragItemsProvider(dragItemsProvider: (p1: UIDragSession) => NSArray | null): void;

  setActivityViewControllerProvider(activityViewControllerProvider: () => UIActivityViewController | null): void;

  setWantsIconRepresentation(wantsIconRepresentation: boolean): void;
}
...
declare class NSTextAttachment extends NSObject implements NSTextAttachmentLayout, NSSecureCoding {
  ...
  setContents(contents: NSData | null): void;
  ...
  setFileWrapper(fileWrapper: NSFileWrapper | null): void;

  setLineLayoutPadding(lineLayoutPadding: number): void;

  setAllowsTextAttachmentView(allowsTextAttachmentView: boolean): void;
...
declare class UIMotionEffectGroup extends UIMotionEffect {
  ...
  setMotionEffects(motionEffects: NSArray<interop.Object> | Array<interop.Object> | null): void;
}
...
declare class UICollectionViewLayoutInvalidationContext extends NSObject {
  ...
  setContentOffsetAdjustment(contentOffsetAdjustment: CGPoint): void;

  setContentSizeAdjustment(contentSizeAdjustment: CGSize): void;
}
...
declare class UIAccessibilityElement extends UIResponder implements UIAccessibilityIdentification {
  ...
  setAccessibilityFrameInContainerSpace(accessibilityFrameInContainerSpace: CGRect): void;
...
declare class UIAccelerometer extends NSObject {
  ...
  setDelegate(delegate: UIAccelerometerDelegate | null): void;
}
...
declare class UIGraphicsPDFRendererFormat extends UIGraphicsRendererFormat {
  ...
  setDocumentInfo(documentInfo: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;
}
...
declare class UISceneSession extends NSObject implements NSSecureCoding {
  ...
  setStateRestorationActivity(stateRestorationActivity: NSUserActivity | null): void;
...
declare class UIFocusGuide extends UILayoutGuide {
  ...
  setPreferredFocusEnvironments(preferredFocusEnvironments: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setPreferredFocusedView(preferredFocusedView: UIView): void;
}
...
declare class UIPrintFormatter extends NSObject implements NSCopying {
  ...
  setMaximumContentHeight(maximumContentHeight: number): void;

  setMaximumContentWidth(maximumContentWidth: number): void;

  setContentInsets(contentInsets: UIEdgeInsets): void;

  setPerPageContentInsets(perPageContentInsets: UIEdgeInsets): void;
...
declare class UIWebView extends UIView implements NSCoding, UIScrollViewDelegate {
  ...
  setDelegate(delegate: UIWebViewDelegate | null): void;

  isLoading(): boolean;

  setScalesPageToFit(scalesPageToFit: boolean): void;

  setDetectsPhoneNumbers(detectsPhoneNumbers: boolean): void;
  ...
  setPaginationMode(paginationMode: interop.Enum<typeof UIWebPaginationMode>): void;

  setPaginationBreakingMode(paginationBreakingMode: interop.Enum<typeof UIWebPaginationBreakingMode>): void;

  setPageLength(pageLength: number): void;

  setGapBetweenPages(gapBetweenPages: number): void;
...
declare class UIViewController extends UIResponder implements NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment {
  ...
  setDefinesPresentationContext(definesPresentationContext: boolean): void;

  setProvidesPresentationContextTransitionStyle(providesPresentationContextTransitionStyle: boolean): void;

  setRestoresFocusAfterTransition(restoresFocusAfterTransition: boolean): void;

  setFocusGroupIdentifier(focusGroupIdentifier: string): void;

  setInteractionActivityTrackingBaseName(interactionActivityTrackingBaseName: string): void;
  ...
  setModalTransitionStyle(modalTransitionStyle: interop.Enum<typeof UIModalTransitionStyle>): void;

  setPreferredTransition(preferredTransition: UIViewControllerTransition): void;

  setModalPresentationStyle(modalPresentationStyle: interop.Enum<typeof UIModalPresentationStyle>): void;

  setModalPresentationCapturesStatusBarAppearance(modalPresentationCapturesStatusBarAppearance: boolean): void;
  ...
  setAutomaticallyAdjustsScrollViewInsets(automaticallyAdjustsScrollViewInsets: boolean): void;

  setPreferredContentSize(preferredContentSize: CGSize): void;
  ...
  setRestorationClass(restorationClass: UIViewControllerRestoration): void;

  updateViewConstraints(): void;

  transitioningDelegate: UIViewControllerTransitioningDelegate;

  setTransitioningDelegate(transitioningDelegate: UIViewControllerTransitioningDelegate): void;
  ...
  setAdditionalSafeAreaInsets(additionalSafeAreaInsets: UIEdgeInsets): void;

  setViewRespectsSystemMinimumLayoutMargins(viewRespectsSystemMinimumLayoutMargins: boolean): void;
  ...
  setModalInPresentation(modalInPresentation: boolean): void;
  ...
  setContentUnavailableConfiguration(contentUnavailableConfiguration: UIContentConfiguration): void;
  ...
  setHidesBottomBarWhenPushed(hidesBottomBarWhenPushed: boolean): void;
  ...
  setToolbarItems(toolbarItems: NSArray<interop.Object> | Array<interop.Object>): void;
  ...
  setModalInPopover(modalInPopover: boolean): void;

  setContentSizeForViewInPopover(contentSizeForViewInPopover: CGSize): void;
  ...
  setTabBarItem(tabBarItem: UITabBarItem | null): void;
...
declare class UIScrollView extends UIView implements NSCoding, UIFocusItemScrollableContainer {
  ...
  setContentSize(contentSize: CGSize): void;

  setContentInset(contentInset: UIEdgeInsets): void;

  setContentAlignmentPoint(contentAlignmentPoint: CGPoint): void;

  setContentInsetAdjustmentBehavior(contentInsetAdjustmentBehavior: interop.Enum<typeof UIScrollViewContentInsetAdjustmentBehavior>): void;

  setAutomaticallyAdjustsScrollIndicatorInsets(automaticallyAdjustsScrollIndicatorInsets: boolean): void;

  setDelegate(delegate: UIScrollViewDelegate | null): void;

  isDirectionalLockEnabled(): boolean;

  setDirectionalLockEnabled(directionalLockEnabled: boolean): void;

  setBounces(bounces: boolean): void;

  setBouncesHorizontally(bouncesHorizontally: boolean): void;

  setBouncesVertically(bouncesVertically: boolean): void;

  setAlwaysBounceVertical(alwaysBounceVertical: boolean): void;

  setAlwaysBounceHorizontal(alwaysBounceHorizontal: boolean): void;
  ...
  setTransfersHorizontalScrollingToParent(transfersHorizontalScrollingToParent: boolean): void;

  setTransfersVerticalScrollingToParent(transfersVerticalScrollingToParent: boolean): void;

  setShowsVerticalScrollIndicator(showsVerticalScrollIndicator: boolean): void;

  setShowsHorizontalScrollIndicator(showsHorizontalScrollIndicator: boolean): void;

  setIndicatorStyle(indicatorStyle: interop.Enum<typeof UIScrollViewIndicatorStyle>): void;

  setVerticalScrollIndicatorInsets(verticalScrollIndicatorInsets: UIEdgeInsets): void;

  setHorizontalScrollIndicatorInsets(horizontalScrollIndicatorInsets: UIEdgeInsets): void;

  setScrollIndicatorInsets(scrollIndicatorInsets: UIEdgeInsets): void;

  setDecelerationRate(decelerationRate: number): void;

  setIndexDisplayMode(indexDisplayMode: interop.Enum<typeof UIScrollViewIndexDisplayMode>): void;
  ...
  setDelaysContentTouches(delaysContentTouches: boolean): void;

  setCanCancelContentTouches(canCancelContentTouches: boolean): void;

  setMinimumZoomScale(minimumZoomScale: number): void;

  setMaximumZoomScale(maximumZoomScale: number): void;

  setZoomScale(zoomScale: number): void;

  setBouncesZoom(bouncesZoom: boolean): void;

  isZooming(): boolean;

  isZoomBouncing(): boolean;

  isZoomAnimating(): boolean;

  setScrollsToTop(scrollsToTop: boolean): void;

  setKeyboardDismissMode(keyboardDismissMode: interop.Enum<typeof UIScrollViewKeyboardDismissMode>): void;

  setRefreshControl(refreshControl: UIRefreshControl): void;

  setAllowsKeyboardScrolling(allowsKeyboardScrolling: boolean): void;
...
declare class UIStackView extends UIView {
  ...
  setAxis(axis: interop.Enum<typeof UILayoutConstraintAxis>): void;

  setDistribution(distribution: interop.Enum<typeof UIStackViewDistribution>): void;

  setAlignment(alignment: interop.Enum<typeof UIStackViewAlignment>): void;

  setSpacing(spacing: number): void;

  isBaselineRelativeArrangement(): boolean;

  setBaselineRelativeArrangement(baselineRelativeArrangement: boolean): void;

  isLayoutMarginsRelativeArrangement(): boolean;

  setLayoutMarginsRelativeArrangement(layoutMarginsRelativeArrangement: boolean): void;
}
...
declare class UIPageControlTimerProgress extends UIPageControlProgress {
  ...
  setPreferredDuration(preferredDuration: number): void;
}
...
declare class UIScribbleInteraction extends NSObject implements UIInteraction {
  ...
  static isPencilInputExpected(): boolean;
...
declare class UICalendarSelectionWeekOfYear extends UICalendarSelection {
  ...
  setSelectedWeekOfYear(selectedWeekOfYear: NSDateComponents | null): void;
}
...
declare class UIPointerAccessory extends NSObject implements NSCopying {
  ...
  setOrientationMatchesAngle(orientationMatchesAngle: boolean): void;
...
declare class UIMutableUserNotificationAction extends UIUserNotificationAction {
  ...
  setBehavior(behavior: interop.Enum<typeof UIUserNotificationActionBehavior>): void;

  setParameters(parameters: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;

  setActivationMode(activationMode: interop.Enum<typeof UIUserNotificationActivationMode>): void;
...
declare class UITabBarAppearance extends UIBarAppearance {
  ...
  setStackedLayoutAppearance(stackedLayoutAppearance: UITabBarItemAppearance): void;

  setInlineLayoutAppearance(inlineLayoutAppearance: UITabBarItemAppearance): void;

  setCompactInlineLayoutAppearance(compactInlineLayoutAppearance: UITabBarItemAppearance): void;

  setSelectionIndicatorTintColor(selectionIndicatorTintColor: UIColor | null): void;

  setSelectionIndicatorImage(selectionIndicatorImage: UIImage | null): void;

  setStackedItemPositioning(stackedItemPositioning: interop.Enum<typeof UITabBarItemPositioning>): void;

  setStackedItemWidth(stackedItemWidth: number): void;

  setStackedItemSpacing(stackedItemSpacing: number): void;
}
...
declare class UIZoomTransitionOptions extends NSObject implements NSCopying {
  ...
  setInteractiveDismissShouldBegin(interactiveDismissShouldBegin: (p1: UIZoomTransitionInteractionContext) => boolean | null): void;

  setAlignmentRectProvider(alignmentRectProvider: (p1: UIZoomTransitionAlignmentRectContext) => CGRect): void;

  setDimmingColor(dimmingColor: UIColor | null): void;

  setDimmingVisualEffect(dimmingVisualEffect: UIBlurEffect | null): void;
...
declare class UIDocumentMenuViewController extends UIViewController {
  ...
  setDelegate(delegate: UIDocumentMenuDelegate | null): void;
}
...
declare class UIPasteboard extends NSObject {
  ...
  setItemProviders(itemProviders: NSArray<interop.Object> | Array<interop.Object>): void;

  setItems(items: NSArray<interop.Object> | Array<interop.Object>): void;

  setString(string: string): void;

  setStrings(strings: NSArray<interop.Object> | Array<interop.Object>): void;

  setURL(URL: NSURL): void;

  setURLs(URLs: NSArray<interop.Object> | Array<interop.Object>): void;

  setImage(image: UIImage): void;

  setImages(images: NSArray<interop.Object> | Array<interop.Object>): void;

  setColor(color: UIColor): void;

  setColors(colors: NSArray<interop.Object> | Array<interop.Object>): void;
}
...
declare class UITabGroup extends UITab {
  ...
  setDefaultChildIdentifier(defaultChildIdentifier: string | null): void;

  setChildren(children: NSArray<interop.Object> | Array<interop.Object>): void;

  setDisplayOrderIdentifiers(displayOrderIdentifiers: NSArray<interop.Object> | Array<interop.Object>): void;

  setAllowsReordering(allowsReordering: boolean): void;

  setManagingNavigationController(managingNavigationController: UINavigationController | null): void;
...
declare class UIApplication extends UIResponder {
  ...
  setDelegate(delegate: UIApplicationDelegate | null): void;
  ...
  setNetworkActivityIndicatorVisible(networkActivityIndicatorVisible: boolean): void;

  isStatusBarHidden(): boolean;

  setApplicationIconBadgeNumber(applicationIconBadgeNumber: number): void;

  setApplicationSupportsShakeToEdit(applicationSupportsShakeToEdit: boolean): void;
  ...
  setScheduledLocalNotifications(scheduledLocalNotifications: NSArray<interop.Object> | Array<interop.Object>): void;
  ...
  setShortcutItems(shortcutItems: NSArray<interop.Object> | Array<interop.Object>): void;
  ...
  setProximitySensingEnabled(proximitySensingEnabled: boolean): void;

  setStatusBarOrientation(statusBarOrientation: interop.Enum<typeof UIInterfaceOrientation>): void;

  setStatusBarStyle(statusBarStyle: interop.Enum<typeof UIStatusBarStyle>): void;
...
declare class NSTextLayoutManager extends NSObject implements NSSecureCoding, NSTextSelectionDataSource {
  ...
  setDelegate(delegate: NSTextLayoutManagerDelegate | null): void;
  ...
  setTextSelections(textSelections: NSArray<interop.Object> | Array<interop.Object>): void;

  setTextSelectionNavigation(textSelectionNavigation: NSTextSelectionNavigation): void;

  setRenderingAttributesValidator(renderingAttributesValidator: (p1: NSTextLayoutManager, p2: NSTextLayoutFragment) => void | null): void;
...
declare class UIPrinterDestination extends NSObject implements NSSecureCoding {
  ...
  setTxtRecord(txtRecord: NSData | null): void;
...
declare class UICalendarView extends UIView {
  ...
  setDelegate(delegate: UICalendarViewDelegate | null): void;

  setSelectionBehavior(selectionBehavior: UICalendarSelection | null): void;

  setLocale(locale: NSLocale): void;

  setCalendar(calendar: NSCalendar): void;

  setTimeZone(timeZone: NSTimeZone | null): void;

  setFontDesign(fontDesign: string): void;

  setAvailableDateRange(availableDateRange: NSDateInterval): void;

  setVisibleDateComponents(visibleDateComponents: NSDateComponents): void;

  setWantsDateDecorations(wantsDateDecorations: boolean): void;
}
...
declare class UIPrintInfo extends NSObject implements NSCopying, NSCoding {
  ...
  setOutputType(outputType: interop.Enum<typeof UIPrintInfoOutputType>): void;

  setOrientation(orientation: interop.Enum<typeof UIPrintInfoOrientation>): void;

  setDuplex(duplex: interop.Enum<typeof UIPrintInfoDuplex>): void;
...
declare class UISceneConfiguration extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setSceneClass(sceneClass: interop.Object | null): void;

  setDelegateClass(delegateClass: interop.Object | null): void;

  setStoryboard(storyboard: UIStoryboard | null): void;
...
declare class UIActivityViewController extends UIViewController {
  ...
  setCompletionHandler(completionHandler: (p1: string, p2: boolean) => void): void;

  setCompletionWithItemsHandler(completionWithItemsHandler: (p1: string, p2: boolean, p3: NSArray<interop.Object> | Array<interop.Object>, p4: NSError) => void): void;

  setExcludedActivityTypes(excludedActivityTypes: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setExcludedActivitySectionTypes(excludedActivitySectionTypes: interop.Enum<typeof UIActivitySectionTypes>): void;

  setAllowsProminentActivity(allowsProminentActivity: boolean): void;
...
declare class UITextFormattingViewControllerConfiguration extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setFormattingStyles(formattingStyles: NSArray<interop.Object> | Array<interop.Object>): void;

  setFontPickerConfiguration(fontPickerConfiguration: UIFontPickerViewControllerConfiguration | null): void;
...
declare class UIDropInteraction extends NSObject implements UIInteraction {
  ...
  setAllowsSimultaneousDropSessions(allowsSimultaneousDropSessions: boolean): void;
...
declare class UITab extends NSObject {
  ...
  setBadgeValue(badgeValue: string | null): void;

  setPreferredPlacement(preferredPlacement: interop.Enum<typeof UITabPlacement>): void;
  ...
  setHiddenByDefault(hiddenByDefault: boolean): void;

  setAllowsHiding(allowsHiding: boolean): void;
}
...
declare class UIUpdateLink extends NSObject {
  ...
  setRequiresContinuousUpdates(requiresContinuousUpdates: boolean): void;

  setWantsLowLatencyEventDispatch(wantsLowLatencyEventDispatch: boolean): void;

  setWantsImmediatePresentation(wantsImmediatePresentation: boolean): void;
...
declare class UIUpdateInfo extends NSObject {
  ...
  isImmediatePresentationExpected(): boolean;

  isLowLatencyEventDispatchConfirmed(): boolean;

  isPerformingLowLatencyPhases(): boolean;
}
...
declare class UIContentUnavailableConfiguration extends NSObject implements UIContentConfiguration, NSSecureCoding {
  ...
  setSecondaryText(secondaryText: string | null): void;

  setSecondaryAttributedText(secondaryAttributedText: NSAttributedString | null): void;

  setButton(button: UIButtonConfiguration): void;

  setSecondaryButton(secondaryButton: UIButtonConfiguration): void;
  ...
  setImageToTextPadding(imageToTextPadding: number): void;

  setTextToSecondaryTextPadding(textToSecondaryTextPadding: number): void;

  setTextToButtonPadding(textToButtonPadding: number): void;

  setButtonToSecondaryButtonPadding(buttonToSecondaryButtonPadding: number): void;

  setBackground(background: UIBackgroundConfiguration): void;
...
declare class UIContentUnavailableButtonProperties extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setPrimaryAction(primaryAction: UIAction | null): void;

  setMenu(menu: UIMenu | null): void;
...
declare class UIPencilInteraction extends NSObject implements UIInteraction {
  ...
  setDelegate(delegate: UIPencilInteractionDelegate | null): void;
...
declare class NSShadow extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setShadowBlurRadius(shadowBlurRadius: number): void;
...
declare class UIBarButtonItemGroup extends NSObject implements NSCoding {
  ...
  setBarButtonItems(barButtonItems: NSArray<interop.Object> | Array<interop.Object>): void;

  setRepresentativeItem(representativeItem: UIBarButtonItem | null): void;

  isDisplayingRepresentativeItem(): boolean;

  setAlwaysAvailable(alwaysAvailable: boolean): void;
...
declare class UIWindowSceneActivationConfiguration extends NSObject {
  ...
  setOptions(options: UIWindowSceneActivationRequestOptions | null): void;

  setPreview(preview: UITargetedPreview | null): void;
}
...
declare class UITableViewCell extends UIView implements NSCoding, UIGestureRecognizerDelegate {
  ...
  setConfigurationUpdateHandler(configurationUpdateHandler: (p1: UITableViewCell, p2: UICellConfigurationState) => void): void;
  ...
  setSelectedBackgroundView(selectedBackgroundView: UIView | null): void;

  setMultipleSelectionBackgroundView(multipleSelectionBackgroundView: UIView): void;

  setSelectionStyle(selectionStyle: interop.Enum<typeof UITableViewCellSelectionStyle>): void;
  ...
  setShowsReorderControl(showsReorderControl: boolean): void;

  setShouldIndentWhileEditing(shouldIndentWhileEditing: boolean): void;

  setAccessoryType(accessoryType: interop.Enum<typeof UITableViewCellAccessoryType>): void;

  setAccessoryView(accessoryView: UIView | null): void;

  setEditingAccessoryType(editingAccessoryType: interop.Enum<typeof UITableViewCellAccessoryType>): void;

  setEditingAccessoryView(editingAccessoryView: UIView | null): void;

  setIndentationLevel(indentationLevel: number): void;

  setIndentationWidth(indentationWidth: number): void;
  ...
  setFocusStyle(focusStyle: interop.Enum<typeof UITableViewCellFocusStyle>): void;

  setUserInteractionEnabledWhileDragging(userInteractionEnabledWhileDragging: boolean): void;
  ...
  setTextColor(textColor: UIColor): void;

  setSelectedTextColor(selectedTextColor: UIColor): void;

  setImage(image: UIImage): void;

  setSelectedImage(selectedImage: UIImage): void;

  setHidesAccessoryWhenEditing(hidesAccessoryWhenEditing: boolean): void;

  setTarget(target: interop.Object): void;

  setEditAction(editAction: string): void;

  setAccessoryAction(accessoryAction: string): void;
...
declare class UIPointerHoverEffect extends UIPointerEffect {
  ...
  setPreferredTintMode(preferredTintMode: interop.Enum<typeof UIPointerEffectTintMode>): void;

  setPrefersShadow(prefersShadow: boolean): void;
...
declare class UIAccessibilityCustomRotor extends NSObject {
  ...
  setItemSearchBlock(itemSearchBlock: (p1: UIAccessibilityCustomRotorSearchPredicate) => UIAccessibilityCustomRotorItemResult): void;
}
...
declare class UIDocumentPickerViewController extends UIViewController {
  ...
  setDelegate(delegate: UIDocumentPickerDelegate | null): void;
...
declare class UINavigationController extends UIViewController {
  ...
  setNavigationBarHidden(navigationBarHidden: boolean): void;

  isToolbarHidden(): boolean;

  setToolbarHidden(toolbarHidden: boolean): void;
  ...
  setHidesBarsWhenVerticallyCompact(hidesBarsWhenVerticallyCompact: boolean): void;
...
declare class UISceneSessionActivationRequest extends NSObject implements NSCopying {
  ...
  setUserActivity(userActivity: NSUserActivity | null): void;

  setOptions(options: UISceneActivationRequestOptions | null): void;
...
declare class UIScreen extends NSObject implements UITraitEnvironment {
  ...
  setCurrentMode(currentMode: UIScreenMode): void;

  setOverscanCompensation(overscanCompensation: interop.Enum<typeof UIScreenOverscanCompensation>): void;

  isCaptured(): boolean;

  setBrightness(brightness: number): void;

  setWantsSoftwareDimming(wantsSoftwareDimming: boolean): void;
...
declare class UIViewPropertyAnimator extends NSObject implements UIViewImplicitlyAnimating, NSCopying {
  ...
  setManualHitTestingEnabled(manualHitTestingEnabled: boolean): void;
...
declare class UIDatePicker extends UIControl implements NSCoding {
  ...
  setDatePickerMode(datePickerMode: interop.Enum<typeof UIDatePickerMode>): void;

  setLocale(locale: NSLocale | null): void;

  setCalendar(calendar: NSCalendar | null): void;

  setTimeZone(timeZone: NSTimeZone | null): void;

  setDate(date: NSDate): void;

  setMinimumDate(minimumDate: NSDate | null): void;

  setMaximumDate(maximumDate: NSDate | null): void;

  setCountDownDuration(countDownDuration: number): void;

  setMinuteInterval(minuteInterval: number): void;

  setPreferredDatePickerStyle(preferredDatePickerStyle: interop.Enum<typeof UIDatePickerStyle>): void;

  setRoundsToMinuteInterval(roundsToMinuteInterval: boolean): void;
...
declare class UICellAccessoryCustomView extends UICellAccessory {
  ...
  setMaintainsFixedSize(maintainsFixedSize: boolean): void;

  setPosition(position: (p1: NSArray<interop.Object> | Array<interop.Object>) => number | null): void;
}
...
declare class UIPushBehavior extends UIDynamicBehavior {
  ...
  setPushDirection(pushDirection: CGVector): void;
}
...
declare class UIPasteConfiguration extends NSObject implements NSSecureCoding, NSCopying {
  ...
  setAcceptableTypeIdentifiers(acceptableTypeIdentifiers: NSArray<interop.Object> | Array<interop.Object>): void;
...
declare class UIDynamicAnimator extends NSObject {
  ...
  setDelegate(delegate: UIDynamicAnimatorDelegate | null): void;
...
declare class UITabBarController extends UIViewController implements UITabBarDelegate, NSCoding {
  ...
  setDelegate(delegate: UITabBarControllerDelegate | null): void;

  setMode(mode: interop.Enum<typeof UITabBarControllerMode>): void;

  setCustomizationIdentifier(customizationIdentifier: string): void;

  setCompactTabIdentifiers(compactTabIdentifiers: NSArray<interop.Object> | Array<interop.Object>): void;

  setSelectedTab(selectedTab: UITab): void;
  ...
  setSelectedViewController(selectedViewController: UIViewController | null): void;

  setSelectedIndex(selectedIndex: number): void;

  setCustomizableViewControllers(customizableViewControllers: NSArray<interop.Object> | Array<interop.Object> | null): void;
...
declare class UIPopoverPresentationController extends UIPresentationController {
  ...
  setCanOverlapSourceViewRect(canOverlapSourceViewRect: boolean): void;

  setSourceItem(sourceItem: UIPopoverPresentationControllerSourceItem): void;

  setBarButtonItem(barButtonItem: UIBarButtonItem): void;

  setPassthroughViews(passthroughViews: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setBackgroundColor(backgroundColor: UIColor): void;

  setPopoverLayoutMargins(popoverLayoutMargins: UIEdgeInsets): void;

  setPopoverBackgroundViewClass(popoverBackgroundViewClass: UIPopoverBackgroundViewMethods | null): void;
}
...
declare class UISheetPresentationController extends UIPresentationController {
  ...
  setPrefersPageSizing(prefersPageSizing: boolean): void;

  setPrefersEdgeAttachedInCompactHeight(prefersEdgeAttachedInCompactHeight: boolean): void;

  setWidthFollowsPreferredContentSizeWhenEdgeAttached(widthFollowsPreferredContentSizeWhenEdgeAttached: boolean): void;

  setPrefersGrabberVisible(prefersGrabberVisible: boolean): void;

  setPreferredCornerRadius(preferredCornerRadius: number): void;

  setDetents(detents: NSArray<interop.Object> | Array<interop.Object>): void;

  setSelectedDetentIdentifier(selectedDetentIdentifier: string): void;

  setLargestUndimmedDetentIdentifier(largestUndimmedDetentIdentifier: string): void;

  setPrefersScrollingExpandsWhenScrolledToEdge(prefersScrollingExpandsWhenScrolledToEdge: boolean): void;
}
...
declare class UISwipeGestureRecognizer extends UIGestureRecognizer {
  ...
  setDirection(direction: interop.Enum<typeof UISwipeGestureRecognizerDirection>): void;
}
...
declare class NSTextContainer extends NSObject implements NSSecureCoding {
  ...
  setLineFragmentPadding(lineFragmentPadding: number): void;

  setMaximumNumberOfLines(maximumNumberOfLines: number): void;
  ...
  setExclusionPaths(exclusionPaths: NSArray<interop.Object> | Array<interop.Object>): void;
...
declare class UIBarAppearance extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setBackgroundEffect(backgroundEffect: UIBlurEffect | null): void;

  setBackgroundColor(backgroundColor: UIColor | null): void;

  setBackgroundImage(backgroundImage: UIImage | null): void;

  setBackgroundImageContentMode(backgroundImageContentMode: interop.Enum<typeof UIViewContentMode>): void;

  setShadowColor(shadowColor: UIColor | null): void;

  setShadowImage(shadowImage: UIImage | null): void;
...
declare class UIPreviewParameters extends NSObject implements NSCopying {
  ...
  setVisiblePath(visiblePath: UIBezierPath | null): void;

  setShadowPath(shadowPath: UIBezierPath): void;
...
declare class UISnapBehavior extends UIDynamicBehavior {
  ...
  setSnapPoint(snapPoint: CGPoint): void;
...
declare class UIFindSession extends NSObject {
  ...
  setSearchResultDisplayStyle(searchResultDisplayStyle: interop.Enum<typeof UIFindSessionSearchResultDisplayStyle>): void;
}
...
declare class UIFieldBehavior extends UIDynamicBehavior {
  ...
  setRegion(region: UIRegion): void;
  ...
  setDirection(direction: CGVector): void;
...
declare class UILongPressGestureRecognizer extends UIGestureRecognizer {
  ...
  setMinimumPressDuration(minimumPressDuration: number): void;

  setAllowableMovement(allowableMovement: number): void;
}
...
declare class UITextInputContext extends NSObject {
  ...
  setPencilInputExpected(pencilInputExpected: boolean): void;

  isDictationInputExpected(): boolean;

  setDictationInputExpected(dictationInputExpected: boolean): void;

  isHardwareKeyboardInputExpected(): boolean;

  setHardwareKeyboardInputExpected(hardwareKeyboardInputExpected: boolean): void;
}
...
declare class UITextChecker extends NSObject {
  ...
  setIgnoredWords(ignoredWords: NSArray<interop.Object> | Array<interop.Object> | null): void;
}
...
declare class UIPercentDrivenInteractiveTransition extends NSObject implements UIViewControllerInteractiveTransitioning {
  ...
  setCompletionSpeed(completionSpeed: number): void;

  setCompletionCurve(completionCurve: interop.Enum<typeof UIViewAnimationCurve>): void;

  setTimingCurve(timingCurve: UITimingCurveProvider): void;

  setWantsInteractiveStart(wantsInteractiveStart: boolean): void;
...
declare class NSCollectionLayoutGroup extends NSCollectionLayoutItem implements NSCopying {
  ...
  setSupplementaryItems(supplementaryItems: NSArray<interop.Object> | Array<interop.Object>): void;

  setInterItemSpacing(interItemSpacing: NSCollectionLayoutSpacing | null): void;
...
declare class UIPopoverController extends NSObject implements UIAppearanceContainer {
  ...
  setDelegate(delegate: UIPopoverControllerDelegate | null): void;

  setContentViewController(contentViewController: UIViewController): void;

  setPopoverContentSize(popoverContentSize: CGSize): void;
  ...
  setPopoverBackgroundViewClass(popoverBackgroundViewClass: interop.Object): void;
...
declare class UIPasteControlConfiguration extends NSObject implements NSSecureCoding {
  ...
  setDisplayMode(displayMode: interop.Enum<typeof UIPasteControlDisplayMode>): void;

  setCornerStyle(cornerStyle: interop.Enum<typeof UIButtonConfigurationCornerStyle>): void;

  setCornerRadius(cornerRadius: number): void;

  setImagePlacement(imagePlacement: interop.Enum<typeof NSDirectionalRectEdge>): void;

  setBaseForegroundColor(baseForegroundColor: UIColor | null): void;

  setBaseBackgroundColor(baseBackgroundColor: UIColor | null): void;
...
declare class UIPageViewController extends UIViewController {
  ...
  setDelegate(delegate: UIPageViewControllerDelegate | null): void;

  setDataSource(dataSource: UIPageViewControllerDataSource | null): void;
...
declare class UIPageControl extends UIControl {
  ...
  setHidesForSinglePage(hidesForSinglePage: boolean): void;

  setProgress(progress: UIPageControlProgress): void;

  setPageIndicatorTintColor(pageIndicatorTintColor: UIColor): void;

  setCurrentPageIndicatorTintColor(currentPageIndicatorTintColor: UIColor): void;

  setBackgroundStyle(backgroundStyle: interop.Enum<typeof UIPageControlBackgroundStyle>): void;

  setDirection(direction: interop.Enum<typeof UIPageControlDirection>): void;

  setAllowsContinuousInteraction(allowsContinuousInteraction: boolean): void;

  setPreferredIndicatorImage(preferredIndicatorImage: UIImage): void;

  setPreferredCurrentPageIndicatorImage(preferredCurrentPageIndicatorImage: UIImage): void;

  setDefersCurrentPageDisplay(defersCurrentPageDisplay: boolean): void;
}
...
declare class UINavigationBar extends UIView implements NSCoding, UIBarPositioning {
  ...
  setBarStyle(barStyle: interop.Enum<typeof UIBarStyle>): void;

  setDelegate(delegate: UINavigationBarDelegate | null): void;

  isTranslucent(): boolean;

  setTranslucent(translucent: boolean): void;

  setItems(items: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setPrefersLargeTitles(prefersLargeTitles: boolean): void;

  setPreferredBehavioralStyle(preferredBehavioralStyle: interop.Enum<typeof UIBehavioralStyle>): void;

  setTintColor(tintColor: UIColor | null): void;

  setBarTintColor(barTintColor: UIColor): void;

  setShadowImage(shadowImage: UIImage): void;

  setTitleTextAttributes(titleTextAttributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;

  setLargeTitleTextAttributes(largeTitleTextAttributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;

  setBackIndicatorImage(backIndicatorImage: UIImage): void;

  setBackIndicatorTransitionMaskImage(backIndicatorTransitionMaskImage: UIImage): void;

  setStandardAppearance(standardAppearance: UINavigationBarAppearance): void;

  setCompactAppearance(compactAppearance: UINavigationBarAppearance): void;

  setScrollEdgeAppearance(scrollEdgeAppearance: UINavigationBarAppearance): void;

  setCompactScrollEdgeAppearance(compactScrollEdgeAppearance: UINavigationBarAppearance): void;
...
declare class UITextFormattingCoordinator extends NSObject implements UIFontPickerViewControllerDelegate {
  ...
  setDelegate(delegate: UITextFormattingCoordinatorDelegate | null): void;

  static isFontPanelVisible(): boolean;
...
declare class UIInterpolatingMotionEffect extends UIMotionEffect {
  ...
  setMinimumRelativeValue(minimumRelativeValue: interop.Object | null): void;
...
declare class UICellAccessory extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setDisplayedState(displayedState: interop.Enum<typeof UICellAccessoryDisplayedState>): void;

  isHidden(): boolean;

  setHidden(hidden: boolean): void;

  setReservedLayoutWidth(reservedLayoutWidth: number): void;
...
declare class UITabBar extends UIView {
  ...
  setDelegate(delegate: UITabBarDelegate | null): void;

  setItems(items: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setSelectedItem(selectedItem: UITabBarItem | null): void;
  ...
  setUnselectedItemTintColor(unselectedItemTintColor: UIColor): void;

  setSelectedImageTintColor(selectedImageTintColor: UIColor): void;

  setBackgroundImage(backgroundImage: UIImage): void;

  setSelectionIndicatorImage(selectionIndicatorImage: UIImage): void;

  setShadowImage(shadowImage: UIImage): void;

  setItemPositioning(itemPositioning: interop.Enum<typeof UITabBarItemPositioning>): void;

  setItemWidth(itemWidth: number): void;

  setItemSpacing(itemSpacing: number): void;
  ...
  setStandardAppearance(standardAppearance: UITabBarAppearance): void;

  setScrollEdgeAppearance(scrollEdgeAppearance: UITabBarAppearance): void;
}
...
declare class UISceneSizeRestrictions extends NSObject {
  ...
  setMinimumSize(minimumSize: CGSize): void;

  setMaximumSize(maximumSize: CGSize): void;

  setAllowsFullScreen(allowsFullScreen: boolean): void;
}
...
declare class UIGraphicsImageRendererFormat extends UIGraphicsRendererFormat {
  ...
  setPrefersExtendedRange(prefersExtendedRange: boolean): void;

  setPreferredRange(preferredRange: interop.Enum<typeof UIGraphicsImageRendererFormatRange>): void;
}
...
declare class UIMutableApplicationShortcutItem extends UIApplicationShortcutItem {
  ...
  setLocalizedSubtitle(localizedSubtitle: string | null): void;

  setIcon(icon: UIApplicationShortcutIcon | null): void;
...
declare class UIAlertView extends UIView {
  ...
  setAlertViewStyle(alertViewStyle: interop.Enum<typeof UIAlertViewStyle>): void;
}
...
declare class UIInputViewController extends UIViewController implements UITextInputDelegate {
  ...
  setInputView(inputView: UIInputView | null): void;

  setPrimaryLanguage(primaryLanguage: string | null): void;

  setHasDictationKey(hasDictationKey: boolean): void;
...
declare class UIGraphicsRenderer extends NSObject {
  ...
  static contextWithFormat(format: UIGraphicsRendererFormat): interop.Object;

  static prepareCGContextWithRendererContext(context: interop.Object, rendererContext: UIGraphicsRendererContext): void;
...
declare class UIManagedDocument extends UIDocument {
  ...
  setPersistentStoreOptions(persistentStoreOptions: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;

  setModelConfiguration(modelConfiguration: string | null): void;
}
...
declare class UIFontPickerViewControllerConfiguration extends NSObject implements NSCopying {
  ...
  setIncludeFaces(includeFaces: boolean): void;

  setDisplayUsingSystemFont(displayUsingSystemFont: boolean): void;

  setFilteredTraits(filteredTraits: interop.Enum<typeof UIFontDescriptorSymbolicTraits>): void;

  setFilteredLanguagesPredicate(filteredLanguagesPredicate: NSPredicate): void;
...
declare class UIVisualEffectView extends UIView implements NSSecureCoding {
  ...
  setEffect(effect: UIVisualEffect | null): void;
...
declare class UIVibrancyEffect extends UIVisualEffect {
  ...
  static widgetEffectForVibrancyStyle(vibrancyStyle: interop.Enum<typeof UIVibrancyEffectStyle>): UIVibrancyEffect;
...
declare class UITableViewController extends UIViewController implements UITableViewDelegate, UITableViewDataSource {
  ...
  setTableView(tableView: UITableView | null): void;
...
declare class UIColor extends NSObject implements NSSecureCoding, NSCopying {
  ...
  static colorWithCGColor(cgColor: interop.Object): UIColor;
  ...
  initWithCGColor(cgColor: interop.Object): this;
...
declare class UIWindowSceneGeometryPreferencesMac extends UIWindowSceneGeometryPreferences {
  ...
  setSystemFrame(systemFrame: CGRect): void;
}
...
declare class NSTextAttachmentViewProvider extends NSObject {
  ...
  setTracksTextAttachmentViewBounds(tracksTextAttachmentViewBounds: boolean): void;
}
...
declare class UIDocumentViewController extends UIViewController {
  ...
  setDocument(document: UIDocument | null): void;

  setLaunchOptions(launchOptions: UIDocumentViewControllerLaunchOptions): void;
}
...
declare class UISearchBar extends UIView implements UIBarPositioning, UITextInputTraits, UILookToDictateCapable {
  ...
  setDelegate(delegate: UISearchBarDelegate | null): void;
  ...
  setShowsBookmarkButton(showsBookmarkButton: boolean): void;

  setShowsCancelButton(showsCancelButton: boolean): void;

  setShowsSearchResultsButton(showsSearchResultsButton: boolean): void;

  isSearchResultsButtonSelected(): boolean;

  setSearchResultsButtonSelected(searchResultsButtonSelected: boolean): void;

  setTintColor(tintColor: UIColor | null): void;

  setBarTintColor(barTintColor: UIColor): void;

  setSearchBarStyle(searchBarStyle: interop.Enum<typeof UISearchBarStyle>): void;

  isTranslucent(): boolean;

  setTranslucent(translucent: boolean): void;

  setScopeButtonTitles(scopeButtonTitles: NSArray<interop.Object> | Array<interop.Object>): void;

  setSelectedScopeButtonIndex(selectedScopeButtonIndex: number): void;

  setShowsScopeBar(showsScopeBar: boolean): void;
  ...
  setScopeBarBackgroundImage(scopeBarBackgroundImage: UIImage): void;

  setSearchFieldBackgroundPositionAdjustment(searchFieldBackgroundPositionAdjustment: UIOffset): void;

  setSearchTextPositionAdjustment(searchTextPositionAdjustment: UIOffset): void;
...
declare class UINavigationItem extends NSObject implements NSCoding {
  ...
  setBackBarButtonItem(backBarButtonItem: UIBarButtonItem): void;

  setBackButtonTitle(backButtonTitle: string): void;

  setHidesBackButton(hidesBackButton: boolean): void;

  setBackButtonDisplayMode(backButtonDisplayMode: interop.Enum<typeof UINavigationItemBackButtonDisplayMode>): void;

  setBackAction(backAction: UIAction): void;

  setTitleMenuProvider(titleMenuProvider: (p1: NSArray<interop.Object> | Array<interop.Object>) => UIMenu | null): void;

  setRenameDelegate(renameDelegate: UINavigationItemRenameDelegate): void;

  setDocumentProperties(documentProperties: UIDocumentProperties): void;

  setLeftBarButtonItems(leftBarButtonItems: NSArray<interop.Object> | Array<interop.Object>): void;

  setRightBarButtonItems(rightBarButtonItems: NSArray<interop.Object> | Array<interop.Object>): void;

  setLeftItemsSupplementBackButton(leftItemsSupplementBackButton: boolean): void;

  setLeftBarButtonItem(leftBarButtonItem: UIBarButtonItem | null): void;

  setRightBarButtonItem(rightBarButtonItem: UIBarButtonItem | null): void;

  setCustomizationIdentifier(customizationIdentifier: string): void;

  setLeadingItemGroups(leadingItemGroups: NSArray<interop.Object> | Array<interop.Object>): void;

  setCenterItemGroups(centerItemGroups: NSArray<interop.Object> | Array<interop.Object>): void;

  setTrailingItemGroups(trailingItemGroups: NSArray<interop.Object> | Array<interop.Object>): void;

  setPinnedTrailingGroup(pinnedTrailingGroup: UIBarButtonItemGroup): void;

  setAdditionalOverflowItems(additionalOverflowItems: UIDeferredMenuElement): void;

  setLargeTitleDisplayMode(largeTitleDisplayMode: interop.Enum<typeof UINavigationItemLargeTitleDisplayMode>): void;

  setStyle(style: interop.Enum<typeof UINavigationItemStyle>): void;

  setSearchController(searchController: UISearchController): void;
...
declare class UIListContentConfiguration extends NSObject implements UIContentConfiguration, NSSecureCoding {
  ...
  setPrefersSideBySideTextAndSecondaryText(prefersSideBySideTextAndSecondaryText: boolean): void;

  setImageToTextPadding(imageToTextPadding: number): void;

  setTextToSecondaryTextHorizontalPadding(textToSecondaryTextHorizontalPadding: number): void;

  setTextToSecondaryTextVerticalPadding(textToSecondaryTextVerticalPadding: number): void;
...
declare class UIWindowSceneDestructionRequestOptions extends UISceneDestructionRequestOptions {
  ...
  setWindowDismissalAnimation(windowDismissalAnimation: interop.Enum<typeof UIWindowSceneDismissalAnimation>): void;
}
...
declare class UIListContentImageProperties extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setPreferredSymbolConfiguration(preferredSymbolConfiguration: UIImageSymbolConfiguration | null): void;

  setTintColor(tintColor: UIColor | null): void;

  setTintColorTransformer(tintColorTransformer: (p1: UIColor) => UIColor | null): void;

  setCornerRadius(cornerRadius: number): void;

  setMaximumSize(maximumSize: CGSize): void;

  setReservedLayoutSize(reservedLayoutSize: CGSize): void;
  ...
  setStrokeColorTransformer(strokeColorTransformer: (p1: UIColor) => UIColor): void;
...
declare class UICollectionViewDiffableDataSource<SectionIdentifierType = interop.Object, ItemIdentifierType = interop.Object> extends NSObject implements UICollectionViewDataSource {
  ...
  setSupplementaryViewProvider(supplementaryViewProvider: (p1: UICollectionView, p2: string, p3: NSIndexPath) => UICollectionReusableView | null): void;

  setReorderingHandlers(reorderingHandlers: UICollectionViewDiffableDataSourceReorderingHandlers): void;

  setSectionSnapshotHandlers(sectionSnapshotHandlers: UICollectionViewDiffableDataSourceSectionSnapshotHandlers): void;
...
declare class UISearchDisplayController extends NSObject {
  ...
  setDelegate(delegate: UISearchDisplayDelegate | null): void;

  isActive(): boolean;

  setActive(active: boolean): void;

  setSearchResultsDataSource(searchResultsDataSource: UITableViewDataSource | null): void;

  setSearchResultsDelegate(searchResultsDelegate: UITableViewDelegate | null): void;

  setSearchResultsTitle(searchResultsTitle: string): void;
...
declare class UITableViewDiffableDataSource<SectionIdentifierType = interop.Object, ItemIdentifierType = interop.Object> extends NSObject implements UITableViewDataSource {
  ...
  setDefaultRowAnimation(defaultRowAnimation: interop.Enum<typeof UITableViewRowAnimation>): void;
...
declare class UITableViewPlaceholder extends NSObject {
  ...
  setCellUpdateHandler(cellUpdateHandler: (p1: UITableViewCell) => void | null): void;
}
...
declare class UIWindowScene extends UIScene {
  ...
  setActivityItemsConfigurationSource(activityItemsConfigurationSource: UIActivityItemsConfigurationProviding): void;
...
declare class UIScreenshotService extends NSObject {
  ...
  setDelegate(delegate: UIScreenshotServiceDelegate | null): void;
}
...
declare class UIGestureRecognizer extends NSObject {
  ...
  setDelegate(delegate: UIGestureRecognizerDelegate | null): void;

  isEnabled(): boolean;

  setEnabled(enabled: boolean): void;

  setCancelsTouchesInView(cancelsTouchesInView: boolean): void;

  setDelaysTouchesBegan(delaysTouchesBegan: boolean): void;

  setDelaysTouchesEnded(delaysTouchesEnded: boolean): void;

  setAllowedTouchTypes(allowedTouchTypes: NSArray<interop.Object> | Array<interop.Object>): void;

  setAllowedPressTypes(allowedPressTypes: NSArray<interop.Object> | Array<interop.Object>): void;

  setRequiresExclusiveTouchType(requiresExclusiveTouchType: boolean): void;
  ...
  setState(state: interop.Enum<typeof UIGestureRecognizerState>): void;
}
...
declare class UICollectionViewListCell extends UICollectionViewCell {
  ...
  setIndentsAccessories(indentsAccessories: boolean): void;
...
declare class NSLayoutManager extends NSObject implements NSSecureCoding {
  ...
  setDelegate(delegate: NSLayoutManagerDelegate | null): void;
  ...
  setUsesDefaultHyphenation(usesDefaultHyphenation: boolean): void;
  ...
  showCGGlyphsPositionsCountFontMatrixAttributesInContext(glyphs: interop.PointerConvertible, positions: interop.PointerConvertible, glyphCount: number, font: UIFont, textMatrix: CGAffineTransform, attributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>, graphicsContext: interop.Object): void;
...
declare class UIKeyboardLayoutGuide extends UITrackingLayoutGuide {
  ...
  setFollowsUndockedKeyboard(followsUndockedKeyboard: boolean): void;

  setUsesBottomSafeArea(usesBottomSafeArea: boolean): void;

  setKeyboardDismissPadding(keyboardDismissPadding: number): void;
}
...
declare class UICollectionViewDiffableDataSourceSectionSnapshotHandlers<ItemType = interop.Object> extends NSObject implements NSCopying {
  ...
  setShouldExpandItemHandler(shouldExpandItemHandler: (p1: interop.Object) => boolean | null): void;

  setWillExpandItemHandler(willExpandItemHandler: (p1: interop.Object) => void | null): void;

  setShouldCollapseItemHandler(shouldCollapseItemHandler: (p1: interop.Object) => boolean | null): void;

  setWillCollapseItemHandler(willCollapseItemHandler: (p1: interop.Object) => void | null): void;

  setSnapshotForExpandingParentItemHandler(snapshotForExpandingParentItemHandler: (p1: interop.Object, p2: NSDiffableDataSourceSectionSnapshot) => NSDiffableDataSourceSectionSnapshot | null): void;
...
declare class UICollectionViewTransitionLayout extends UICollectionViewLayout {
  ...
  setTransitionProgress(transitionProgress: number): void;
}
...
declare class UITraitCollection extends NSObject implements NSCopying, NSSecureCoding {
  ...
  static setCurrentTraitCollection(currentTraitCollection: UITraitCollection): void;
...
declare class UICollectionViewCell extends UICollectionReusableView {
  ...
  setConfigurationUpdateHandler(configurationUpdateHandler: (p1: UICollectionViewCell, p2: UICellConfigurationState) => void): void;
...
declare class UICollectionViewPlaceholder extends NSObject {
  ...
  setCellUpdateHandler(cellUpdateHandler: (p1: UICollectionViewCell) => void | null): void;
}
...
declare class NSStringDrawingContext extends NSObject {
  ...
  setMinimumTrackingAdjustment(minimumTrackingAdjustment: number): void;
}
...
declare class UIDocumentViewControllerLaunchOptions extends NSObject {
  ...
  setBrowserViewController(browserViewController: UIDocumentBrowserViewController): void;

  setTitle(title: string): void;

  setPrimaryAction(primaryAction: UIAction | null): void;

  setSecondaryAction(secondaryAction: UIAction | null): void;

  setDocumentTargetView(documentTargetView: UIView | null): void;

  setForegroundAccessoryView(foregroundAccessoryView: UIView | null): void;

  setBackgroundAccessoryView(backgroundAccessoryView: UIView | null): void;
...
declare class UIControl extends UIView {
  ...
  setContentVerticalAlignment(contentVerticalAlignment: interop.Enum<typeof UIControlContentVerticalAlignment>): void;

  setContentHorizontalAlignment(contentHorizontalAlignment: interop.Enum<typeof UIControlContentHorizontalAlignment>): void;
  ...
  setContextMenuInteractionEnabled(contextMenuInteractionEnabled: boolean): void;

  setShowsMenuAsPrimaryAction(showsMenuAsPrimaryAction: boolean): void;
...
declare class UIBackgroundConfiguration extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setBackgroundInsets(backgroundInsets: NSDirectionalEdgeInsets): void;

  setEdgesAddingLayoutMarginsToBackgroundInsets(edgesAddingLayoutMarginsToBackgroundInsets: interop.Enum<typeof NSDirectionalRectEdge>): void;

  setBackgroundColor(backgroundColor: UIColor | null): void;

  setBackgroundColorTransformer(backgroundColorTransformer: (p1: UIColor) => UIColor | null): void;

  setVisualEffect(visualEffect: UIVisualEffect | null): void;

  setImage(image: UIImage): void;

  setImageContentMode(imageContentMode: interop.Enum<typeof UIViewContentMode>): void;

  setStrokeColor(strokeColor: UIColor | null): void;

  setStrokeColorTransformer(strokeColorTransformer: (p1: UIColor) => UIColor | null): void;

  setStrokeWidth(strokeWidth: number): void;

  setStrokeOutset(strokeOutset: number): void;
...
declare class UIFindInteraction extends NSObject implements UIInteraction {
  ...
  isFindNavigatorVisible(): boolean;

  setSearchText(searchText: string | null): void;

  setReplacementText(replacementText: string | null): void;

  setOptionsMenuProvider(optionsMenuProvider: (p1: NSArray<interop.Object> | Array<interop.Object>) => UIMenu | null): void;
...
declare class UITabBarControllerSidebar extends NSObject {
  ...
  setDelegate(delegate: UITabBarControllerSidebarDelegate | null): void;

  isHidden(): boolean;

  setHidden(hidden: boolean): void;

  setPreferredLayout(preferredLayout: interop.Enum<typeof UITabBarControllerSidebarLayout>): void;

  setNavigationOverflowItems(navigationOverflowItems: UIDeferredMenuElement | null): void;

  setHeaderContentConfiguration(headerContentConfiguration: UIContentConfiguration): void;

  setFooterContentConfiguration(footerContentConfiguration: UIContentConfiguration): void;

  setBottomBarView(bottomBarView: UIView | null): void;
}
...
declare class UIWindow extends UIView {
  ...
  setCanResizeToFitContent(canResizeToFitContent: boolean): void;

  setWindowLevel(windowLevel: number): void;

  isKeyWindow(): boolean;

  setRootViewController(rootViewController: UIViewController): void;
...
declare class UIGravityBehavior extends UIDynamicBehavior {
  ...
  setGravityDirection(gravityDirection: CGVector): void;
...
declare class UISceneActivationRequestOptions extends NSObject {
  ...
  setRequestingScene(requestingScene: UIScene | null): void;
}
...
declare class UIToolTipInteraction extends NSObject implements UIInteraction {
  ...
  setDelegate(delegate: UIToolTipInteractionDelegate | null): void;

  isEnabled(): boolean;

  setEnabled(enabled: boolean): void;

  setDefaultToolTip(defaultToolTip: string | null): void;
...
declare class UIDragInteraction extends NSObject implements UIInteraction {
  ...
  setAllowsSimultaneousRecognitionDuringLift(allowsSimultaneousRecognitionDuringLift: boolean): void;
...
declare class UIBarItem extends NSObject implements NSCoding, UIAppearance {
  ...
  setLandscapeImagePhone(landscapeImagePhone: UIImage): void;

  setLargeContentSizeImage(largeContentSizeImage: UIImage): void;

  setImageInsets(imageInsets: UIEdgeInsets): void;

  setLandscapeImagePhoneInsets(landscapeImagePhoneInsets: UIEdgeInsets): void;

  setLargeContentSizeImageInsets(largeContentSizeImageInsets: UIEdgeInsets): void;
...
declare class UITextInputAssistantItem extends NSObject {
  ...
  setAllowsHidingShortcuts(allowsHidingShortcuts: boolean): void;

  setLeadingBarButtonGroups(leadingBarButtonGroups: NSArray<interop.Object> | Array<interop.Object>): void;

  setTrailingBarButtonGroups(trailingBarButtonGroups: NSArray<interop.Object> | Array<interop.Object>): void;
}
...
declare class UIButtonConfiguration extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setButtonSize(buttonSize: interop.Enum<typeof UIButtonConfigurationSize>): void;

  setMacIdiomStyle(macIdiomStyle: interop.Enum<typeof UIButtonConfigurationMacIdiomStyle>): void;
  ...
  setActivityIndicatorColorTransformer(activityIndicatorColorTransformer: (p1: UIColor) => UIColor | null): void;

  setTitle(title: string | null): void;

  setAttributedTitle(attributedTitle: NSAttributedString | null): void;

  setTitleTextAttributesTransformer(titleTextAttributesTransformer: (p1: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>) => NSDictionary | null): void;

  setTitleLineBreakMode(titleLineBreakMode: interop.Enum<typeof NSLineBreakMode>): void;

  setSubtitle(subtitle: string | null): void;

  setAttributedSubtitle(attributedSubtitle: NSAttributedString | null): void;

  setSubtitleTextAttributesTransformer(subtitleTextAttributesTransformer: (p1: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>) => NSDictionary | null): void;

  setSubtitleLineBreakMode(subtitleLineBreakMode: interop.Enum<typeof NSLineBreakMode>): void;

  setIndicator(indicator: interop.Enum<typeof UIButtonConfigurationIndicator>): void;

  setIndicatorColorTransformer(indicatorColorTransformer: (p1: UIColor) => UIColor): void;

  setContentInsets(contentInsets: NSDirectionalEdgeInsets): void;

  setImagePlacement(imagePlacement: interop.Enum<typeof NSDirectionalRectEdge>): void;

  setImagePadding(imagePadding: number): void;

  setTitlePadding(titlePadding: number): void;

  setTitleAlignment(titleAlignment: interop.Enum<typeof UIButtonConfigurationTitleAlignment>): void;

  setAutomaticallyUpdateForSelection(automaticallyUpdateForSelection: boolean): void;
...
declare class UIConversationContext extends NSObject {
  ...
  setEntries(entries: NSArray<interop.Object> | Array<interop.Object>): void;

  setSelfIdentifiers(selfIdentifiers: NSSet): void;

  setResponsePrimaryRecipientIdentifiers(responsePrimaryRecipientIdentifiers: NSSet): void;

  setParticipantNameByIdentifier(participantNameByIdentifier: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;
}
...
declare class UIToolbar extends UIView implements UIBarPositioning {
  ...
  setStandardAppearance(standardAppearance: UIToolbarAppearance): void;

  setCompactAppearance(compactAppearance: UIToolbarAppearance): void;

  setScrollEdgeAppearance(scrollEdgeAppearance: UIToolbarAppearance): void;

  setCompactScrollEdgeAppearance(compactScrollEdgeAppearance: UIToolbarAppearance): void;

  setDelegate(delegate: UIToolbarDelegate): void;
...
declare class UIAccessibilityCustomAction extends NSObject {
  ...
  setActionHandler(actionHandler: (p1: UIAccessibilityCustomAction) => boolean): void;
...
declare class UIBezierPath extends NSObject implements NSCopying, NSSecureCoding {
  ...
  static bezierPathWithCGPath<This extends abstract new (...args: any) => any>(this: This, CGPath: interop.Object): InstanceType<This>;
  ...
  setLineCapStyle(lineCapStyle: interop.Enum<typeof CGLineCap>): void;

  setLineJoinStyle(lineJoinStyle: interop.Enum<typeof CGLineJoin>): void;

  setMiterLimit(miterLimit: number): void;

  setFlatness(flatness: number): void;

  setUsesEvenOddFillRule(usesEvenOddFillRule: boolean): void;
...
declare class UICollectionView extends UIScrollView implements UIDataSourceTranslating {
  ...
  setPrefetchDataSource(prefetchDataSource: UICollectionViewDataSourcePrefetching): void;

  isPrefetchingEnabled(): boolean;

  setPrefetchingEnabled(prefetchingEnabled: boolean): void;

  setDragDelegate(dragDelegate: UICollectionViewDragDelegate): void;

  setDropDelegate(dropDelegate: UICollectionViewDropDelegate): void;

  setDragInteractionEnabled(dragInteractionEnabled: boolean): void;

  setReorderingCadence(reorderingCadence: interop.Enum<typeof UICollectionViewReorderingCadence>): void;

  setSelfSizingInvalidation(selfSizingInvalidation: interop.Enum<typeof UICollectionViewSelfSizingInvalidation>): void;
...
declare class UIAccessibilityCustomRotorItemResult extends NSObject {
  ...
  setTargetElement(targetElement: NSObject | null): void;

  setTargetRange(targetRange: UITextRange | null): void;
}
...
declare class UIHoverStyle extends NSObject implements NSCopying {
  ...
  setEffect(effect: UIHoverEffect): void;
...
declare class UITabBarItem extends UIBarItem {
  ...
  setBadgeColor(badgeColor: UIColor): void;
...
declare class UIDocumentBrowserTransitionController extends NSObject implements UIViewControllerAnimatedTransitioning {
  ...
  setLoadingProgress(loadingProgress: NSProgress | null): void;
...
declare class UIListSeparatorConfiguration extends NSObject implements NSCopying, NSSecureCoding {
  ...
  setTopSeparatorVisibility(topSeparatorVisibility: interop.Enum<typeof UIListSeparatorVisibility>): void;

  setBottomSeparatorVisibility(bottomSeparatorVisibility: interop.Enum<typeof UIListSeparatorVisibility>): void;

  setTopSeparatorInsets(topSeparatorInsets: NSDirectionalEdgeInsets): void;

  setBottomSeparatorInsets(bottomSeparatorInsets: NSDirectionalEdgeInsets): void;

  setColor(color: UIColor): void;

  setMultipleSelectionColor(multipleSelectionColor: UIColor): void;

  setVisualEffect(visualEffect: UIVisualEffect): void;
...
declare class UIDevice extends NSObject {
  ...
  setBatteryMonitoringEnabled(batteryMonitoringEnabled: boolean): void;

  isProximityMonitoringEnabled(): boolean;

  setProximityMonitoringEnabled(proximityMonitoringEnabled: boolean): void;
...
declare class UIImageReaderConfiguration extends NSObject implements NSCopying {
  ...
  setPrefersHighDynamicRange(prefersHighDynamicRange: boolean): void;

  setPreparesImagesForDisplay(preparesImagesForDisplay: boolean): void;

  setPreferredThumbnailSize(preferredThumbnailSize: CGSize): void;
...
declare class UIImage extends NSObject implements NSSecureCoding {
  ...
  static imageWithCGImage(cgImage: interop.Object): UIImage;

  static imageWithCGImageScaleOrientation(cgImage: interop.Object, scale: number, orientation: interop.Enum<typeof UIImageOrientation>): UIImage;
  ...
  initWithCGImageScaleOrientation(cgImage: interop.Object, scale: number, orientation: interop.Enum<typeof UIImageOrientation>): this;
...
declare class UIActivityItemsConfiguration extends NSObject implements UIActivityItemsConfigurationReading {
  ...
  setSupportedInteractions(supportedInteractions: NSArray<interop.Object> | Array<interop.Object>): void;

  setMetadataProvider(metadataProvider: (p1: string) => interop.Object | null): void;

  setPerItemMetadataProvider(perItemMetadataProvider: (p1: number, p2: string) => interop.Object | null): void;

  setPreviewProvider(previewProvider: (p1: number, p2: string, p3: CGSize) => NSItemProvider | null): void;

  setApplicationActivitiesProvider(applicationActivitiesProvider: () => NSArray | null): void;
...
declare class UILocalNotification extends NSObject implements NSCopying, NSCoding {
  ...
  setFireDate(fireDate: NSDate | null): void;

  setTimeZone(timeZone: NSTimeZone | null): void;

  setRepeatInterval(repeatInterval: interop.Enum<typeof NSCalendarUnit>): void;

  setRepeatCalendar(repeatCalendar: NSCalendar | null): void;

  setRegion(region: CLRegion | null): void;

  setRegionTriggersOnce(regionTriggersOnce: boolean): void;

  setAlertBody(alertBody: string | null): void;

  setHasAction(hasAction: boolean): void;

  setAlertAction(alertAction: string | null): void;

  setAlertLaunchImage(alertLaunchImage: string | null): void;
...
declare class UITextField extends UIControl implements UITextInput, NSCoding, UIContentSizeCategoryAdjusting, UILetterformAwareAdjusting {
  ...
  setBorderStyle(borderStyle: interop.Enum<typeof UITextBorderStyle>): void;

  setDefaultTextAttributes(defaultTextAttributes: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object>): void;

  setPlaceholder(placeholder: string | null): void;

  setAttributedPlaceholder(attributedPlaceholder: NSAttributedString): void;

  setClearsOnBeginEditing(clearsOnBeginEditing: boolean): void;

  setAdjustsFontSizeToFitWidth(adjustsFontSizeToFitWidth: boolean): void;

  setMinimumFontSize(minimumFontSize: number): void;

  setDelegate(delegate: UITextFieldDelegate | null): void;

  setBackground(background: UIImage | null): void;

  setDisabledBackground(disabledBackground: UIImage | null): void;
  ...
  setClearButtonMode(clearButtonMode: interop.Enum<typeof UITextFieldViewMode>): void;

  setLeftView(leftView: UIView | null): void;

  setLeftViewMode(leftViewMode: interop.Enum<typeof UITextFieldViewMode>): void;

  setRightView(rightView: UIView | null): void;

  setRightViewMode(rightViewMode: interop.Enum<typeof UITextFieldViewMode>): void;
...
declare class UIPickerView extends UIView implements NSCoding {
  ...
  setDataSource(dataSource: UIPickerViewDataSource | null): void;

  setDelegate(delegate: UIPickerViewDelegate | null): void;

  setShowsSelectionIndicator(showsSelectionIndicator: boolean): void;
...
declare class UIPrintInteractionController extends NSObject {
  ...
  setPrintInfo(printInfo: UIPrintInfo | null): void;

  setDelegate(delegate: UIPrintInteractionControllerDelegate | null): void;

  setShowsPageRange(showsPageRange: boolean): void;

  setShowsNumberOfCopies(showsNumberOfCopies: boolean): void;

  setShowsPaperSelectionForLoadedPapers(showsPaperSelectionForLoadedPapers: boolean): void;

  setShowsPaperOrientation(showsPaperOrientation: boolean): void;

  setPrintPageRenderer(printPageRenderer: UIPrintPageRenderer | null): void;

  setPrintFormatter(printFormatter: UIPrintFormatter | null): void;

  setPrintingItem(printingItem: interop.Object | null): void;
...
declare class UICellAccessoryPopUpMenu extends UICellAccessory {
  ...
  setSelectedElementDidChangeHandler(selectedElementDidChangeHandler: (p1: UIMenu) => void | null): void;
}
...
declare class UICollisionBehavior extends UIDynamicBehavior {
  ...
  setCollisionMode(collisionMode: interop.Enum<typeof UICollisionBehaviorMode>): void;

  setTranslatesReferenceBoundsIntoBoundary(translatesReferenceBoundsIntoBoundary: boolean): void;
...
declare class NSMutableParagraphStyle extends NSParagraphStyle {
  ...
  setFirstLineHeadIndent(firstLineHeadIndent: number): void;

  setHeadIndent(headIndent: number): void;

  setTailIndent(tailIndent: number): void;

  setLineBreakMode(lineBreakMode: interop.Enum<typeof NSLineBreakMode>): void;

  setMinimumLineHeight(minimumLineHeight: number): void;

  setMaximumLineHeight(maximumLineHeight: number): void;

  setBaseWritingDirection(baseWritingDirection: interop.Enum<typeof NSWritingDirection>): void;

  setLineHeightMultiple(lineHeightMultiple: number): void;

  setParagraphSpacingBefore(paragraphSpacingBefore: number): void;

  setHyphenationFactor(hyphenationFactor: number): void;

  setUsesDefaultHyphenation(usesDefaultHyphenation: boolean): void;

  setTabStops(tabStops: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setDefaultTabInterval(defaultTabInterval: number): void;

  setAllowsDefaultTighteningForTruncation(allowsDefaultTighteningForTruncation: boolean): void;

  setLineBreakStrategy(lineBreakStrategy: interop.Enum<typeof NSLineBreakStrategy>): void;

  setTextLists(textLists: NSArray<interop.Object> | Array<interop.Object>): void;

  // @ts-ignore MemberDecl.tsIgnore
  alignment: interop.Enum<typeof NSTextAlignment>;

  setAlignment(alignment: interop.Enum<typeof NSTextAlignment>): void;
}
...
declare class UISlider extends UIControl implements NSCoding {
  ...
  setMinimumValueImage(minimumValueImage: UIImage | null): void;

  setMaximumValueImage(maximumValueImage: UIImage | null): void;
  ...
  setThumbTintColor(thumbTintColor: UIColor): void;
...
declare class UICellAccessoryOutlineDisclosure extends UICellAccessory {
  ...
  setStyle(style: interop.Enum<typeof UICellAccessoryOutlineDisclosureStyle>): void;
...
declare class UIPrinterPickerController extends NSObject {
  ...
  setDelegate(delegate: UIPrinterPickerControllerDelegate | null): void;
}
...
declare class UISwitch extends UIControl implements NSCoding {
  ...
  setOnTintColor(onTintColor: UIColor): void;

  setThumbTintColor(thumbTintColor: UIColor): void;

  setOnImage(onImage: UIImage): void;

  setOffImage(offImage: UIImage): void;

  setTitle(title: string): void;

  setPreferredStyle(preferredStyle: interop.Enum<typeof UISwitchStyle>): void;
...
declare class NSCollectionLayoutBoundarySupplementaryItem extends NSCollectionLayoutSupplementaryItem implements NSCopying {
  ...
  setExtendsBoundary(extendsBoundary: boolean): void;

  setPinToVisibleBounds(pinToVisibleBounds: boolean): void;
...
declare class UICollectionViewFlowLayout extends UICollectionViewLayout {
  ...
  setMinimumLineSpacing(minimumLineSpacing: number): void;

  setMinimumInteritemSpacing(minimumInteritemSpacing: number): void;

  setItemSize(itemSize: CGSize): void;

  setEstimatedItemSize(estimatedItemSize: CGSize): void;

  setScrollDirection(scrollDirection: interop.Enum<typeof UICollectionViewScrollDirection>): void;

  setHeaderReferenceSize(headerReferenceSize: CGSize): void;

  setFooterReferenceSize(footerReferenceSize: CGSize): void;

  setSectionInset(sectionInset: UIEdgeInsets): void;

  setSectionInsetReference(sectionInsetReference: interop.Enum<typeof UICollectionViewFlowLayoutSectionInsetReference>): void;
...
declare class UIBarButtonItemStateAppearance extends NSObject {
  ...
  setBackgroundImagePositionAdjustment(backgroundImagePositionAdjustment: UIOffset): void;
}
...
declare class UICollectionLayoutSectionOrthogonalScrollingProperties extends NSObject implements NSCopying {
  ...
  setBounce(bounce: interop.Enum<typeof UICollectionLayoutSectionOrthogonalScrollingBounce>): void;
...
declare class UIActivityIndicatorView extends UIView implements NSCoding {
  ...
  setActivityIndicatorViewStyle(activityIndicatorViewStyle: interop.Enum<typeof UIActivityIndicatorViewStyle>): void;

  setHidesWhenStopped(hidesWhenStopped: boolean): void;
...
declare class UITextInteraction extends NSObject implements UIInteraction {
  ...
  setDelegate(delegate: UITextInteractionDelegate | null): void;

  setTextInput(textInput: UIResponder | null): void;
...
declare class UIWindowSceneActivationRequestOptions extends UISceneActivationRequestOptions {
  ...
  setPreferredPresentationStyle(preferredPresentationStyle: interop.Enum<typeof UIWindowScenePresentationStyle>): void;

  setPlacement(placement: UIWindowScenePlacement): void;
}
