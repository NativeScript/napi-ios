...
declare class unnamed_14979234733914535558 {
  constructor(init?: unnamed_14979234733914535558);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_1165010876048433935Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_1165010876048433935 {
  constructor(init?: unnamed_1165010876048433935Descriptor);
  elements: unknown /* const array */;
}
