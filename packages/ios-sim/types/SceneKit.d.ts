...
declare class SCNSkinner extends NSObject implements NSSecureCoding {
  ...
  setBaseGeometryBindTransform(baseGeometryBindTransform: SCNMatrix4): void;
...
declare class SCNView extends UIView implements SCNSceneRenderer, SCNTechniqueSupport {
  ...
  setEaglContext(eaglContext: EAGLContext): void;
...
declare class SCNMaterialProperty extends NSObject implements SCNAnimatable, NSSecureCoding {
  ...
  setContentsTransform(contentsTransform: SCNMatrix4): void;
...
declare class SCNNode extends NSObject implements NSCopying, NSSecureCoding, SCNAnimatable, SCNActionable, SCNBoundingVolume {
  ...
  setTransform(transform: SCNMatrix4): void;
  ...
  setPivot(pivot: SCNMatrix4): void;
...
declare class SCNPhysicsConeTwistJoint extends SCNPhysicsBehavior {
  ...
  setFrameA(frameA: SCNMatrix4): void;

  setFrameB(frameB: SCNMatrix4): void;
