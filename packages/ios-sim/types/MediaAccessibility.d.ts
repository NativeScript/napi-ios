...
declare function MACaptionAppearanceCopyProfileIDs(): interop.Pointer;

declare function MACaptionAppearanceSetActiveProfileID(profileID: interop.PointerConvertible): void;

declare function MACaptionAppearanceCopyActiveProfileID(): interop.Pointer;

declare function MACaptionAppearanceCopyProfileName(profileID: interop.PointerConvertible): interop.Pointer;

declare function MACaptionAppearanceExecuteBlockForProfileID(profileID: interop.PointerConvertible, aBlock: () => void): void;
