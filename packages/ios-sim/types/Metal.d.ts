...
declare class unnamed_10354799456500052124 {
  constructor(init?: unnamed_10354799456500052124);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_673997453788650126Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_673997453788650126 {
  constructor(init?: unnamed_673997453788650126Descriptor);
  elements: unknown /* const array */;
}
