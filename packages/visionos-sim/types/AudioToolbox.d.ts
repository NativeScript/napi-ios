...
declare class AudioUnitEvent {
  ...
  mArgument: unnamed_9015510150500264393;
}
...
declare class unnamed_14709820072591815379 {
  constructor(init?: unnamed_14709820072591815379);
...
declare class AUNodeInteraction {
  ...
  nodeInteraction: unnamed_1590973997601198405;
}
...
declare class AudioUnitParameterEvent {
  ...
  eventValues: unnamed_10729461140716182021;
}
...
declare class unnamed_6292324771014946850 {
  constructor(init?: unnamed_6292324771014946850);
  bufferOffset: number;
  value: number;
}
...
type unnamed_1590973997601198405Descriptor = 
  | { connection: AudioUnitNodeConnection }
  | { inputCallback: AUNodeRenderCallback };

declare class unnamed_1590973997601198405 {
  constructor(init?: unnamed_1590973997601198405Descriptor);
  connection: AudioUnitNodeConnection;
  inputCallback: AUNodeRenderCallback;
}

type unnamed_9015510150500264393Descriptor = 
  | { mParameter: AudioUnitParameter }
  | { mProperty: AudioUnitProperty };

declare class unnamed_9015510150500264393 {
  constructor(init?: unnamed_9015510150500264393Descriptor);
  mParameter: AudioUnitParameter;
  mProperty: AudioUnitProperty;
}

type unnamed_10729461140716182021Descriptor = 
  | { ramp: unnamed_14709820072591815379 }
  | { immediate: unnamed_6292324771014946850 };

declare class unnamed_10729461140716182021 {
  constructor(init?: unnamed_10729461140716182021Descriptor);
  ramp: unnamed_14709820072591815379;
  immediate: unnamed_6292324771014946850;
}
