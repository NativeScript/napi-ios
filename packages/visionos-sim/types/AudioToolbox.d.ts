...
declare const kAudioQueueProperty_IntendedSpatialExperience: number;
...
declare const kAudioOutputUnitProperty_IntendedSpatialExperience: number;
...
declare const kAudioServicesDetailIntendedSpatialExperience: interop.Pointer;
...
declare const CASoundStageSize: {
  Automatic: 0,
  Small: 1,
  Medium: 2,
  Large: 3,
...
declare class AudioUnitEvent {
  ...
  mArgument: unnamed_11734474731843396765;
}
...
declare class unnamed_9781002033135513415 {
  constructor(init?: unnamed_9781002033135513415);
  bufferOffset: number;
  value: number;
}

declare class unnamed_16351774428447476537 {
  constructor(init?: unnamed_16351774428447476537);
...
declare class AudioUnitParameterEvent {
  ...
  eventValues: unnamed_13691159510206185705;
}
...
declare class AUNodeInteraction {
  ...
  nodeInteraction: unnamed_14675730699543696373;
}
...
type unnamed_11734474731843396765Descriptor = 
  | { mParameter: AudioUnitParameter }
  | { mProperty: AudioUnitProperty };

declare class unnamed_11734474731843396765 {
  constructor(init?: unnamed_11734474731843396765Descriptor);
  mParameter: AudioUnitParameter;
  mProperty: AudioUnitProperty;
}

type unnamed_14675730699543696373Descriptor = 
  | { connection: AudioUnitNodeConnection }
  | { inputCallback: AUNodeRenderCallback };

declare class unnamed_14675730699543696373 {
  constructor(init?: unnamed_14675730699543696373Descriptor);
  connection: AudioUnitNodeConnection;
  inputCallback: AUNodeRenderCallback;
}

type unnamed_13691159510206185705Descriptor = 
  | { ramp: unnamed_16351774428447476537 }
  | { immediate: unnamed_9781002033135513415 };

declare class unnamed_13691159510206185705 {
  constructor(init?: unnamed_13691159510206185705Descriptor);
  ramp: unnamed_16351774428447476537;
  immediate: unnamed_9781002033135513415;
}
...
declare function AudioOutputUnitPublish(inDesc: interop.PointerConvertible, inName: interop.Object, inVersion: number, inOutputUnit: interop.PointerConvertible): number;
...
declare function AudioConverterFillComplexBufferWithPacketDependencies(inAudioConverter: interop.PointerConvertible, inInputDataProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number, inInputDataProcUserData: interop.PointerConvertible, ioOutputDataPacketSize: interop.PointerConvertible, outOutputData: interop.PointerConvertible, outPacketDescriptions: interop.PointerConvertible, outPacketDependencies: interop.PointerConvertible): number;
...
declare function AudioFileWritePacketsWithDependencies(inAudioFile: interop.PointerConvertible, inUseCache: number, inNumBytes: number, inPacketDescriptions: interop.PointerConvertible, inPacketDependencies: interop.PointerConvertible, inStartingPacket: number, ioNumPackets: interop.PointerConvertible, inBuffer: interop.PointerConvertible): number;
...
declare function AudioSessionInitialize(inRunLoop: interop.Object, inRunLoopMode: interop.Object, inInterruptionListener: (p1: interop.PointerConvertible, p2: number) => void, inClientData: interop.PointerConvertible): number;
...
declare function AudioServicesPlaySystemSoundWithDetails(inSystemSoundID: number, inDetails: interop.Object, inCompletionBlock: () => void): void;

declare function AudioServicesPlayAlertSoundWithDetails(inSystemSoundID: number, inDetails: interop.Object, inCompletionBlock: () => void): void;
...
declare class CAFrontAnchoringStrategy extends CAAnchoringStrategy {
  init(): this;
...
declare class AUAudioUnit extends NSObject {
  ...
  setIntendedSpatialExperience(intendedSpatialExperience: CASpatialAudioExperience): void;
  ...
  requestViewControllerWithCompletionHandler(completionHandler: (p1: UIViewController) => void | null): void;
...
declare class CASceneAnchoringStrategy extends CAAnchoringStrategy {
  initWithSceneIdentifier(sceneIdentifier: string): this;

  readonly sceneIdentifier: string;
}
...
declare class CAFixedSpatialAudio extends CASpatialAudioExperience {
  initWithSoundStageSize(soundStageSize: interop.Enum<typeof CASoundStageSize>): this;

  readonly soundStageSize: interop.Enum<typeof CASoundStageSize>;
}

declare class CABypassedSpatialAudio extends CASpatialAudioExperience {
  init(): this;

  static new<This extends abstract new (...args: any) => any>(this: This): InstanceType<This>;
}

declare class CAAutomaticSpatialAudio extends CASpatialAudioExperience {
  init(): this;

  static new<This extends abstract new (...args: any) => any>(this: This): InstanceType<This>;
}

declare class CASpatialAudioExperience extends NSObject implements NSSecureCoding, NSCopying {
...
declare class CAAnchoringStrategy extends NSObject implements NSSecureCoding, NSCopying {
  static readonly supportsSecureCoding: boolean;
...
declare class CAHeadTrackedSpatialAudio extends CASpatialAudioExperience {
  initWithSoundStageSizeAnchoringStrategy(soundStageSize: interop.Enum<typeof CASoundStageSize>, anchoringStrategy: CAAnchoringStrategy): this;

  readonly soundStageSize: interop.Enum<typeof CASoundStageSize>;

  readonly anchoringStrategy: CAAnchoringStrategy;
}

declare class CAAutomaticAnchoringStrategy extends CAAnchoringStrategy {
  init(): this;
