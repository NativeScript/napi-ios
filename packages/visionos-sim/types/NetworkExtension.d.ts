...
declare class NEHotspotConfigurationManager extends NSObject {
  ...
  joinAccessoryHotspotPassphraseCompletionHandler(accessory: interop.Object, passphrase: string, completionHandler: (p1: NSError) => void | null): void;

  joinAccessoryHotspotWithoutSecurityCompletionHandler(accessory: interop.Object, completionHandler: (p1: NSError) => void | null): void;
}
