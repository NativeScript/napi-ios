...
declare const UIProposedSceneSizeNoPreference: number;
...
declare const UISceneSessionRoleImmersiveSpaceApplication: string;
...
declare const UIWindowSceneSessionRoleVolumetricApplication: string;
...
declare const UIContainerBackgroundStyle: {
  Automatic: 0,
  Glass: 1,
  Hidden: 2,
};
...
declare const UIWindowSceneResizingRestrictions: {
  Unspecified: 0,
  None: 1,
  Uniform: 2,
  Freeform: 3,
...
declare class UIScene extends UIResponder {
  ...
  getDefaultAudioSessionWithCompletionHandler(handler: (p1: AVAudioSession) => void | null): void;
}
...
declare class UIWindowScenePushPlacement extends UIWindowScenePlacement {
  static placementTargetingSceneSession<This extends abstract new (...args: any) => any>(this: This, targetSceneSession: UISceneSession): InstanceType<This>;
}
...
declare class UIViewController extends UIResponder implements NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment {
  ...
  readonly preferredContainerBackgroundStyle: interop.Enum<typeof UIContainerBackgroundStyle>;

  readonly childViewControllerForPreferredContainerBackgroundStyle: UIViewController;

  setNeedsUpdateOfPreferredContainerBackgroundStyle(): void;
...
declare class UIScrollView extends UIView implements NSCoding, UIFocusItemScrollableContainer {
  ...
  lookToScrollAxes: interop.Enum<typeof UIAxis>;
  ...
  setLookToScrollAxes(lookToScrollAxes: interop.Enum<typeof UIAxis>): void;
...
declare class UIWindowSceneGeometry extends NSObject implements NSCopying {
  ...
  readonly resizingRestrictions: interop.Enum<typeof UIWindowSceneResizingRestrictions>;
...
declare class UIWindowSceneReplacePlacement extends UIWindowScenePlacement {
  static placementToReplaceSceneSession<This extends abstract new (...args: any) => any>(this: This, sceneSession: UISceneSession): InstanceType<This>;
}
...
declare class UIWindowSceneGeometryPreferencesVision extends UIWindowSceneGeometryPreferences {
  init(): this;
  ...
  resizingRestrictions: interop.Enum<typeof UIWindowSceneResizingRestrictions>;
  ...
  setResizingRestrictions(resizingRestrictions: interop.Enum<typeof UIWindowSceneResizingRestrictions>): void;
}
...
declare class UIWindow extends UIView {
  ...
  readonly avDisplayManager: AVDisplayManager;
}
...
declare class UITextInputAssistantItem extends NSObject {
  keyboardActionButtonItem: UIBarButtonItem;

  setKeyboardActionButtonItem(keyboardActionButtonItem: UIBarButtonItem): void;
}
...
declare class UIHoverEffectLayer extends CALayer {
  hoverStyle: UIHoverStyle;

  containerView: UIView;

  initWithContainerViewStyle(containerView: UIView, style: UIHoverStyle | null): this;
...
declare class UISceneDestructionCondition extends NSObject implements NSCopying {
  static userInitiatedDismissal<This extends abstract new (...args: any) => any>(this: This): InstanceType<This>;

  static systemDisconnection<This extends abstract new (...args: any) => any>(this: This): InstanceType<This>;
