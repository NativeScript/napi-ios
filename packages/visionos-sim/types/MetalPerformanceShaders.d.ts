...
declare class unnamed_2498738494923158847 {
  constructor(init?: unnamed_2498738494923158847);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_10008647910719470680Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_10008647910719470680 {
  constructor(init?: unnamed_10008647910719470680Descriptor);
  elements: unknown /* const array */;
}
