...
declare class unnamed_2723874917396922861 {
  constructor(init?: unnamed_2723874917396922861);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_15112646431689129659Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_15112646431689129659 {
  constructor(init?: unnamed_15112646431689129659Descriptor);
  elements: unknown /* const array */;
}
