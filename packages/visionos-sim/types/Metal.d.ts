...
declare class unnamed_12745174315002407851 {
  constructor(init?: unnamed_12745174315002407851);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_12601174711399574770Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_12601174711399574770 {
  constructor(init?: unnamed_12601174711399574770Descriptor);
  elements: unknown /* const array */;
}

type unnamed_8220879180120924189Descriptor = 
  | { _impl: number }
  | { textureID: number };

declare class unnamed_8220879180120924189 {
