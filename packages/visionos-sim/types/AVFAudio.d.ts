...
declare const AVAudioSessionSpatialExperienceOptionSceneIdentifier: string;

declare const AVAudioSessionSpatialExperienceOptionAnchoringStrategy: string;
...
declare const AVAudioSessionSpatialExperienceOptionSoundStageSize: string;
...
declare const AVAudioSessionSpatialExperience: {
  HeadTracked: 0,
  Fixed: 1,
  Bypassed: 2,
};

declare const AVAudioSessionAnchoringStrategy: {
  Automatic: 0,
  Scene: 1,
  Front: 2,
};
...
declare class AVAudioSession extends NSObject {
  ...
  setIntendedSpatialExperienceOptionsError(intendedSpatialExperience: interop.Enum<typeof AVAudioSessionSpatialExperience>, options: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null, error: interop.PointerConvertible): boolean;

  readonly intendedSpatialExperience: interop.Enum<typeof AVAudioSessionSpatialExperience>;

  readonly intendedSpatialExperienceOptions: NSDictionary;

  readonly isNowPlayingCandidate: boolean;

  setIsNowPlayingCandidateError(inValue: boolean, outError: interop.PointerConvertible): boolean;
