...
declare const PHASERenderingMode: {
  Local: 0,
  Client: 1,
};
...
declare class PHASEEngine extends NSObject {
  ...
  initWithUpdateModeRenderingMode(updateMode: interop.Enum<typeof PHASEUpdateMode>, renderingMode: interop.Enum<typeof PHASERenderingMode>): this;
