...
declare class unnamed_11229749378931227347 {
  constructor(init?: unnamed_11229749378931227347);
  words: unknown /* const array */;
}

declare class unnamed_4341833070770911152 {
  constructor(init?: unnamed_4341833070770911152);
  note: number;
  options: interop.Enum<typeof MIDIPerNoteManagementOptions>;
  reserved: unknown /* const array */;
}

declare class unnamed_9365067863999930105 {
  constructor(init?: unnamed_9365067863999930105);
  noteNumber: number;
  index: number;
  data: number;
}

declare class unnamed_11079536408219299493 {
  constructor(init?: unnamed_11079536408219299493);
  data: number;
  reserved: unknown /* const array */;
}

declare class unnamed_2453406025910281458 {
  constructor(init?: unnamed_2453406025910281458);
  number: number;
...
declare class unnamed_3630296752677137420 {
  constructor(init?: unnamed_3630296752677137420);
...
declare class unnamed_16469762400125193370 {
  constructor(init?: unnamed_16469762400125193370);
  number: number;
  velocity: number;
}

declare class unnamed_16948144402283104916 {
  constructor(init?: unnamed_16948144402283104916);
...
declare class unnamed_15628975326588054731 {
  constructor(init?: unnamed_15628975326588054731);
  index: number;
  data: number;
}
...
declare class unnamed_15112753296599769065 {
  constructor(init?: unnamed_15112753296599769065);
  noteNumber: number;
  pressure: number;
}

declare class unnamed_12119816243751031541 {
  constructor(init?: unnamed_12119816243751031541);
...
declare class unnamed_1533749640487775227 {
  constructor(init?: unnamed_1533749640487775227);
  data: number;
  reserved: unknown /* const array */;
}

declare class unnamed_3562042656980034494 {
  constructor(init?: unnamed_3562042656980034494);
  noteNumber: number;
  reserved: number;
  pressure: number;
}

declare class unnamed_3912000309305837205 {
  constructor(init?: unnamed_3912000309305837205);
  bank: number;
  index: number;
  data: number;
}

declare class unnamed_14085672384342097189 {
  constructor(init?: unnamed_14085672384342097189);
  mdsID: number;
  data: unknown /* const array */;
  reserved: number;
}
...
declare class unnamed_10535423383069752282 {
  constructor(init?: unnamed_10535423383069752282);
  status: interop.Enum<typeof MIDIUtilityStatus>;
}

declare class unnamed_1600777185226163851 {
  constructor(init?: unnamed_1600777185226163851);
  status: interop.Enum<typeof MIDISysExStatus>;
}

declare class unnamed_10282308343083948317 {
  constructor(init?: unnamed_10282308343083948317);
...
declare class unnamed_1749282032382991033 {
  constructor(init?: unnamed_1749282032382991033);
  status: interop.Enum<typeof MIDICVStatus>;
  channel: number;
  reserved: unknown /* const array */;
}

declare class unnamed_3280983773643762796 {
  constructor(init?: unnamed_3280983773643762796);
  noteNumber: number;
  reserved: number;
  bend: number;
}
...
declare class unnamed_6325616776174310759 {
  constructor(init?: unnamed_6325616776174310759);
  index: number;
  reserved: number;
  data: number;
}
...
declare class unnamed_6700468534898528243 {
  constructor(init?: unnamed_6700468534898528243);
  byteCount: number;
  streamID: number;
  data: unknown /* const array */;
  reserved: number;
...
type unnamed_1378872614749844662Descriptor = 
  | { sysex8: unnamed_6700468534898528243 }
  | { mixedDataSet: unnamed_14085672384342097189 };

declare class unnamed_1378872614749844662 {
  constructor(init?: unnamed_1378872614749844662Descriptor);
  sysex8: unnamed_6700468534898528243;
  mixedDataSet: unnamed_14085672384342097189;
}

type unnamed_13294870382533590120Descriptor = 
  | { note: unnamed_16469762400125193370 }
  | { polyPressure: unnamed_15112753296599769065 }
  | { controlChange: unnamed_15628975326588054731 }
  | { program: number }
  | { channelPressure: number }
  | { pitchBend: number };

declare class unnamed_13294870382533590120 {
  constructor(init?: unnamed_13294870382533590120Descriptor);
  note: unnamed_16469762400125193370;
  polyPressure: unnamed_15112753296599769065;
  controlChange: unnamed_15628975326588054731;
  program: number;
...
type unnamed_12945445162203778387Descriptor = 
  | { jitterReductionClock: number }
  | { jitterReductionTimestamp: number };

declare class unnamed_12945445162203778387 {
  constructor(init?: unnamed_12945445162203778387Descriptor);
  jitterReductionClock: number;
  jitterReductionTimestamp: number;
}

type unnamed_6868251867237722313Descriptor = 
  | { utility: unnamed_10535423383069752282 }
  | { system: unnamed_16948144402283104916 }
  | { channelVoice1: unnamed_12119816243751031541 }
  | { sysEx: unnamed_3630296752677137420 }
  | { channelVoice2: unnamed_1749282032382991033 }
  | { data128: unnamed_1600777185226163851 }
  | { unknown: unnamed_11229749378931227347 };

declare class unnamed_6868251867237722313 {
  constructor(init?: unnamed_6868251867237722313Descriptor);
  utility: unnamed_10535423383069752282;
  system: unnamed_16948144402283104916;
  channelVoice1: unnamed_12119816243751031541;
  sysEx: unnamed_3630296752677137420;
...
type unnamed_1097537111394446340Descriptor = 
  | { note: unnamed_2453406025910281458 }
  | { polyPressure: unnamed_3562042656980034494 }
  | { controlChange: unnamed_6325616776174310759 }
  | { programChange: unnamed_10282308343083948317 }
  | { channelPressure: unnamed_11079536408219299493 }
  | { pitchBend: unnamed_1533749640487775227 }
  | { perNoteController: unnamed_9365067863999930105 }
  | { controller: unnamed_3912000309305837205 }
  | { perNotePitchBend: unnamed_3280983773643762796 }
  | { perNoteManagement: unnamed_4341833070770911152 };

declare class unnamed_1097537111394446340 {
  constructor(init?: unnamed_1097537111394446340Descriptor);
  note: unnamed_2453406025910281458;
  polyPressure: unnamed_3562042656980034494;
  controlChange: unnamed_6325616776174310759;
  programChange: unnamed_10282308343083948317;
...
type unnamed_11691991629268526971Descriptor = 
  | { timeCode: number }
  | { songPositionPointer: number }
  | { songSelect: number };

declare class unnamed_11691991629268526971 {
