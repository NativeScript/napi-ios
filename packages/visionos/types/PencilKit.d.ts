...
declare interface PKToolPickerDelegate extends NSObjectProtocol {
  toolPickerWillDismiss?(toolPicker: PKToolPicker): boolean;
}
...
declare class PKToolPicker extends NSObject {
  ...
  prefersDismissControlVisible: boolean;
  ...
  setPrefersDismissControlVisible(prefersDismissControlVisible: boolean): void;
