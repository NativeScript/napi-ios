...
declare const AXPrefersHeadAnchorAlternativeDidChangeNotification: string;
...
declare const AXHearingDeviceEar: {
  None: 0,
  Left: 2,
  Right: 4,
  Both: 6,
...
declare function AXMFiHearingDevicePairedUUIDs(): NSArray;
...
declare function AXPrefersHeadAnchorAlternative(): boolean;
