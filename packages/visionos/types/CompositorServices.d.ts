...
declare function cp_layer_renderer_capabilities_supported_color_formats_count(layer_capabilities: CP_OBJECT_cp_layer_renderer_capabilities): number;
...
declare function cp_layer_renderer_capabilities_supported_color_format(layer_capabilities: CP_OBJECT_cp_layer_renderer_capabilities, index: number): interop.Enum<typeof MTLPixelFormat>;
...
declare function cp_view_get_tangents(view: interop.PointerConvertible): unknown /* ext vector */;
...
declare function cp_drawable_is_content_capture_protected(drawable: interop.PointerConvertible): boolean;
...
declare function cp_frame_query_drawable(frame: interop.PointerConvertible): interop.Pointer;
