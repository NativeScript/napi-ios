...
declare class unnamed_10809255899350814379 {
  constructor(init?: unnamed_10809255899350814379);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_5818498586629225743Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_5818498586629225743 {
  constructor(init?: unnamed_5818498586629225743Descriptor);
  elements: unknown /* const array */;
}
