...
declare class unnamed_14791846614349894283 {
  constructor(init?: unnamed_14791846614349894283);
  x: number;
  y: number;
  z: number;
}
...
type unnamed_3000082598278752657Descriptor = 
  | { elements: unknown /* const array */ };

declare class unnamed_3000082598278752657 {
  constructor(init?: unnamed_3000082598278752657Descriptor);
  elements: unknown /* const array */;
}
