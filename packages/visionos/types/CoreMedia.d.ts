...
declare function CMTimebaseAddTimerDispatchSource(timebase: interop.PointerConvertible, timerSource: interop.Object): number;

declare function CMTimebaseRemoveTimerDispatchSource(timebase: interop.PointerConvertible, timerSource: interop.Object): number;

declare function CMTimebaseSetTimerDispatchSourceNextFireTime(timebase: interop.PointerConvertible, timerSource: interop.Object, fireTime: CMTime, flags: number): number;

declare function CMTimebaseSetTimerDispatchSourceToFireImmediately(timebase: interop.PointerConvertible, timerSource: interop.Object): number;
