...
declare const kAudioStreamAnyRate: number;
...
declare const AVAudioSessionErrorCode: {
  None: 0,
...
declare const AudioChannelCoordinateIndex: {
  LeftRight: 0,
  BackFront: 1,
  DownUp: 2,
  Azimuth: 0,
...
declare class AudioValueTranslation {
  constructor(init?: AudioValueTranslation);
