...
declare const kColorSyncFactoryProfiles: interop.Pointer;
...
declare const kColorSyncProfileRepositoryChangeNotification: interop.Pointer;

declare const kColorSyncDisplayDeviceProfilesNotification: interop.Pointer;

declare const kColorSyncDeviceProfilesNotification: interop.Pointer;

declare const kColorSyncDeviceUnregisteredNotification: interop.Pointer;

declare const kColorSyncProfileHostScope: interop.Pointer;

declare const kColorSyncDeviceUserScope: interop.Pointer;

declare const kColorSyncDeviceHostScope: interop.Pointer;

declare const kColorSyncDeviceDefaultProfileID: interop.Pointer;

declare const kColorSyncDeviceModeDescription: interop.Pointer;

declare const kColorSyncCustomProfiles: interop.Pointer;

declare const kColorSyncDeviceProfileURL: interop.Pointer;

declare const kColorSyncPrinterDeviceClass: interop.Pointer;

declare const kColorSyncCameraDeviceClass: interop.Pointer;

declare const kCMMApplyTransformProcName: interop.Pointer;

declare const kCMMInitializeTransformProcName: interop.Pointer;
...
declare const kColorSyncWaitForCacheReply: interop.Pointer;

declare const kColorSyncProfileCacheSeed: interop.Pointer;

declare const kColorSyncProfileUserDomain: interop.Pointer;

declare const kColorSyncProfileComputerDomain: interop.Pointer;
...
declare const kColorSyncDisplayDeviceClass: interop.Pointer;
...
declare const kColorSyncDeviceClass: interop.Pointer;

declare const kColorSyncSigXYZData: interop.Pointer;

declare const kColorSyncDeviceModeDescriptions: interop.Pointer;

declare const kColorSyncRegistrationUpdateWindowServer: interop.Pointer;

declare const kColorSyncSigGrayData: interop.Pointer;

declare const kColorSyncTransformProfileSequnce: interop.Pointer;

declare const kColorSyncDeviceDescriptions: interop.Pointer;
...
declare const kColorSyncProfileUserScope: interop.Pointer;
...
declare const kColorSyncDeviceProfileIsDefault: interop.Pointer;

declare const kColorSyncSigDeviceModelDescTag: interop.Pointer;

declare const kColorSyncRenderingIntent: interop.Pointer;

declare const kColorSyncDeviceProfileIsCurrent: interop.Pointer;
...
declare const kColorSyncDeviceRegisteredNotification: interop.Pointer;

declare const kColorSyncConversionChannelID: interop.Pointer;

declare const kColorSyncSigDisplayClass: interop.Pointer;

declare const kCMMCreateTransformPropertyProcName: interop.Pointer;
...
declare const kColorSyncDeviceProfileIsFactory: interop.Pointer;

declare const kColorSyncDisplayP3Profile: interop.Pointer;

declare const kColorSyncPreferredCMM: interop.Pointer;

declare const kColorSyncSigRedTRCTag: interop.Pointer;

declare const kColorSyncDeviceDescription: interop.Pointer;

declare const kColorSyncGenericLabProfile: interop.Pointer;

declare const kColorSyncScannerDeviceClass: interop.Pointer;

declare const kCMMInitializeLinkProfileProcName: interop.Pointer;

declare const ColorSyncDataDepth: {
  Sync1BitGamut: 1,
  Sync8BitInteger: 2,
  Sync16BitInteger: 3,
  Sync16BitFloat: 4,
  Sync32BitInteger: 5,
  Sync32BitNamedColorIndex: 6,
  Sync32BitFloat: 7,
  Sync10BitInteger: 8,
};
...
declare class ColorSyncCMM {
  constructor(init?: ColorSyncCMM);
}

declare class ColorSyncTransform {
  constructor(init?: ColorSyncTransform);
}

declare class ColorSyncMD5 {
  constructor(init?: ColorSyncMD5);
...
declare function ColorSyncProfileCreateWithDisplayID(displayID: number): interop.Pointer;

declare function ColorSyncProfileCreateDeviceProfile(deviceClass: interop.PointerConvertible, deviceID: interop.PointerConvertible, profileID: interop.PointerConvertible): interop.Pointer;
...
declare function ColorSyncProfileEstimateGamma(prof: interop.PointerConvertible, error: interop.PointerConvertible): number;

declare function ColorSyncProfileGetDisplayTransferFormulaFromVCGT(profile: interop.PointerConvertible, redMin: interop.PointerConvertible, redMax: interop.PointerConvertible, redGamma: interop.PointerConvertible, greenMin: interop.PointerConvertible, greenMax: interop.PointerConvertible, greenGamma: interop.PointerConvertible, blueMin: interop.PointerConvertible, blueMax: interop.PointerConvertible, blueGamma: interop.PointerConvertible): boolean;

declare function ColorSyncProfileCreateDisplayTransferTablesFromVCGT(profile: interop.PointerConvertible, nSamplesPerChannel: interop.PointerConvertible): interop.Pointer;
...
declare function ColorSyncIterateInstalledProfilesWithOptions(callBack: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => boolean, seed: interop.PointerConvertible, userInfo: interop.PointerConvertible, options: interop.PointerConvertible, error: interop.PointerConvertible): void;

declare function ColorSyncProfileInstall(profile: interop.PointerConvertible, domain: interop.PointerConvertible, subpath: interop.PointerConvertible, error: interop.PointerConvertible): boolean;

declare function ColorSyncProfileUninstall(profile: interop.PointerConvertible, error: interop.PointerConvertible): boolean;
...
declare function ColorSyncCMMCreate(cmmBundle: interop.PointerConvertible): interop.Pointer;

declare function ColorSyncCMMGetBundle(p1: interop.PointerConvertible): interop.Pointer;

declare function ColorSyncCMMCopyLocalizedName(p1: interop.PointerConvertible): interop.Pointer;

declare function ColorSyncCMMCopyCMMIdentifier(p1: interop.PointerConvertible): interop.Pointer;

declare function ColorSyncIterateInstalledCMMs(callBack: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => boolean, userInfo: interop.PointerConvertible): void;

declare function ColorSyncRegisterDevice(deviceClass: interop.PointerConvertible, deviceID: interop.PointerConvertible, deviceInfo: interop.PointerConvertible): boolean;

declare function ColorSyncUnregisterDevice(deviceClass: interop.PointerConvertible, deviceID: interop.PointerConvertible): boolean;

declare function ColorSyncDeviceSetCustomProfiles(deviceClass: interop.PointerConvertible, deviceID: interop.PointerConvertible, profileInfo: interop.PointerConvertible): boolean;

declare function ColorSyncDeviceCopyDeviceInfo(deviceClass: interop.PointerConvertible, devID: interop.PointerConvertible): interop.Pointer;

declare function ColorSyncIterateDeviceProfiles(callBack: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => boolean, userInfo: interop.PointerConvertible): void;

declare function CGDisplayCreateUUIDFromDisplayID(displayID: number): interop.Pointer;

declare function CGDisplayGetDisplayIDFromUUID(uuid: interop.PointerConvertible): number;
