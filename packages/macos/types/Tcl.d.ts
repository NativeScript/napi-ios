...
declare class unnamed_7824233883213054716 {
  constructor(init?: unnamed_7824233883213054716);
  active: number;
...
declare class unnamed_17514607248424827274 {
  constructor(init?: unnamed_17514607248424827274);
  cmd: string | null;
  len: number;
}
...
declare class Interp {
  ...
  returnLevel: number;
  limit: unnamed_7824233883213054716;
  ensembleRewrite: unnamed_1227349141779430837;
...
declare class Var {
  ...
  flags: number;
  value: unnamed_305759613702923734;
}
...
declare class unnamed_4839595629196425038 {
  constructor(init?: unnamed_4839595629196425038);
  path: interop.Pointer;
}
...
declare class CmdFrame {
  ...
  framePtr: interop.Pointer;
  nextPtr: interop.Pointer;
  data: unnamed_18060412296971542146;
  cmd: unnamed_7097918599243553655;
}
...
declare class Tcl_HashEntry {
  ...
  clientData: interop.Pointer;
  key: unnamed_15400323148951272678;
}
...
declare class unnamed_12505268977828514132 {
  constructor(init?: unnamed_12505268977828514132);
  ptr: interop.Pointer;
  value: number;
}
...
declare class unnamed_13944020252074219774 {
  constructor(init?: unnamed_13944020252074219774);
...
declare class unnamed_41887744488081265 {
  constructor(init?: unnamed_41887744488081265);
...
declare class Tcl_Obj {
  ...
  length: number;
  typePtr: interop.Pointer;
  internalRep: unnamed_5696038602824601602;
}
...
declare class unnamed_1227349141779430837 {
  constructor(init?: unnamed_1227349141779430837);
...
type unnamed_9273542940891494431Descriptor = 
  | { numArgs: number }
  | { identity: number };

declare class unnamed_9273542940891494431 {
  constructor(init?: unnamed_9273542940891494431Descriptor);
  numArgs: number;
  identity: number;
}

type unnamed_305759613702923734Descriptor = 
  | { objPtr: interop.PointerConvertible }
  | { tablePtr: interop.PointerConvertible }
  | { linkPtr: interop.PointerConvertible };

declare class unnamed_305759613702923734 {
  constructor(init?: unnamed_305759613702923734Descriptor);
  objPtr: interop.Pointer;
  tablePtr: interop.Pointer;
  linkPtr: interop.Pointer;
}

type unnamed_15400323148951272678Descriptor = 
  | { oneWordValue: string | null }
  | { objPtr: interop.PointerConvertible }
  | { words: unknown /* const array */ }
  | { string: unknown /* const array */ };

declare class unnamed_15400323148951272678 {
  constructor(init?: unnamed_15400323148951272678Descriptor);
  oneWordValue: string | null;
  objPtr: interop.Pointer;
  words: unknown /* const array */;
  string: unknown /* const array */;
...
type unnamed_5696038602824601602Descriptor = 
  | { longValue: number }
  | { doubleValue: number }
  | { otherValuePtr: interop.PointerConvertible }
  | { wideValue: number }
  | { twoPtrValue: unnamed_13944020252074219774 }
  | { ptrAndLongRep: unnamed_12505268977828514132 };

declare class unnamed_5696038602824601602 {
  constructor(init?: unnamed_5696038602824601602Descriptor);
  longValue: number;
  doubleValue: number;
...
type unnamed_7097918599243553655Descriptor = 
  | { str: unnamed_17514607248424827274 }
  | { listPtr: interop.PointerConvertible };

declare class unnamed_7097918599243553655 {
  constructor(init?: unnamed_7097918599243553655Descriptor);
  str: unnamed_17514607248424827274;
  listPtr: interop.Pointer;
}

type unnamed_18060412296971542146Descriptor = 
  | { eval: unnamed_4839595629196425038 }
  | { tebc: unnamed_41887744488081265 };

declare class unnamed_18060412296971542146 {
  constructor(init?: unnamed_18060412296971542146Descriptor);
  eval: unnamed_4839595629196425038;
  tebc: unnamed_41887744488081265;
}
