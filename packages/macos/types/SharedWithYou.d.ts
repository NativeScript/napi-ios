...
declare class SWAttributionView extends NSView {
  ...
  readonly highlightMenu: NSMenu;

  menuTitleForHideAction: string;

  supplementalMenu: NSMenuItem;
  ...
  setSupplementalMenu(supplementalMenu: NSMenuItem | null): void;
}
...
declare class SWCollaborationView extends NSView {
  cloudSharingDelegate: NSCloudSharingServiceDelegate;

  setContentView(detailViewListContentView: NSView): void;
  ...
  readonly menuFormRepresentation: NSMenuItem;

  cloudSharingServiceDelegate: NSCloudSharingServiceDelegate | null;
  ...
  setCloudSharingDelegate(cloudSharingDelegate: NSCloudSharingServiceDelegate | null): void;
  ...
  setHeaderImage(headerImage: NSImage): void;

  setCloudSharingServiceDelegate(cloudSharingServiceDelegate: NSCloudSharingServiceDelegate | null): void;
...
declare class SWRemoveParticipantAlert extends NSObject {
  static showAlertWithParticipantHighlightInWindow(participant: SWPerson, highlight: SWCollaborationHighlight, window: NSWindow | null): void;
}
