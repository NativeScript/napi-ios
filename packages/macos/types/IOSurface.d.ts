...
declare function IOSurfaceCreateXPCObject(aSurface: interop.PointerConvertible): NSObject;

declare function IOSurfaceLookupFromXPCObject(xobj: NSObject): interop.Pointer;
