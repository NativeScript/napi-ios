...
declare const AVMetadataIdentifierQuickTimeMetadataAIMEData: string;
...
declare const AVAssetPlaybackConfigurationOptionAppleImmersiveVideo: string;
...
declare interface AVCaptureFileOutputDelegate extends NSObjectProtocol {
  ...
  captureOutputDidOutputSampleBufferFromConnection?(output: AVCaptureFileOutput, sampleBuffer: interop.Object, connection: AVCaptureConnection): void;
}
...
declare class AVPlayerItemTrack extends NSObject {
  ...
  setVideoFieldMode(videoFieldMode: string): void;
}
...
declare class AVCaptureScreenInput extends AVCaptureInput {
  ...
  setCropRect(cropRect: CGRect): void;

  setScaleFactor(scaleFactor: number): void;

  setCapturesMouseClicks(capturesMouseClicks: boolean): void;

  setCapturesCursor(capturesCursor: boolean): void;

  setRemovesDuplicateFrames(removesDuplicateFrames: boolean): void;
}
...
declare class AVCaptureDeskViewApplicationLaunchConfiguration extends NSObject {
  ...
  setMainWindowFrame(mainWindowFrame: CGRect): void;

  setRequiresSetUpModeCompletion(requiresSetUpModeCompletion: boolean): void;
}
...
declare class AVCaptureFileOutput extends AVCaptureOutput {
  ...
  setDelegate(delegate: AVCaptureFileOutputDelegate | null): void;
...
declare class AVCaptureAudioPreviewOutput extends AVCaptureOutput {
  ...
  setOutputDeviceUniqueID(outputDeviceUniqueID: string | null): void;
...
declare class AVCaptureConnection extends NSObject {
  ...
  readonly supportsVideoFieldMode: boolean;
  ...
  setVideoFieldMode(videoFieldMode: interop.Enum<typeof AVVideoFieldMode>): void;
...
declare class AVSampleBufferGenerator extends NSObject {
  ...
  createSampleBufferForRequest(request: AVSampleBufferRequest): interop.Object;
...
declare class AVPlayerItem extends NSObject implements NSCopying {
  ...
  readonly authorizationRequiredForPlayback: boolean;

  readonly applicationAuthorizedForPlayback: boolean;

  readonly contentAuthorizedForPlayback: boolean;
...
declare class AVAssetExportSession extends NSObject {
  ...
  setAllowsParallelizedExport(allowsParallelizedExport: boolean): void;
...
declare class AVPlayer extends NSObject {
  ...
  setAudioOutputDeviceUniqueID(audioOutputDeviceUniqueID: string): void;
  ...
  setPreferredVideoDecoderGPURegistryID(preferredVideoDecoderGPURegistryID: number): void;
...
declare class AVCaptureAudioFileOutput extends AVCaptureFileOutput {
  ...
  setAudioSettings(audioSettings: NSDictionary<interop.Object, interop.Object> | Record<interop.Object, interop.Object> | null): void;
}
...
declare class AVCaptureDevice extends NSObject {
  ...
  readonly inUseByAnotherApplication: boolean;
  ...
  setActiveInputSource(activeInputSource: AVCaptureDeviceInputSource | null): void;
