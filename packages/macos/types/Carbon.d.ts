...
declare const kFCFontCGColorAttribute: interop.Pointer;

declare const kFCFontVisibleNameAttribute: interop.Pointer;

declare const kFCFontSizeAttribute: interop.Pointer;

declare const kFCFontFaceAttribute: interop.Pointer;

declare const kFCFontNameAttribute: interop.Pointer;

declare const kFontSelectionATSUIType: number;

declare const fontPanelFontSelectionQDStyleVersionErr: number;

declare const kFontPanelMouseTrackingState: interop.Pointer;

declare const kFontPanelAttributesKey: interop.Pointer;

declare const kFontPanelVariationValuesKey: interop.Pointer;

declare const kFontPanelVariationAxesKey: interop.Pointer;
...
declare const kTSMTEAutoScroll: number;

declare const kTSMTEInterfaceType: number;

declare const kTSMTESignature: number;

declare const kIMKMouseTrackingMode: number;

declare const kTISNotifyEnabledKeyboardInputSourcesChanged: interop.Pointer;

declare const kTISTypeInk: interop.Pointer;

declare const kTISTypeKeyboardViewer: interop.Pointer;

declare const kTISTypeCharacterPalette: interop.Pointer;

declare const kTISTypeKeyboardInputMode: interop.Pointer;

declare const kTISTypeKeyboardInputMethodWithoutModes: interop.Pointer;

declare const kTISTypeKeyboardLayout: interop.Pointer;

declare const kTISCategoryKeyboardInputSource: interop.Pointer;

declare const kTISPropertyUnicodeKeyLayoutData: interop.Pointer;

declare const kTISPropertyBundleID: interop.Pointer;

declare const kTISPropertyInputSourceIsEnabled: interop.Pointer;

declare const kTISPropertyInputSourceIsSelectCapable: interop.Pointer;

declare const kTISPropertyInputSourceIsEnableCapable: interop.Pointer;
...
declare const kHIToolboxVersionNumber: number;
...
declare const kHIViewWindowGrowBoxID: ControlID;

declare const kHIViewWindowToolbarButtonID: ControlID;

declare const kHIViewWindowCloseBoxID: ControlID;

declare const kHIViewWindowContentID: ControlID;
...
declare const kHIViewMenuContentID: ControlID;
...
declare const kTXNQuickTimeDocumentType: interop.Pointer;

declare const kTXNMLTEDocumentType: interop.Pointer;

declare const kTXNPlainTextDocumentType: interop.Pointer;

declare const kTXNDataOptionCharacterEncodingKey: interop.Pointer;

declare const kTXNDocumentAttributeCopyrightKey: interop.Pointer;

declare const kTXNDocumentAttributeModificationTimeKey: interop.Pointer;

declare const kTXNDocumentAttributeCommentKey: interop.Pointer;

declare const kTXNDocumentAttributeAuthorKey: interop.Pointer;

declare const kTXNDocumentAttributeSubjectKey: interop.Pointer;

declare const kTXNDocumentAttributeCompanyNameKey: interop.Pointer;

declare const kTXNDocumentAttributeTitleKey: interop.Pointer;
...
declare const kTXNActionCountOfAllChanges: interop.Pointer;
...
declare const kTXNActionChangeTextPosition: interop.Pointer;

declare const kTXNActionChangeFontFeature: interop.Pointer;

declare const kTXNDontCareTypeStyle: number;

declare const kTXNActionMove: interop.Pointer;

declare const kTXNActionAlignCenter: interop.Pointer;

declare const kTXNActionAlignLeft: interop.Pointer;

declare const kTXNActionChangeStyle: interop.Pointer;

declare const kTXNActionChangeSize: interop.Pointer;

declare const kOSASelectStopRecording: number;

declare const kTXNActionChangeFont: interop.Pointer;

declare const kTXNActionCut: interop.Pointer;

declare const kTXNActionTyping: interop.Pointer;
...
declare const kTISPropertyInputSourceLanguages: interop.Pointer;
...
declare const IMKTextOrientationName: string;
...
declare const kTXNActionAlignRight: interop.Pointer;
...
declare const kTISPropertyInputSourceID: interop.Pointer;
...
declare const kTXNRTFDocumentType: interop.Pointer;
...
declare const kTISPropertyInputSourceCategory: interop.Pointer;
...
declare const kHIDelegateAfterKey: interop.Pointer;

declare const kHIDelegateBeforeKey: interop.Pointer;
...
declare const kHIObjectCustomDataClassIDKey: interop.Pointer;

declare const kHIObjectCustomDataParameterValuesKey: interop.Pointer;

declare const kHIObjectCustomDataParameterTypesKey: interop.Pointer;

declare const kHIObjectCustomDataParameterNamesKey: interop.Pointer;
...
declare const kHIObjectInitParamEventType: interop.Pointer;

declare const kHIObjectInitParamEventName: interop.Pointer;

declare const kHIObjectInitParamDescription: interop.Pointer;

declare const kHIObjectInitParamUserName: interop.Pointer;
...
declare const kHITextViewClassID: interop.Pointer;
...
declare const kTISPropertyLocalizedName: interop.Pointer;

declare const kFontPanelATSUFontIDKey: interop.Pointer;
...
declare const kTXNActionChangeFontVariation: interop.Pointer;
...
declare const kFontPanelFeatureSelectorsKey: interop.Pointer;
...
declare const kFontPanelFeatureTypesKey: interop.Pointer;
...
declare const kTISPropertyInputSourceIsASCIICapable: interop.Pointer;
...
declare const kTXNActionChangeColor: interop.Pointer;
...
declare const kTISCategoryPaletteInputSource: interop.Pointer;
...
declare const kHIViewWindowToolbarID: ControlID;
...
declare const kTISPropertyInputModeID: interop.Pointer;

declare const kEventControlTrackingAreaExited: number;

declare const kTXNDocumentAttributeCreationTimeKey: interop.Pointer;
...
declare const kHIViewWindowZoomBoxID: ControlID;
...
declare const kHIObjectCustomDataCDEFProcIDKey: interop.Pointer;
...
declare const kTISTypeKeyboardInputMethodModeEnabled: interop.Pointer;
...
declare const kTISPropertyInputSourceType: interop.Pointer;
...
declare const kTISPropertyIconRef: interop.Pointer;
...
declare const kTXNActionUndoLast: interop.Pointer;
...
declare const kTXNActionChangeGlyphVariation: interop.Pointer;
...
declare const kTXNActionCountOfStyleChanges: interop.Pointer;
...
declare const kTXNActionPaste: interop.Pointer;
...
declare const kTISCategoryInkInputSource: interop.Pointer;
...
declare const kFontPanelAttributeSizesKey: interop.Pointer;
...
declare const kTISPropertyIconImageURL: interop.Pointer;
...
declare const kFontPanelAttributeTagsKey: interop.Pointer;
...
declare const kHIViewWindowTitleID: ControlID;
...
declare const kTISPropertyInputSourceIsSelected: interop.Pointer;
...
declare const kTISNotifySelectedKeyboardInputSourceChanged: interop.Pointer;
...
declare const kTXNActionClear: interop.Pointer;
...
declare const kHIObjectCustomDataSuperClassIDKey: interop.Pointer;
...
declare const kHIViewWindowCollapseBoxID: ControlID;
...
declare const kVK_ContextualMenu: number;
...
declare const kTXNDataOptionDocumentTypeKey: interop.Pointer;
...
declare const kTXNDocumentAttributeEditorKey: interop.Pointer;
...
declare const kFontPanelBackgroundColorAttributeName: interop.Pointer;
...
declare const kFCFontFamilyAttribute: interop.Pointer;
...
declare class FontSelectionQDStyle {
  constructor(init?: FontSelectionQDStyle);
  version: number;
...
declare class NPMColor {
  constructor(init?: NPMColor);
  profile: interop.Pointer;
  color: CMColor;
}

declare class TSMTERec {
  constructor(init?: TSMTERec);
  textH: interop.Pointer;
  preUpdateProc: (p1: interop.PointerConvertible, p2: number) => void | null;
  postUpdateProc: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number) => void | null;
  updateFlag: number;
  refCon: number;
}

declare class FileTranslationSpec {
  constructor(init?: FileTranslationSpec);
  componentSignature: number;
  translationSystemInfo: interop.Pointer;
  src: FileTypeSpec;
  dst: FileTypeSpec;
}

declare class ScrapTranslationList {
  constructor(init?: ScrapTranslationList);
  modDate: number;
  groupCount: number;
}

declare class ScrapTypeSpec {
  constructor(init?: ScrapTypeSpec);
  format: number;
  hint: number;
}

declare class FileTypeSpec {
  constructor(init?: FileTypeSpec);
  format: number;
  hint: number;
  flags: number;
  catInfoType: number;
...
declare class StandardIconListCellDataRec {
  constructor(init?: StandardIconListCellDataRec);
...
declare class ListRec {
  constructor(init?: ListRec);
  rView: Rect;
  port: interop.Pointer;
  indent: Point;
  cellSize: Point;
  visible: Rect;
  ...
  clikLoc: Point;
  mouseLoc: Point;
  lClickLoop: () => number | null;
  lastClick: Point;
  refCon: number;
  listDefProc: interop.Pointer;
  userHandle: interop.Pointer;
  dataBounds: Rect;
  cells: interop.Pointer;
  maxIndex: number;
  cellArray: unknown /* const array */;
}

declare class ControlEditTextSelectionRec {
  constructor(init?: ControlEditTextSelectionRec);
  selStart: number;
  selEnd: number;
}

declare class ControlTabInfoRecV1 {
...
declare class DataBrowserAccessibilityItemInfoV1 {
  constructor(init?: DataBrowserAccessibilityItemInfoV1);
  container: number;
  item: number;
...
declare class HMStringResType {
  constructor(init?: HMStringResType);
  hmmResID: number;
  hmmIndex: number;
}

declare class TXNLongRect {
  constructor(init?: TXNLongRect);
  top: number;
  left: number;
  bottom: number;
  right: number;
...
declare class TXNMatchTextRecord {
  constructor(init?: TXNMatchTextRecord);
  iTextPtr: interop.Pointer;
  iTextToMatchLength: number;
  iTextEncoding: number;
}

declare class TXNTypeAttributes {
  constructor(init?: TXNTypeAttributes);
  tag: number;
  size: number;
  data: TXNAttributeData;
}

declare class TXNATSUIVariations {
  constructor(init?: TXNATSUIVariations);
  variationCount: number;
  variationAxis: interop.Pointer;
  variationValues: interop.Pointer;
}

declare class TXNMargins {
  constructor(init?: TXNMargins);
  topMargin: number;
  leftMargin: number;
  bottomMargin: number;
  rightMargin: number;
...
declare class TXNTab {
  constructor(init?: TXNTab);
  value: number;
  tabType: number;
  filler: number;
}

declare class OpaqueTXNObject {
  constructor(init?: OpaqueTXNObject);
}

declare class OpaqueScrapRef {
  constructor(init?: OpaqueScrapRef);
}

declare class ScrapFlavorInfo {
  constructor(init?: ScrapFlavorInfo);
  flavorType: number;
  flavorFlags: number;
}

declare class TSMGlyphInfoArray {
  constructor(init?: TSMGlyphInfoArray);
  numGlyphInfo: number;
  glyphInfo: unknown /* const array */;
}

declare class TSMGlyphInfo {
  constructor(init?: TSMGlyphInfo);
  range: CFRange;
  fontRef: number;
  collection: number;
  glyphID: number;
...
declare class ScriptLanguageRecord {
  constructor(init?: ScriptLanguageRecord);
  fScript: number;
  fLanguage: number;
}

declare class TextServiceList {
  constructor(init?: TextServiceList);
  fTextServiceCount: number;
  fServices: unknown /* const array */;
}

declare class OpaqueTSMDocumentID {
  constructor(init?: OpaqueTSMDocumentID);
}

declare class AlertStdCFStringAlertParamRec {
  constructor(init?: AlertStdCFStringAlertParamRec);
  version: number;
  movable: number;
  helpButton: number;
...
declare class AlertTemplate {
  constructor(init?: AlertTemplate);
  boundsRect: Rect;
  itemsID: number;
  stages: number;
}

declare class HILayoutInfo {
  constructor(init?: HILayoutInfo);
  version: number;
  binding: HIBinding;
  scale: HIScaling;
...
declare class HIViewFrameMetrics {
  constructor(init?: HIViewFrameMetrics);
  top: number;
  left: number;
  bottom: number;
  right: number;
...
declare class HIThemeBackgroundDrawInfo {
  constructor(init?: HIThemeBackgroundDrawInfo);
  version: number;
  state: number;
  kind: number;
}

declare class HIThemePopupArrowDrawInfo {
  constructor(init?: HIThemePopupArrowDrawInfo);
  version: number;
  state: number;
  orientation: number;
  size: number;
...
declare class HIThemeSeparatorDrawInfo {
  constructor(init?: HIThemeSeparatorDrawInfo);
  version: number;
  state: number;
}

declare class HIThemeWindowWidgetDrawInfo {
  constructor(init?: HIThemeWindowWidgetDrawInfo);
  version: number;
  widgetState: number;
  widgetType: number;
  windowState: number;
...
declare class HIThemeTickMarkDrawInfo {
  constructor(init?: HIThemeTickMarkDrawInfo);
  version: number;
  state: number;
}

declare class HIThemeMenuTitleDrawInfo {
  constructor(init?: HIThemeMenuTitleDrawInfo);
  version: number;
  state: number;
  attributes: number;
...
declare class HIThemeMenuBarDrawInfo {
  constructor(init?: HIThemeMenuBarDrawInfo);
  version: number;
  state: number;
  attributes: number;
}

declare class HIThemeHeaderDrawInfo {
  constructor(init?: HIThemeHeaderDrawInfo);
  version: number;
  state: number;
  kind: number;
}

declare class HIThemePlacardDrawInfo {
  constructor(init?: HIThemePlacardDrawInfo);
  version: number;
  state: number;
}

declare class HIThemeGrabberDrawInfo {
  constructor(init?: HIThemeGrabberDrawInfo);
  version: number;
  state: number;
}

declare class HIThemeGroupBoxDrawInfo {
  constructor(init?: HIThemeGroupBoxDrawInfo);
  version: number;
  state: number;
  kind: number;
}

declare class HIThemeMenuDrawInfoVersionZero {
  constructor(init?: HIThemeMenuDrawInfoVersionZero);
  version: number;
  menuType: number;
}

declare class HIThemeMenuDrawInfo {
  constructor(init?: HIThemeMenuDrawInfo);
  version: number;
  menuType: number;
  reserved1: number;
  reserved2: number;
...
declare class HIThemeTabDrawInfo {
  constructor(init?: HIThemeTabDrawInfo);
  version: number;
  style: number;
  direction: number;
  size: number;
...
declare class HIThemeSplitterDrawInfo {
  constructor(init?: HIThemeSplitterDrawInfo);
  version: number;
  state: number;
  adornment: number;
}

declare class HIThemeButtonDrawInfo {
  constructor(init?: HIThemeButtonDrawInfo);
  version: number;
  state: number;
  kind: number;
  value: number;
...
declare class HIThemeAnimationTimeInfo {
  constructor(init?: HIThemeAnimationTimeInfo);
  start: number;
  current: number;
}

declare class HIThemeTrackDrawInfo {
  constructor(init?: HIThemeTrackDrawInfo);
  version: number;
  kind: number;
  bounds: CGRect;
  min: number;
...
declare class HIScrollBarTrackInfo {
  constructor(init?: HIScrollBarTrackInfo);
  version: number;
  enableState: number;
  pressState: number;
  viewsize: number;
...
declare class OpaqueToolboxObjectClassRef {
  constructor(init?: OpaqueToolboxObjectClassRef);
}

declare class TabletPointRec {
  constructor(init?: TabletPointRec);
  absX: number;
  absY: number;
  absZ: number;
  buttons: number;
...
declare class WinCTab {
  constructor(init?: WinCTab);
  wCSeed: number;
  wCReserved: number;
  ctSize: number;
  ctTable: unknown /* const array */;
}

declare class MeasureWindowTitleRec {
  constructor(init?: MeasureWindowTitleRec);
  fullTitleWidth: number;
  titleTextWidth: number;
  isUnicodeTitle: number;
  unused: number;
}

declare class HIContentBorderMetrics {
  constructor(init?: HIContentBorderMetrics);
  top: number;
  left: number;
  bottom: number;
  right: number;
...
declare class OpaqueWindowGroupRef {
  constructor(init?: OpaqueWindowGroupRef);
}
...
declare class WStateData {
  constructor(init?: WStateData);
  userState: Rect;
  stdState: Rect;
}

declare class ControlID {
  constructor(init?: ControlID);
  signature: number;
  id: number;
}

declare class IndicatorDragConstraint {
  constructor(init?: IndicatorDragConstraint);
  limitRect: Rect;
  slopRect: Rect;
  axis: number;
}

declare class PromiseHFSFlavor {
  constructor(init?: PromiseHFSFlavor);
  fileType: number;
  fileCreator: number;
  fdFlags: number;
...
declare class OpaqueDragRef {
  constructor(init?: OpaqueDragRef);
}

declare class TEStyleRec {
  constructor(init?: TEStyleRec);
  nRuns: number;
  nStyles: number;
  styleTab: interop.Pointer;
  lhTab: interop.Pointer;
  teRefCon: number;
  nullStyle: interop.Pointer;
  runs: unknown /* const array */;
}

declare class NullStRec {
  constructor(init?: NullStRec);
  teReserved: number;
  nullScrap: interop.Pointer;
}

declare class ScrpSTElement {
  constructor(init?: ScrpSTElement);
...
declare class LHElement {
  constructor(init?: LHElement);
  lhHeight: number;
  lhAscent: number;
}

declare class STElement {
  constructor(init?: STElement);
  stCount: number;
  stHeight: number;
  stAscent: number;
  stFont: number;
...
declare class StyleRun {
  constructor(init?: StyleRun);
  startChar: number;
  styleIndex: number;
}

declare class TERec {
  constructor(init?: TERec);
  destRect: Rect;
  viewRect: Rect;
  selRect: Rect;
  lineHeight: number;
  ...
  selEnd: number;
  active: number;
  wordBreak: (p1: string, p2: number) => number | null;
  clickLoop: (p1: interop.PointerConvertible) => number | null;
  clickTime: number;
  clickLoc: number;
  caretTime: number;
  caretState: number;
  ...
  txMode: number;
  txSize: number;
  inPort: interop.Pointer;
  highHook: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void | null;
  caretHook: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void | null;
  nLines: number;
  lineStarts: unknown /* const array */;
}

declare class MenuCRsrc {
  constructor(init?: MenuCRsrc);
  numEntries: number;
  mcEntryRecs: unknown /* const array */;
}

declare class MCEntry {
  constructor(init?: MCEntry);
  mctID: number;
  mctItem: number;
  mctRGB1: RGBColor;
  mctRGB2: RGBColor;
...
declare class MDEFDrawData {
  constructor(init?: MDEFDrawData);
  trackingData: MenuTrackingData;
  context: interop.Pointer;
}

declare class MDEFHiliteItemData {
  constructor(init?: MDEFHiliteItemData);
  previousItem: number;
  newItem: number;
  context: interop.Pointer;
}

declare class ContextualMenuInterfaceStruct {
  constructor(init?: ContextualMenuInterfaceStruct);
  ...
  ExamineContext: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number | null;
  HandleSelection: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number | null;
...
declare class MenuBarHeader {
  constructor(init?: MenuBarHeader);
  lastMenu: number;
  lastRight: number;
  mbResID: number;
}

declare class OpaqueMenuRef {
  constructor(init?: OpaqueMenuRef);
}

declare class EventRecord {
  constructor(init?: EventRecord);
  what: number;
  message: number;
  when: number;
  where: Point;
...
declare class OpaqueThemeDrawingState {
  constructor(init?: OpaqueThemeDrawingState);
}

declare class ThemeWindowMetrics {
  constructor(init?: ThemeWindowMetrics);
  metricSize: number;
  titleHeight: number;
  titleWidth: number;
...
declare class ThemeTrackDrawInfo {
  constructor(init?: ThemeTrackDrawInfo);
  kind: number;
  bounds: Rect;
  min: number;
  max: number;
...
declare class SliderTrackInfo {
  constructor(init?: SliderTrackInfo);
  thumbDir: number;
  pressState: number;
}

declare class OpaqueHIArchiveRef {
  constructor(init?: OpaqueHIArchiveRef);
}

declare class OpaqueControlRef {
  constructor(init?: OpaqueControlRef);
}
...
declare class __EventLoopTimer {
  constructor(init?: __EventLoopTimer);
}

declare class OpaqueEventLoopRef {
  constructor(init?: OpaqueEventLoopRef);
}

declare class OpaqueEventRef {
  constructor(init?: OpaqueEventRef);
}

declare class DataBrowserListViewHeaderDesc {
  constructor(init?: DataBrowserListViewHeaderDesc);
  version: number;
  minimumWidth: number;
  maximumWidth: number;
  titleOffset: number;
...
declare class AlertStdAlertParamRec {
  constructor(init?: AlertStdAlertParamRec);
  movable: number;
  helpButton: number;
  filterProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number | null;
  defaultText: interop.Pointer;
  cancelText: interop.Pointer;
  otherText: interop.Pointer;
  defaultButton: number;
...
declare class TXNBackground {
  constructor(init?: TXNBackground);
  bgType: number;
  bg: TXNBackgroundData;
}

declare class EventTypeSpec {
  constructor(init?: EventTypeSpec);
  eventClass: number;
  eventKind: number;
}

declare class HIScaling {
  constructor(init?: HIScaling);
  x: HIAxisScale;
  y: HIAxisScale;
}
...
declare class ScrollBarTrackInfo {
  constructor(init?: ScrollBarTrackInfo);
  viewsize: number;
  pressState: number;
}
...
declare class EventHotKeyID {
  constructor(init?: EventHotKeyID);
  signature: number;
  id: number;
}

declare class CtlCTab {
  constructor(init?: CtlCTab);
  ccSeed: number;
  ccRider: number;
  ctSize: number;
  ctTable: unknown /* const array */;
...
declare class HIThemeGrowBoxDrawInfo {
  constructor(init?: HIThemeGrowBoxDrawInfo);
  version: number;
  state: number;
  kind: number;
  direction: number;
...
declare class OpaqueEventQueueRef {
  constructor(init?: OpaqueEventQueueRef);
}

declare class TransitionWindowOptions {
  constructor(init?: TransitionWindowOptions);
  version: number;
  duration: number;
...
declare class ControlTabInfoRec {
  constructor(init?: ControlTabInfoRec);
  version: number;
  iconSuiteID: number;
  name: unknown /* const array */;
}

declare class TXNATSUIFeatures {
  constructor(init?: TXNATSUIFeatures);
  featureCount: number;
  featureTypes: interop.Pointer;
...
declare class CalibratorInfo {
  constructor(init?: CalibratorInfo);
  dataSize: number;
  displayID: number;
  profileLocationSize: number;
  profileLocationPtr: interop.Pointer;
  eventProc: (p1: interop.PointerConvertible) => void | null;
  isGood: number;
}
...
declare class HIThemeScrollBarDelimitersDrawInfo {
  constructor(init?: HIThemeScrollBarDelimitersDrawInfo);
  version: number;
  state: number;
  windowType: number;
  attributes: number;
...
declare class ScriptLanguageSupport {
  constructor(init?: ScriptLanguageSupport);
  fScriptLanguageCount: number;
  fScriptLanguageArray: unknown /* const array */;
}

declare class HIThemeTabPaneDrawInfo {
  constructor(init?: HIThemeTabPaneDrawInfo);
  version: number;
  state: number;
  direction: number;
  size: number;
...
declare class GetGrowImageRegionRec {
  constructor(init?: GetGrowImageRegionRec);
  growRect: Rect;
  growImageRegion: interop.Pointer;
}

declare class HIThemeTabDrawInfoVersionZero {
  constructor(init?: HIThemeTabDrawInfoVersionZero);
  version: number;
  style: number;
  direction: number;
  size: number;
...
declare class OpaqueEventHandlerCallRef {
  constructor(init?: OpaqueEventHandlerCallRef);
}

declare class SRCallBackStruct {
  constructor(init?: SRCallBackStruct);
  what: number;
  message: number;
...
declare class HIThemeSegmentDrawInfo {
  constructor(init?: HIThemeSegmentDrawInfo);
  version: number;
  state: number;
  value: number;
  size: number;
...
declare class GetWindowRegionRec {
  constructor(init?: GetWindowRegionRec);
  winRgn: interop.Pointer;
  regionCode: number;
}
...
declare class URLCallbackInfo {
  ...
  version: number;
  urlRef: interop.Pointer;
  property: string | null;
  currentSize: number;
  systemEvent: interop.Pointer;
}

declare class ControlTemplate {
  constructor(init?: ControlTemplate);
  controlRect: Rect;
  controlValue: number;
  controlVisible: number;
  fill: number;
...
declare class OpaqueKeyboardLayoutRef {
  constructor(init?: OpaqueKeyboardLayoutRef);
}

declare class HIThemeAnimationFrameInfo {
  constructor(init?: HIThemeAnimationFrameInfo);
  index: number;
}

declare class TextServiceInfo {
  constructor(init?: TextServiceInfo);
  fComponent: interop.Pointer;
  fItemName: unknown /* const array */;
}

declare class OpaqueURLReference {
  constructor(init?: OpaqueURLReference);
}
...
declare class DialogTemplate {
  constructor(init?: DialogTemplate);
  boundsRect: Rect;
  procID: number;
  visible: number;
  filler1: number;
  ...
  refCon: number;
  itemsID: number;
  title: unknown /* const array */;
}

declare class TextStyle {
  constructor(init?: TextStyle);
  tsFont: number;
  tsFace: number;
  tsSize: number;
  tsColor: RGBColor;
...
declare class MDEFFindItemData {
  constructor(init?: MDEFFindItemData);
  trackingData: MenuTrackingData;
  context: interop.Pointer;
}

declare class HMenuBarHeader {
  constructor(init?: HMenuBarHeader);
  lastHMenu: number;
  menuTitleBits: interop.Pointer;
}

declare class NColorPickerInfo {
  constructor(init?: NColorPickerInfo);
  theColor: NPMColor;
  dstProfile: interop.Pointer;
  flags: number;
  placeWhere: number;
  dialogOrigin: Point;
  pickerType: number;
  colorProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void | null;
  colorProcData: interop.Pointer;
  prompt: unknown /* const array */;
  mInfo: PickerMenuItemInfo;
  newColorChosen: number;
  reserved: number;
}
...
declare class ControlKind {
  constructor(init?: ControlKind);
  signature: number;
  kind: number;
}

declare class FileTranslationList {
  constructor(init?: FileTranslationList);
  modDate: number;
  groupCount: number;
}
...
declare class OpaqueEventTargetRef {
  constructor(init?: OpaqueEventTargetRef);
}

declare class OpaqueIBNibRef {
  constructor(init?: OpaqueIBNibRef);
}

declare class HIThemeChasingArrowsDrawInfo {
  constructor(init?: HIThemeChasingArrowsDrawInfo);
  version: number;
  state: number;
  index: number;
}

declare class HITypeAndCreator {
  constructor(init?: HITypeAndCreator);
  type: number;
  creator: number;
}

declare class DataBrowserPropertyDesc {
  constructor(init?: DataBrowserPropertyDesc);
  propertyID: number;
  propertyType: number;
  propertyFlags: number;
}

declare class HMHelpContentRec {
  constructor(init?: HMHelpContentRec);
  version: number;
  absHotRect: Rect;
  tagSide: number;
...
declare class DataBrowserAccessibilityItemInfoV0 {
  constructor(init?: DataBrowserAccessibilityItemInfoV0);
  container: number;
  item: number;
  columnProperty: number;
  propertyPart: number;
...
declare class HIThemeFrameDrawInfo {
  constructor(init?: HIThemeFrameDrawInfo);
  version: number;
  kind: number;
  state: number;
  isFocused: number;
...
declare class MDEFDrawItemsData {
  constructor(init?: MDEFDrawItemsData);
  firstItem: number;
  lastItem: number;
  trackingData: interop.Pointer;
  context: interop.Pointer;
}
...
declare class PickerMenuItemInfo {
  constructor(init?: PickerMenuItemInfo);
  editMenuID: number;
  cutItem: number;
  copyItem: number;
  pasteItem: number;
...
declare class ThemeButtonDrawInfo {
  constructor(init?: ThemeButtonDrawInfo);
  state: number;
  value: number;
  adornment: number;
}
...
declare class HIThemeTabPaneDrawInfoVersionZero {
  constructor(init?: HIThemeTabPaneDrawInfoVersionZero);
  version: number;
  state: number;
  direction: number;
  size: number;
...
declare class HIThemeTextInfo {
  constructor(init?: HIThemeTextInfo);
  version: number;
  state: number;
  fontID: number;
...
declare class NMRec {
  constructor(init?: NMRec);
  qLink: interop.Pointer;
  qType: number;
  nmFlags: number;
  nmPrivate: interop.Pointer;
  nmReserved: number;
  nmMark: number;
  nmIcon: interop.Pointer;
  nmSound: interop.Pointer;
  nmStr: interop.Pointer;
  nmResp: (p1: interop.PointerConvertible) => void | null;
...
type TXNAttributeDataDescriptor = 
  | { dataPtr: interop.PointerConvertible }
  | { dataValue: number }
...
declare function HIRectConvert(ioRect: interop.PointerConvertible, inSourceSpace: number, inSourceObject: interop.PointerConvertible, inDestinationSpace: number, inDestinationObject: interop.PointerConvertible): void;

declare function HISizeConvert(ioSize: interop.PointerConvertible, inSourceSpace: number, inSourceObject: interop.PointerConvertible, inDestinationSpace: number, inDestinationObject: interop.PointerConvertible): void;

declare function GetCurrentEventLoop(): interop.Pointer;

declare function GetMainEventLoop(): interop.Pointer;
...
declare function GetEventRetainCount(inEvent: interop.PointerConvertible): number;

declare function ReleaseEvent(inEvent: interop.PointerConvertible): void;

declare function SetEventParameter(inEvent: interop.PointerConvertible, inName: number, inType: number, inSize: number, inDataPtr: interop.PointerConvertible): number;

declare function GetEventParameter(inEvent: interop.PointerConvertible, inName: number, inDesiredType: number, outActualType: interop.PointerConvertible, inBufferSize: number, outActualSize: interop.PointerConvertible, outData: interop.PointerConvertible): number;

declare function RemoveEventParameter(inEvent: interop.PointerConvertible, inName: number): number;

declare function GetEventClass(inEvent: interop.PointerConvertible): number;

declare function GetEventKind(inEvent: interop.PointerConvertible): number;

declare function GetEventTime(inEvent: interop.PointerConvertible): number;
...
declare function GetMainEventQueue(): interop.Pointer;

declare function NewEventComparatorUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number;

declare function DisposeEventComparatorUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): void;

declare function InvokeEventComparatorUPP(inEvent: interop.PointerConvertible, inCompareData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): number;

declare function PostEventToQueue(inQueue: interop.PointerConvertible, inEvent: interop.PointerConvertible, inPriority: number): number;

declare function FlushEventsMatchingListFromQueue(inQueue: interop.PointerConvertible, inNumTypes: number, inList: interop.PointerConvertible): number;

declare function FlushSpecificEventsFromQueue(inQueue: interop.PointerConvertible, inComparator: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number, inCompareData: interop.PointerConvertible): number;

declare function FlushEventQueue(inQueue: interop.PointerConvertible): number;

declare function FindSpecificEventInQueue(inQueue: interop.PointerConvertible, inComparator: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number, inCompareData: interop.PointerConvertible): interop.Pointer;

declare function GetNumEventsInQueue(inQueue: interop.PointerConvertible): number;

declare function RemoveEventFromQueue(inQueue: interop.PointerConvertible, inEvent: interop.PointerConvertible): number;

declare function IsEventInQueue(inQueue: interop.PointerConvertible, inEvent: interop.PointerConvertible): number;

declare function AcquireFirstMatchingEventInQueue(inQueue: interop.PointerConvertible, inNumTypes: number, inList: interop.PointerConvertible, inOptions: number): interop.Pointer;

declare function GetCurrentEvent(): interop.Pointer;

declare function GetCurrentEventButtonState(): number;

declare function GetCurrentEventKeyModifiers(): number;

declare function HIGetMousePosition(inSpace: number, inObject: interop.PointerConvertible, outPoint: interop.PointerConvertible): interop.Pointer;
...
declare function NewEventLoopTimerUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void;

declare function NewEventLoopIdleTimerUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => void;

declare function DisposeEventLoopTimerUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;
...
declare function DisposeEventHandlerUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function InvokeEventHandlerUPP(inHandlerCallRef: interop.PointerConvertible, inEvent: interop.PointerConvertible, inUserData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InstallEventHandler(inTarget: interop.PointerConvertible, inHandler: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, inNumTypes: number, inList: interop.PointerConvertible, inUserData: interop.PointerConvertible, outRef: interop.PointerConvertible): number;

declare function RemoveEventHandler(inHandlerRef: interop.PointerConvertible): number;

declare function AddEventTypesToHandler(inHandlerRef: interop.PointerConvertible, inNumTypes: number, inList: interop.PointerConvertible): number;

declare function RemoveEventTypesFromHandler(inHandlerRef: interop.PointerConvertible, inNumTypes: number, inList: interop.PointerConvertible): number;

declare function CallNextEventHandler(inCallRef: interop.PointerConvertible, inEvent: interop.PointerConvertible): number;

declare function SendEventToEventTarget(inEvent: interop.PointerConvertible, inTarget: interop.PointerConvertible): number;

declare function SendEventToEventTargetWithOptions(inEvent: interop.PointerConvertible, inTarget: interop.PointerConvertible, inOptions: number): number;
...
declare function NewThemeEraseUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void;

declare function NewThemeButtonDrawUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: number) => void): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: number) => void;

declare function NewWindowTitleDrawingUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void;

declare function NewThemeIteratorUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function DisposeThemeTabTitleDrawUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: interop.PointerConvertible) => void): void;

declare function DisposeThemeEraseUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): void;

declare function DisposeThemeButtonDrawUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: number) => void): void;

declare function DisposeWindowTitleDrawingUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function DisposeThemeIteratorUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function InvokeThemeTabTitleDrawUPP(bounds: interop.PointerConvertible, style: number, direction: number, depth: number, isColorDev: number, userData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: interop.PointerConvertible) => void): void;

declare function InvokeThemeEraseUPP(bounds: interop.PointerConvertible, eraseData: interop.PointerConvertible, depth: number, isColorDev: number, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number) => void): void;

declare function InvokeThemeButtonDrawUPP(bounds: interop.PointerConvertible, kind: number, info: interop.PointerConvertible, userData: interop.PointerConvertible, depth: number, isColorDev: number, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: number, p6: number) => void): void;

declare function InvokeWindowTitleDrawingUPP(bounds: interop.PointerConvertible, depth: number, colorDevice: number, userData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function InvokeThemeIteratorUPP(inFileName: interop.PointerConvertible, resID: number, inThemeSettings: interop.PointerConvertible, inUserData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function NewMenuTitleDrawingUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void;

declare function NewMenuItemDrawingUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void;

declare function DisposeMenuTitleDrawingUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function DisposeMenuItemDrawingUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function InvokeMenuTitleDrawingUPP(inBounds: interop.PointerConvertible, inDepth: number, inIsColorDevice: number, inUserData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function InvokeMenuItemDrawingUPP(inBounds: interop.PointerConvertible, inDepth: number, inIsColorDevice: number, inUserData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function Button(): number;

declare function GetKeys(theKeys: unknown /* const array */): void;

declare function FlushEvents(whichMask: number, stopMask: number): void;

declare function IsCmdChar(event: interop.PointerConvertible, test: number): number;
...
declare function CMPluginHandleSelection(thisInstance: interop.PointerConvertible, inContext: interop.PointerConvertible, inCommandID: number): number;

declare function CMPluginPostMenuCleanup(thisInstance: interop.PointerConvertible): void;

declare function NewHighHookUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void;

declare function NewEOLHookUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function NewCaretHookUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void;

declare function NewWidthHookUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function NewTextWidthHookUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function NewNWidthHookUPP(userRoutine: (p1: number, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number): (p1: number, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number;

declare function NewDrawHookUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void;

declare function NewHitTestHookUPP(userRoutine: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => number): (p1: number, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => number;

declare function NewTEFindWordUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void;

declare function NewTERecalcUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void;

declare function NewTEDoTextUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void;

declare function NewTEClickLoopUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function DisposeHighHookUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function DisposeEOLHookUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function DisposeCaretHookUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function DisposeWidthHookUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function DisposeTextWidthHookUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function DisposeNWidthHookUPP(userUPP: (p1: number, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number): void;

declare function DisposeDrawHookUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function DisposeHitTestHookUPP(userUPP: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => number): void;

declare function DisposeTEFindWordUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): void;

declare function DisposeTERecalcUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function DisposeTEDoTextUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): void;

declare function DisposeTEClickLoopUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function InvokeHighHookUPP(r: interop.PointerConvertible, pTE: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function InvokeEOLHookUPP(theChar: number, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InvokeCaretHookUPP(r: interop.PointerConvertible, pTE: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function InvokeWidthHookUPP(textLen: number, textOffset: number, textBufferPtr: interop.PointerConvertible, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): number;

declare function InvokeTextWidthHookUPP(textLen: number, textOffset: number, textBufferPtr: interop.PointerConvertible, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): number;

declare function InvokeNWidthHookUPP(styleRunLen: number, styleRunOffset: number, slop: number, direction: number, textBufferPtr: interop.PointerConvertible, lineStart: interop.PointerConvertible, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible) => number): number;

declare function InvokeDrawHookUPP(textOffset: number, drawLen: number, textBufferPtr: interop.PointerConvertible, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function InvokeHitTestHookUPP(styleRunLen: number, styleRunOffset: number, slop: number, textBufferPtr: interop.PointerConvertible, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, pixelWidth: interop.PointerConvertible, charOffset: interop.PointerConvertible, pixelInChar: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible, p7: interop.PointerConvertible, p8: interop.PointerConvertible, p9: interop.PointerConvertible) => number): number;

declare function InvokeTEFindWordUPP(currentPos: number, caller: number, pTE: interop.PointerConvertible, hTE: interop.PointerConvertible, wordStart: interop.PointerConvertible, wordEnd: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): void;

declare function InvokeTERecalcUPP(pTE: interop.PointerConvertible, changeLength: number, lineStart: interop.PointerConvertible, firstChar: interop.PointerConvertible, lastChar: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function InvokeTEDoTextUPP(pTE: interop.PointerConvertible, firstChar: number, lastChar: number, selector: number, currentGrafPort: interop.PointerConvertible, charPosition: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): void;

declare function InvokeTEClickLoopUPP(pTE: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function NewDragInputUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function DisposeDragInputUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function InvokeDragInputUPP(mouse: interop.PointerConvertible, modifiers: interop.PointerConvertible, dragInputRefCon: interop.PointerConvertible, theDrag: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function NewDragSendDataUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewDragTrackingHandlerUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewDragReceiveHandlerUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function NewDragDrawingUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: Point, p4: interop.PointerConvertible, p5: Point, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: Point, p4: interop.PointerConvertible, p5: Point, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number;

declare function DisposeDragSendDataUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeDragTrackingHandlerUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeDragReceiveHandlerUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function DisposeDragDrawingUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: Point, p4: interop.PointerConvertible, p5: Point, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): void;

declare function InvokeDragSendDataUPP(theType: number, dragSendRefCon: interop.PointerConvertible, theItemRef: interop.PointerConvertible, theDrag: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeDragTrackingHandlerUPP(message: number, theWindow: interop.PointerConvertible, handlerRefCon: interop.PointerConvertible, theDrag: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeDragReceiveHandlerUPP(theWindow: interop.PointerConvertible, handlerRefCon: interop.PointerConvertible, theDrag: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InvokeDragDrawingUPP(message: number, showRegion: interop.PointerConvertible, showOrigin: Point, hideRegion: interop.PointerConvertible, hideOrigin: Point, dragDrawingRefCon: interop.PointerConvertible, theDrag: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: Point, p4: interop.PointerConvertible, p5: Point, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number): number;

declare function NewControlActionUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => void): (p1: interop.PointerConvertible, p2: number) => void;
...
declare function DisposeWindowPaintUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): void;

declare function InvokeWindowPaintUPP(device: interop.PointerConvertible, qdContext: interop.PointerConvertible, window: interop.PointerConvertible, inClientPaintRgn: interop.PointerConvertible, outSystemPaintRgn: interop.PointerConvertible, refCon: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): number;

declare function CheckEventQueueForUserCancel(): number;

declare function IsUserCancelEventRef(event: interop.PointerConvertible): number;

declare function HIMouseTrackingGetParameters(inSelector: number, outTime: interop.PointerConvertible, outDistance: interop.PointerConvertible): number;

declare function GetApplicationEventTarget(): interop.Pointer;

declare function GetEventDispatcherTarget(): interop.Pointer;

declare function GetEventMonitorTarget(): interop.Pointer;

declare function ProcessHICommand(inCommand: interop.PointerConvertible): number;

declare function RegisterEventHotKey(inHotKeyCode: number, inHotKeyModifiers: number, inHotKeyID: EventHotKeyID, inTarget: interop.PointerConvertible, inOptions: number, outRef: interop.PointerConvertible): number;

declare function UnregisterEventHotKey(inHotKey: interop.PointerConvertible): number;

declare function CopySymbolicHotKeys(outHotKeyArray: interop.PointerConvertible): number;

declare function PushSymbolicHotKeyMode(inOptions: number): interop.Pointer;

declare function PopSymbolicHotKeyMode(inToken: interop.PointerConvertible): void;
...
declare function HIThemeGetButtonContentBounds(inBounds: interop.PointerConvertible, inDrawInfo: interop.PointerConvertible, outBounds: interop.PointerConvertible): number;
...
declare function HIThemeGetTabPaneContentShape(inRect: interop.PointerConvertible, inDirection: number, inTabSize: number, outShape: interop.PointerConvertible): number;

declare function HIThemeGetTabDrawShape(inRect: interop.PointerConvertible, inDrawInfo: interop.PointerConvertible, outShape: interop.PointerConvertible): number;
...
declare function HIThemeHitTestTrack(inDrawInfo: interop.PointerConvertible, inMousePoint: interop.PointerConvertible, outPartHit: interop.PointerConvertible): number;

declare function HIThemeGetTrackBounds(inDrawInfo: interop.PointerConvertible, outBounds: interop.PointerConvertible): number;

declare function HIThemeGetTrackPartBounds(inDrawInfo: interop.PointerConvertible, inPartCode: number, outPartBounds: interop.PointerConvertible): number;

declare function HIThemeGetTrackParts(inDrawInfo: interop.PointerConvertible, outNumberOfParts: interop.PointerConvertible, inMaxParts: number, ioPartsBuffer: interop.PointerConvertible): number;

declare function HIThemeGetTrackDragRect(inDrawInfo: interop.PointerConvertible, outDragRect: interop.PointerConvertible): number;

declare function HIThemeGetTrackThumbPositionFromOffset(inDrawInfo: interop.PointerConvertible, inThumbOffset: interop.PointerConvertible, outRelativePosition: interop.PointerConvertible): number;

declare function HIThemeGetTrackThumbPositionFromBounds(inDrawInfo: interop.PointerConvertible, inThumbBounds: interop.PointerConvertible, outRelativePosition: interop.PointerConvertible): number;

declare function HIThemeGetTrackLiveValue(inDrawInfo: interop.PointerConvertible, inRelativePosition: number, outValue: interop.PointerConvertible): number;

declare function HIThemeGetScrollBarTrackRect(inBounds: interop.PointerConvertible, inTrackInfo: interop.PointerConvertible, inIsHoriz: number, outTrackBounds: interop.PointerConvertible): number;
...
declare function HIThemeGetWindowShape(inContRect: interop.PointerConvertible, inDrawInfo: interop.PointerConvertible, inWinRegion: number, outShape: interop.PointerConvertible): number;
...
declare function HIThemeGetTextColorForThemeBrush(inBrush: number, inWindowIsActive: number, outColor: interop.PointerConvertible): number;

declare function GetThemeMenuSeparatorHeight(outHeight: interop.PointerConvertible): number;

declare function GetThemeMenuItemExtra(inItemType: number, outHeight: interop.PointerConvertible, outWidth: interop.PointerConvertible): number;

declare function GetThemeMenuTitleExtra(outWidth: interop.PointerConvertible, inIsSquished: number): number;

declare function GetThemeMetric(inMetric: number, outMetric: interop.PointerConvertible): number;

declare function CopyThemeIdentifier(outIdentifier: interop.PointerConvertible): number;

declare function NewNMUPP(userRoutine: (p1: interop.PointerConvertible) => void): (p1: interop.PointerConvertible) => void;

declare function DisposeNMUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function InvokeNMUPP(nmReqPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => void): void;

declare function NewModalFilterUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function NewModalFilterYDUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewUserItemUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => void): (p1: interop.PointerConvertible, p2: number) => void;

declare function DisposeModalFilterUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function DisposeModalFilterYDUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;

declare function DisposeUserItemUPP(userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;

declare function InvokeModalFilterUPP(theDialog: interop.PointerConvertible, theEvent: interop.PointerConvertible, itemHit: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InvokeModalFilterYDUPP(theDialog: interop.PointerConvertible, theEvent: interop.PointerConvertible, itemHit: interop.PointerConvertible, yourDataPtr: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): number;

declare function InvokeUserItemUPP(theDialog: interop.PointerConvertible, itemNo: number, userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;

declare function AESend(theAppleEvent: interop.PointerConvertible, reply: interop.PointerConvertible, sendMode: number, sendPriority: number, timeOutInTicks: number, idleProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, filterProc: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number): number;

declare function AEProcessAppleEvent(theEventRecord: interop.PointerConvertible): number;

declare function AEProcessEvent(inEvent: interop.PointerConvertible): number;

declare function AEResetTimer(reply: interop.PointerConvertible): number;

declare function AEGetInteractionAllowed(level: interop.PointerConvertible): number;

declare function AESetInteractionAllowed(level: number): number;

declare function AEInteractWithUser(timeOutInTicks: number, nmReqPtr: interop.PointerConvertible, idleProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function AESuspendTheCurrentEvent(theAppleEvent: interop.PointerConvertible): number;

declare function AEResumeTheCurrentEvent(theAppleEvent: interop.PointerConvertible, reply: interop.PointerConvertible, dispatcher: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, handlerRefcon: interop.PointerConvertible): number;

declare function AEGetTheCurrentEvent(theAppleEvent: interop.PointerConvertible): number;

declare function AESetTheCurrentEvent(theAppleEvent: interop.PointerConvertible): number;

declare function NewAEIdleUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function NewAEFilterUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number;

declare function DisposeAEIdleUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function DisposeAEFilterUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number): void;

declare function InvokeAEIdleUPP(theEvent: interop.PointerConvertible, sleepTime: interop.PointerConvertible, mouseRgn: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function InvokeAEFilterUPP(theEvent: interop.PointerConvertible, returnID: number, transactionID: number, sender: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number): number;

declare function TSMSetDocumentProperty(docID: interop.PointerConvertible, propertyTag: number, propertySize: number, propertyData: interop.PointerConvertible): number;

declare function TSMGetDocumentProperty(docID: interop.PointerConvertible, propertyTag: number, bufferSize: number, actualSize: interop.PointerConvertible, propertyBuffer: interop.PointerConvertible): number;

declare function TSMRemoveDocumentProperty(docID: interop.PointerConvertible, propertyTag: number): number;

declare function TSMGetActiveDocument(): interop.Pointer;

declare function NewScrapPromiseKeeperUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number;

declare function DisposeScrapPromiseKeeperUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): void;

declare function InvokeScrapPromiseKeeperUPP(scrap: interop.PointerConvertible, flavorType: number, userData: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): number;

declare function NewTXNFindUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number, p6: number, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible, p10: interop.PointerConvertible, p11: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number, p6: number, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible, p10: interop.PointerConvertible, p11: interop.PointerConvertible) => number;

declare function NewTXNActionNameMapperUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => interop.Pointer): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => interop.Pointer;

declare function NewTXNContextualMenuSetupUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => void;

declare function NewTXNScrollInfoUPP(userRoutine: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible) => void): (p1: number, p2: number, p3: number, p4: interop.PointerConvertible) => void;

declare function DisposeTXNFindUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number, p6: number, p7: number, p8: interop.PointerConvertible, p9: interop.PointerConvertible, p10: interop.PointerConvertible, p11: interop.PointerConvertible) => number): void;

declare function DisposeTXNActionNameMapperUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => interop.Pointer): void;

declare function DisposeTXNContextualMenuSetupUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => void): void;

declare function DisposeTXNScrollInfoUPP(userUPP: (p1: number, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;
...
declare function NewTXNActionKeyMapperUPP(userRoutine: (p1: number, p2: number) => interop.Pointer): (p1: number, p2: number) => interop.Pointer;
...
declare function NewHMWindowContentUPP(userRoutine: (p1: interop.PointerConvertible, p2: Point, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: Point, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function NewHMMenuTitleContentUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function NewHMMenuItemContentUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number;

declare function DisposeHMControlContentUPP(userUPP: (p1: interop.PointerConvertible, p2: Point, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function DisposeHMWindowContentUPP(userUPP: (p1: interop.PointerConvertible, p2: Point, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function DisposeHMMenuTitleContentUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => number): void;
...
declare function NewControlUserPaneDrawUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => void): (p1: interop.PointerConvertible, p2: number) => void;

declare function NewControlUserPaneHitTestUPP(userRoutine: (p1: interop.PointerConvertible, p2: Point) => number): (p1: interop.PointerConvertible, p2: Point) => number;

declare function NewControlUserPaneTrackingUPP(userRoutine: (p1: interop.PointerConvertible, p2: Point, p3: (p1: interop.PointerConvertible, p2: number) => void) => number): (p1: interop.PointerConvertible, p2: Point, p3: (p1: interop.PointerConvertible, p2: number) => void) => number;

declare function NewControlUserPaneIdleUPP(userRoutine: (p1: interop.PointerConvertible) => void): (p1: interop.PointerConvertible) => void;

declare function NewControlUserPaneKeyDownUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number;

declare function NewControlUserPaneActivateUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => void): (p1: interop.PointerConvertible, p2: number) => void;

declare function NewControlUserPaneFocusUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => number): (p1: interop.PointerConvertible, p2: number) => number;

declare function DisposeControlUserPaneDrawUPP(userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;

declare function DisposeControlUserPaneHitTestUPP(userUPP: (p1: interop.PointerConvertible, p2: Point) => number): void;

declare function DisposeControlUserPaneTrackingUPP(userUPP: (p1: interop.PointerConvertible, p2: Point, p3: (p1: interop.PointerConvertible, p2: number) => void) => number): void;

declare function DisposeControlUserPaneIdleUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function DisposeControlUserPaneKeyDownUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number): void;

declare function DisposeControlUserPaneActivateUPP(userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;
...
declare function DisposeDataBrowserItemUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => void): void;

declare function InvokeDataBrowserItemUPP(item: number, state: number, clientData: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible) => void): void;

declare function NewDataBrowserItemDataUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number) => number;

declare function NewDataBrowserItemCompareUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number;

declare function NewDataBrowserItemNotificationWithItemUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void;

declare function NewDataBrowserItemNotificationUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number) => void): (p1: interop.PointerConvertible, p2: number, p3: number) => void;

declare function NewDataBrowserAddDragItemUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: interop.PointerConvertible) => number;

declare function NewDataBrowserAcceptDragUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number;

declare function NewDataBrowserReceiveDragUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number;

declare function NewDataBrowserPostProcessDragUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => void;

declare function NewDataBrowserGetContextualMenuUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void;

declare function NewDataBrowserSelectContextualMenuUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void;

declare function NewDataBrowserItemHelpContentUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => void;

declare function DisposeDataBrowserItemDataUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: number) => number): void;

declare function DisposeDataBrowserItemCompareUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number) => number): void;

declare function DisposeDataBrowserItemNotificationWithItemUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => void): void;

declare function DisposeDataBrowserItemNotificationUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number) => void): void;

declare function DisposeDataBrowserAddDragItemUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: interop.PointerConvertible) => number): void;

declare function DisposeDataBrowserAcceptDragUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): void;

declare function DisposeDataBrowserReceiveDragUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => number): void;

declare function DisposeDataBrowserPostProcessDragUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number) => void): void;

declare function DisposeDataBrowserGetContextualMenuUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function DisposeDataBrowserSelectContextualMenuUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number) => void): void;
...
declare function NewDataBrowserEditItemUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number;

declare function NewDataBrowserHitTestUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function NewDataBrowserTrackingUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: Point, p6: number) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: Point, p6: number) => number;

declare function NewDataBrowserItemDragRgnUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void;

declare function NewDataBrowserItemAcceptDragUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number;

declare function NewDataBrowserItemReceiveDragUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible) => number;

declare function DisposeDataBrowserDrawItemUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible, p6: number, p7: number) => void): void;

declare function DisposeDataBrowserEditItemUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible, p6: interop.PointerConvertible) => number): void;

declare function DisposeDataBrowserHitTestUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;

declare function DisposeDataBrowserTrackingUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: Point, p6: number) => number): void;

declare function DisposeDataBrowserItemDragRgnUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => void): void;

declare function DisposeDataBrowserItemAcceptDragUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible, p5: interop.PointerConvertible) => number): void;
...
declare function NewEditUnicodePostUpdateUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: interop.PointerConvertible) => number;

declare function DisposeControlEditTextValidationUPP(userUPP: (p1: interop.PointerConvertible) => void): void;
...
declare function NewListSearchUPP(userRoutine: (p1: string, p2: string, p3: number, p4: number) => number): (p1: string, p2: string, p3: number, p4: number) => number;

declare function NewListClickLoopUPP(userRoutine: () => number): () => number;

declare function NewListDefUPP(userRoutine: (p1: number, p2: number, p3: interop.PointerConvertible, p4: Point, p5: number, p6: number, p7: interop.PointerConvertible) => void): (p1: number, p2: number, p3: interop.PointerConvertible, p4: Point, p5: number, p6: number, p7: interop.PointerConvertible) => void;

declare function DisposeListSearchUPP(userUPP: (p1: string, p2: string, p3: number, p4: number) => number): void;

declare function DisposeListClickLoopUPP(userUPP: () => number): void;

declare function DisposeListDefUPP(userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: Point, p5: number, p6: number, p7: interop.PointerConvertible) => void): void;

declare function InvokeListSearchUPP(aPtr: string, bPtr: string, aLen: number, bLen: number, userUPP: (p1: string, p2: string, p3: number, p4: number) => number): number;

declare function InvokeListClickLoopUPP(userUPP: () => number): number;

declare function InvokeListDefUPP(lMessage: number, lSelect: number, lRect: interop.PointerConvertible, lCell: Point, lDataOffset: number, lDataLen: number, lHandle: interop.PointerConvertible, userUPP: (p1: number, p2: number, p3: interop.PointerConvertible, p4: Point, p5: number, p6: number, p7: interop.PointerConvertible) => void): void;

declare function NewGetScrapDataUPP(userRoutine: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number;

declare function DisposeGetScrapDataUPP(userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): void;

declare function InvokeGetScrapDataUPP(requestedFormat: number, dataH: interop.PointerConvertible, srcDataGetterRefCon: interop.PointerConvertible, userUPP: (p1: number, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number): number;

declare function SetSystemUIMode(inMode: number, inOptions: number): number;

declare function GetSystemUIMode(outMode: interop.PointerConvertible, outOptions: interop.PointerConvertible): void;
...
declare function DebugPrintEvent(inEvent: interop.PointerConvertible): void;

declare function NewTSMTEPreUpdateUPP(userRoutine: (p1: interop.PointerConvertible, p2: number) => void): (p1: interop.PointerConvertible, p2: number) => void;

declare function NewTSMTEPostUpdateUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number) => void): (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number) => void;

declare function DisposeTSMTEPreUpdateUPP(userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;

declare function DisposeTSMTEPostUpdateUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number) => void): void;

declare function InvokeTSMTEPreUpdateUPP(textH: interop.PointerConvertible, refCon: number, userUPP: (p1: interop.PointerConvertible, p2: number) => void): void;

declare function InvokeTSMTEPostUpdateUPP(textH: interop.PointerConvertible, fixLen: number, inputAreaStart: number, inputAreaEnd: number, pinStart: number, pinEnd: number, refCon: number, userUPP: (p1: interop.PointerConvertible, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number) => void): void;

declare function OSALoad(scriptingComponent: interop.PointerConvertible, scriptData: interop.PointerConvertible, modeFlags: number, resultingScriptID: interop.PointerConvertible): number;

declare function OSAStore(scriptingComponent: interop.PointerConvertible, scriptID: number, desiredType: number, modeFlags: number, resultingScriptData: interop.PointerConvertible): number;

declare function OSAExecute(scriptingComponent: interop.PointerConvertible, compiledScriptID: number, contextID: number, modeFlags: number, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSADisplay(scriptingComponent: interop.PointerConvertible, scriptValueID: number, desiredType: number, modeFlags: number, resultingText: interop.PointerConvertible): number;

declare function OSACopyDisplayString(scriptingComponent: interop.PointerConvertible, scriptID: number, modeFlags: number, result: interop.PointerConvertible): number;

declare function OSAScriptError(scriptingComponent: interop.PointerConvertible, selector: number, desiredType: number, resultingErrorDescription: interop.PointerConvertible): number;

declare function OSADispose(scriptingComponent: interop.PointerConvertible, scriptID: number): number;

declare function OSASetScriptInfo(scriptingComponent: interop.PointerConvertible, scriptID: number, selector: number, value: number): number;

declare function OSAGetScriptInfo(scriptingComponent: interop.PointerConvertible, scriptID: number, selector: number, result: interop.PointerConvertible): number;

declare function OSASetActiveProc(scriptingComponent: interop.PointerConvertible, activeProc: (p1: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function OSAGetActiveProc(scriptingComponent: interop.PointerConvertible, activeProc: interop.PointerConvertible, refCon: interop.PointerConvertible): number;

declare function OSAScriptingComponentName(scriptingComponent: interop.PointerConvertible, resultingScriptingComponentName: interop.PointerConvertible): number;

declare function OSACompile(scriptingComponent: interop.PointerConvertible, sourceData: interop.PointerConvertible, modeFlags: number, previousAndResultingScriptID: interop.PointerConvertible): number;

declare function OSACopyID(scriptingComponent: interop.PointerConvertible, fromID: number, toID: interop.PointerConvertible): number;

declare function OSACopyScript(scriptingComponent: interop.PointerConvertible, fromID: number, toID: interop.PointerConvertible): number;

declare function OSAGetSource(scriptingComponent: interop.PointerConvertible, scriptID: number, desiredType: number, resultingSourceData: interop.PointerConvertible): number;

declare function OSACopySourceString(scriptingComponent: interop.PointerConvertible, scriptID: number, modeFlags: number, result: interop.PointerConvertible): number;

declare function OSACoerceFromDesc(scriptingComponent: interop.PointerConvertible, scriptData: interop.PointerConvertible, modeFlags: number, resultingScriptID: interop.PointerConvertible): number;

declare function OSACoerceToDesc(scriptingComponent: interop.PointerConvertible, scriptID: number, desiredType: number, modeFlags: number, result: interop.PointerConvertible): number;

declare function OSASetSendProc(scriptingComponent: interop.PointerConvertible, sendProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: number, p4: number, p5: number, p6: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, p7: (p1: interop.PointerConvertible, p2: number, p3: number, p4: interop.PointerConvertible) => number, p8: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function OSAGetSendProc(scriptingComponent: interop.PointerConvertible, sendProc: interop.PointerConvertible, refCon: interop.PointerConvertible): number;

declare function OSASetCreateProc(scriptingComponent: interop.PointerConvertible, createProc: (p1: number, p2: number, p3: interop.PointerConvertible, p4: number, p5: number, p6: interop.PointerConvertible, p7: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function OSAGetCreateProc(scriptingComponent: interop.PointerConvertible, createProc: interop.PointerConvertible, refCon: interop.PointerConvertible): number;

declare function OSASetDefaultTarget(scriptingComponent: interop.PointerConvertible, target: interop.PointerConvertible): number;

declare function OSAStartRecording(scriptingComponent: interop.PointerConvertible, compiledScriptToModifyID: interop.PointerConvertible): number;

declare function OSAStopRecording(scriptingComponent: interop.PointerConvertible, compiledScriptID: number): number;

declare function OSALoadExecute(scriptingComponent: interop.PointerConvertible, scriptData: interop.PointerConvertible, contextID: number, modeFlags: number, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSACompileExecute(scriptingComponent: interop.PointerConvertible, sourceData: interop.PointerConvertible, contextID: number, modeFlags: number, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSADoScript(scriptingComponent: interop.PointerConvertible, sourceData: interop.PointerConvertible, contextID: number, desiredType: number, modeFlags: number, resultingText: interop.PointerConvertible): number;

declare function OSASetCurrentDialect(scriptingComponent: interop.PointerConvertible, dialectCode: number): number;

declare function OSAGetCurrentDialect(scriptingComponent: interop.PointerConvertible, resultingDialectCode: interop.PointerConvertible): number;

declare function OSAAvailableDialects(scriptingComponent: interop.PointerConvertible, resultingDialectInfoList: interop.PointerConvertible): number;

declare function OSAGetDialectInfo(scriptingComponent: interop.PointerConvertible, dialectCode: number, selector: number, resultingDialectInfo: interop.PointerConvertible): number;

declare function OSAAvailableDialectCodeList(scriptingComponent: interop.PointerConvertible, resultingDialectCodeList: interop.PointerConvertible): number;

declare function OSASetResumeDispatchProc(scriptingComponent: interop.PointerConvertible, resumeDispatchProc: (p1: interop.PointerConvertible, p2: interop.PointerConvertible, p3: interop.PointerConvertible) => number, refCon: interop.PointerConvertible): number;

declare function OSAGetResumeDispatchProc(scriptingComponent: interop.PointerConvertible, resumeDispatchProc: interop.PointerConvertible, refCon: interop.PointerConvertible): number;

declare function OSAExecuteEvent(scriptingComponent: interop.PointerConvertible, theAppleEvent: interop.PointerConvertible, contextID: number, modeFlags: number, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSADoEvent(scriptingComponent: interop.PointerConvertible, theAppleEvent: interop.PointerConvertible, contextID: number, modeFlags: number, reply: interop.PointerConvertible): number;
...
declare function OSAStoreFile(scriptingComponent: interop.PointerConvertible, scriptID: number, desiredType: number, modeFlags: number, scriptFile: interop.PointerConvertible): number;

declare function OSALoadExecuteFile(scriptingComponent: interop.PointerConvertible, scriptFile: interop.PointerConvertible, contextID: number, modeFlags: number, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSADoScriptFile(scriptingComponent: interop.PointerConvertible, scriptFile: interop.PointerConvertible, contextID: number, desiredType: number, modeFlags: number, resultingText: interop.PointerConvertible): number;

declare function OSAGetStorageType(scriptData: interop.PointerConvertible, dscType: interop.PointerConvertible): number;

declare function OSAAddStorageType(scriptData: interop.PointerConvertible, dscType: number): number;

declare function OSARemoveStorageType(scriptData: interop.PointerConvertible): number;

declare function OSAGetDefaultScriptingComponent(genericScriptingComponent: interop.PointerConvertible, scriptingSubType: interop.PointerConvertible): number;

declare function OSASetDefaultScriptingComponent(genericScriptingComponent: interop.PointerConvertible, scriptingSubType: number): number;

declare function OSAGetScriptingComponent(genericScriptingComponent: interop.PointerConvertible, scriptingSubType: number, scriptingInstance: interop.PointerConvertible): number;

declare function OSAGetScriptingComponentFromStored(genericScriptingComponent: interop.PointerConvertible, scriptData: interop.PointerConvertible, scriptingSubType: interop.PointerConvertible): number;

declare function OSAGenericToRealID(genericScriptingComponent: interop.PointerConvertible, theScriptID: interop.PointerConvertible, theExactComponent: interop.PointerConvertible): number;

declare function OSARealToGenericID(genericScriptingComponent: interop.PointerConvertible, theScriptID: interop.PointerConvertible, theExactComponent: interop.PointerConvertible): number;

declare function ASInit(scriptingComponent: interop.PointerConvertible, modeFlags: number, minStackSize: number, preferredStackSize: number, maxStackSize: number, minHeapSize: number, preferredHeapSize: number, maxHeapSize: number): number;

declare function ASSetSourceStyles(scriptingComponent: interop.PointerConvertible, sourceStyles: interop.PointerConvertible): number;

declare function ASGetSourceStyles(scriptingComponent: interop.PointerConvertible, resultingSourceStyles: interop.PointerConvertible): number;
...
declare function OSASetProperty(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, variableName: interop.PointerConvertible, scriptValueID: number): number;

declare function OSAGetProperty(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, variableName: interop.PointerConvertible, resultingScriptValueID: interop.PointerConvertible): number;

declare function OSAGetPropertyNames(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, resultingPropertyNames: interop.PointerConvertible): number;

declare function OSASetHandler(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, handlerName: interop.PointerConvertible, compiledScriptID: number): number;

declare function OSAGetHandler(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, handlerName: interop.PointerConvertible, resultingCompiledScriptID: interop.PointerConvertible): number;

declare function OSAGetHandlerNames(scriptingComponent: interop.PointerConvertible, modeFlags: number, contextID: number, resultingHandlerNames: interop.PointerConvertible): number;

declare function OSAGetSysTerminology(scriptingComponent: interop.PointerConvertible, modeFlags: number, terminologyID: number, terminologyList: interop.PointerConvertible): number;
...
declare function DisposeNColorChangedUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function InvokeNColorChangedUPP(userData: interop.PointerConvertible, newColor: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => void): void;

declare function GetColor(where: Point, prompt: interop.PointerConvertible, inColor: interop.PointerConvertible, outColor: interop.PointerConvertible): number;

declare function NPickColor(theColorInfo: interop.PointerConvertible): number;

declare function NewCalibrateEventUPP(userRoutine: (p1: interop.PointerConvertible) => void): (p1: interop.PointerConvertible) => void;

declare function NewCanCalibrateUPP(userRoutine: (p1: number, p2: interop.PointerConvertible) => number): (p1: number, p2: interop.PointerConvertible) => number;

declare function NewCalibrateUPP(userRoutine: (p1: interop.PointerConvertible) => number): (p1: interop.PointerConvertible) => number;

declare function DisposeCalibrateEventUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function DisposeCanCalibrateUPP(userUPP: (p1: number, p2: interop.PointerConvertible) => number): void;

declare function DisposeCalibrateUPP(userUPP: (p1: interop.PointerConvertible) => number): void;

declare function InvokeCalibrateEventUPP(event: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => void): void;

declare function InvokeCanCalibrateUPP(displayID: number, errMessage: unknown /* const array */, userUPP: (p1: number, p2: interop.PointerConvertible) => number): number;

declare function InvokeCalibrateUPP(theInfo: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => number): number;

declare function CMCalibrateDisplay(theInfo: interop.PointerConvertible): number;

declare function FPIsFontPanelVisible(): number;
...
declare function DisposeSRCallBackUPP(userUPP: (p1: interop.PointerConvertible) => void): void;

declare function InvokeSRCallBackUPP(param: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible) => void): void;

declare function SROpenRecognitionSystem(system: interop.PointerConvertible, systemID: number): number;

declare function SRCloseRecognitionSystem(system: interop.PointerConvertible): number;

declare function SRSetProperty(srObject: interop.PointerConvertible, selector: number, property: interop.PointerConvertible, propertyLen: number): number;

declare function SRGetProperty(srObject: interop.PointerConvertible, selector: number, property: interop.PointerConvertible, propertyLen: interop.PointerConvertible): number;

declare function SRReleaseObject(srObject: interop.PointerConvertible): number;

declare function SRGetReference(srObject: interop.PointerConvertible, newObjectRef: interop.PointerConvertible): number;

declare function SRNewRecognizer(system: interop.PointerConvertible, recognizer: interop.PointerConvertible, sourceID: number): number;

declare function SRStartListening(recognizer: interop.PointerConvertible): number;

declare function SRStopListening(recognizer: interop.PointerConvertible): number;

declare function SRSetLanguageModel(recognizer: interop.PointerConvertible, languageModel: interop.PointerConvertible): number;

declare function SRGetLanguageModel(recognizer: interop.PointerConvertible, languageModel: interop.PointerConvertible): number;

declare function SRContinueRecognition(recognizer: interop.PointerConvertible): number;

declare function SRCancelRecognition(recognizer: interop.PointerConvertible): number;

declare function SRIdle(): number;

declare function SRNewLanguageModel(system: interop.PointerConvertible, model: interop.PointerConvertible, name: interop.PointerConvertible, nameLength: number): number;

declare function SRNewPath(system: interop.PointerConvertible, path: interop.PointerConvertible): number;

declare function SRNewPhrase(system: interop.PointerConvertible, phrase: interop.PointerConvertible, text: interop.PointerConvertible, textLength: number): number;

declare function SRNewWord(system: interop.PointerConvertible, word: interop.PointerConvertible, text: interop.PointerConvertible, textLength: number): number;

declare function SRPutLanguageObjectIntoHandle(languageObject: interop.PointerConvertible, lobjHandle: interop.PointerConvertible): number;

declare function SRPutLanguageObjectIntoDataFile(languageObject: interop.PointerConvertible, fRefNum: number): number;

declare function SRNewLanguageObjectFromHandle(system: interop.PointerConvertible, languageObject: interop.PointerConvertible, lObjHandle: interop.PointerConvertible): number;

declare function SRNewLanguageObjectFromDataFile(system: interop.PointerConvertible, languageObject: interop.PointerConvertible, fRefNum: number): number;

declare function SREmptyLanguageObject(languageObject: interop.PointerConvertible): number;

declare function SRChangeLanguageObject(languageObject: interop.PointerConvertible, text: interop.PointerConvertible, textLength: number): number;

declare function SRAddLanguageObject(base: interop.PointerConvertible, addon: interop.PointerConvertible): number;

declare function SRAddText(base: interop.PointerConvertible, text: interop.PointerConvertible, textLength: number, refCon: interop.PointerConvertible): number;

declare function SRRemoveLanguageObject(base: interop.PointerConvertible, toRemove: interop.PointerConvertible): number;

declare function SRCountItems(container: interop.PointerConvertible, count: interop.PointerConvertible): number;

declare function SRGetIndexedItem(container: interop.PointerConvertible, item: interop.PointerConvertible, index: number): number;

declare function SRSetIndexedItem(container: interop.PointerConvertible, item: interop.PointerConvertible, index: number): number;

declare function SRRemoveIndexedItem(container: interop.PointerConvertible, index: number): number;

declare function SRDrawText(recognizer: interop.PointerConvertible, dispText: interop.PointerConvertible, dispLength: number): number;

declare function SRDrawRecognizedText(recognizer: interop.PointerConvertible, dispText: interop.PointerConvertible, dispLength: number): number;

declare function SRSpeakText(recognizer: interop.PointerConvertible, speakText: interop.PointerConvertible, speakLength: number): number;

declare function SRSpeakAndDrawText(recognizer: interop.PointerConvertible, text: interop.PointerConvertible, textLength: number): number;

declare function SRStopSpeech(recognizer: interop.PointerConvertible): number;

declare function SRSpeechBusy(recognizer: interop.PointerConvertible): number;

declare function SRProcessBegin(recognizer: interop.PointerConvertible, failed: number): number;

declare function SRProcessEnd(recognizer: interop.PointerConvertible, failed: number): number;

declare function KCAddAppleSharePassword(serverSignature: interop.PointerConvertible, serverAddress: interop.PointerConvertible, serverName: interop.PointerConvertible, volumeName: interop.PointerConvertible, accountName: interop.PointerConvertible, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCAddInternetPassword(serverName: interop.PointerConvertible, securityDomain: interop.PointerConvertible, accountName: interop.PointerConvertible, port: number, protocol: number, authType: number, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function KCAddInternetPasswordWithPath(serverName: interop.PointerConvertible, securityDomain: interop.PointerConvertible, accountName: interop.PointerConvertible, path: interop.PointerConvertible, port: number, protocol: number, authType: number, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;
...
declare function kcaddapplesharepassword(serverSignature: interop.PointerConvertible, serverAddress: string, serverName: string, volumeName: string, accountName: string, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function kcaddinternetpassword(serverName: string, securityDomain: string, accountName: string, port: number, protocol: number, authType: number, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function kcaddinternetpasswordwithpath(serverName: string, securityDomain: string, accountName: string, path: string, port: number, protocol: number, authType: number, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function kcaddgenericpassword(serviceName: string, accountName: string, passwordLength: number, passwordData: interop.PointerConvertible, item: interop.PointerConvertible): number;

declare function NewURLNotifyUPP(userRoutine: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number;

declare function NewURLSystemEventUPP(userRoutine: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number;

declare function DisposeURLNotifyUPP(userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): void;

declare function DisposeURLSystemEventUPP(userUPP: (p1: interop.PointerConvertible, p2: interop.PointerConvertible) => number): void;

declare function InvokeURLNotifyUPP(userContext: interop.PointerConvertible, event: number, callbackInfo: interop.PointerConvertible, userUPP: (p1: interop.PointerConvertible, p2: number, p3: interop.PointerConvertible) => number): number;
...
declare function AHRegisterHelpBookWithURL(applicationURL: interop.PointerConvertible): number;

declare interface IMKTextInput {
  insertTextReplacementRange(string: interop.Object, replacementRange: _NSRange): void;

  setMarkedTextSelectionRangeReplacementRange(string: interop.Object, selectionRange: _NSRange, replacementRange: _NSRange): void;
  ...
  characterIndexForPointTrackingInMarkedRange(point: CGPoint, mappingMode: number, inMarkedRange: interop.PointerConvertible): number;

  attributesForCharacterIndexLineHeightRectangle(index: number, lineRect: interop.PointerConvertible): NSDictionary;

  validAttributesForMarkedText(): NSArray;

  overrideKeyboardWithKeyboardNamed(keyboardUniqueName: string): void;

  selectInputMode(modeIdentifier: string): void;
  ...
  supportsProperty(property: number): boolean;

  uniqueClientIdentifierString(): string;

  stringFromRangeActualRange(range: _NSRange, actualRange: interop.PointerConvertible): string;

  firstRectForCharacterRangeActualRange(aRange: _NSRange, actualRange: interop.PointerConvertible): CGRect;
}

declare class IMKTextInput extends NativeObject implements IMKTextInput {
}

declare interface IMKUnicodeTextInput {
  insertText(string: interop.Object): void;
}

declare class IMKUnicodeTextInput extends NativeObject implements IMKUnicodeTextInput {
}
