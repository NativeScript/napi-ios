...
declare class TkDisplay {
  ...
  metaModMask: number;
  altModMask: number;
  lockUsage: interop.Enum<typeof TkDisplay::(unnamed at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/System/Library/Frameworks/Tk.framework/Headers/tk-private/tkInt.h:209:5)>;
...
declare class XClientMessageEvent {
  ...
  message_type: number;
  format: number;
  data: unnamed_4904452087451051455;
}
...
declare class unnamed_13960883516327852850 {
  constructor(init?: unnamed_13960883516327852850);
...
declare class _XDisplay {
  ...
  cms: unnamed_13960883516327852850;
...
declare class unnamed_2352001328441991241 {
  constructor(init?: unnamed_2352001328441991241);
  flags: number;
  input: number;
...
declare class unnamed_4050213587489563428 {
  constructor(init?: unnamed_4050213587489563428);
  x: number;
  y: number;
}
...
declare class XSizeHints {
  ...
  width_inc: number;
  height_inc: number;
  min_aspect: unnamed_4050213587489563428;
  max_aspect: unnamed_4050213587489563428;
  base_width: number;
  base_height: number;
  win_gravity: number;
}
...
declare class TkpClipMask {
  ...
  type: number;
  value: unnamed_11038567333036823393;
}
...
declare class unnamed_4701682215625571257 {
  constructor(init?: unnamed_4701682215625571257);
  visual: interop.Pointer;
  visualid: number;
  screen: number;
  depth: number;
...
declare class Tk_Dash {
  ...
  number: number;
  pattern: unnamed_16115917518980463070;
}
...
declare class unnamed_12188705564808401902 {
  constructor(init?: unnamed_12188705564808401902);
  colormap: number;
  red_max: number;
  red_mult: number;
  green_max: number;
...
declare class _XIMText {
  ...
  string: unnamed_13436300643023984661;
}
...
declare class unnamed_5481127661812118336 {
  constructor(init?: unnamed_5481127661812118336);
...
declare class _XIMStatusDrawCallbackStruct {
  ...
  data: unnamed_11598040957152129888;
}
...
type unnamed_16115917518980463070Descriptor = 
  | { pt: string | null }
  | { array: unknown /* const array */ };

declare class unnamed_16115917518980463070 {
  constructor(init?: unnamed_16115917518980463070Descriptor);
  pt: string | null;
  array: unknown /* const array */;
}

type unnamed_11598040957152129888Descriptor = 
  | { text: interop.PointerConvertible }
  | { bitmap: number };

declare class unnamed_11598040957152129888 {
  constructor(init?: unnamed_11598040957152129888Descriptor);
  text: interop.Pointer;
  bitmap: number;
}

type unnamed_13436300643023984661Descriptor = 
  | { multi_byte: string | null }
  | { wide_char: interop.PointerConvertible };

declare class unnamed_13436300643023984661 {
  constructor(init?: unnamed_13436300643023984661Descriptor);
  multi_byte: string | null;
...
type unnamed_11038567333036823393Descriptor = 
  | { pixmap: number }
  | { region: interop.PointerConvertible };

declare class unnamed_11038567333036823393 {
  constructor(init?: unnamed_11038567333036823393Descriptor);
  pixmap: number;
...
type unnamed_4904452087451051455Descriptor = 
  | { b: unknown /* const array */ }
  | { s: unknown /* const array */ }
  | { l: unknown /* const array */ };

declare class unnamed_4904452087451051455 {
  constructor(init?: unnamed_4904452087451051455Descriptor);
  b: unknown /* const array */;
  s: unknown /* const array */;
  l: unknown /* const array */;
}
