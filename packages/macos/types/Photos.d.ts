...
declare class PHPhotoLibrary extends NSObject {
  ...
  localIdentifiersForCloudIdentifiers(cloudIdentifiers: NSArray<interop.Object> | Array<interop.Object>): NSArray;

  cloudIdentifiersForLocalIdentifiers(localIdentifiers: NSArray<interop.Object> | Array<interop.Object>): NSArray;
}
...
declare class PHProjectChangeRequest extends PHChangeRequest {
  ...
  setKeyAsset(keyAsset: PHAsset | null): void;

  setProjectPreviewImage(previewImage: NSImage): void;

  removeAssets(assets: NSFastEnumeration): void;

  setTitle(title: string): void;

  setProjectExtensionData(projectExtensionData: NSData): void;
}
...
declare class PHAssetChangeRequest extends PHChangeRequest {
  static creationRequestForAssetFromImage<This extends abstract new (...args: any) => any>(this: This, image: NSImage): InstanceType<This>;
