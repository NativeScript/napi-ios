...
declare class CNContactFormatter extends NSFormatter implements NSSecureCoding {
  ...
  setStyle(style: interop.Enum<typeof CNContactFormatterStyle>): void;
...
declare class CNMutableContact extends CNContact {
  ...
  setContactType(contactType: interop.Enum<typeof CNContactType>): void;
  ...
  setPreviousFamilyName(previousFamilyName: string): void;
  ...
  setPhoneticGivenName(phoneticGivenName: string): void;

  setPhoneticMiddleName(phoneticMiddleName: string): void;

  setPhoneticFamilyName(phoneticFamilyName: string): void;

  setPhoneticOrganizationName(phoneticOrganizationName: string): void;

  setNote(note: string): void;

  setImageData(imageData: NSData | null): void;

  setPhoneNumbers(phoneNumbers: NSArray<interop.Object> | Array<interop.Object>): void;

  setEmailAddresses(emailAddresses: NSArray<interop.Object> | Array<interop.Object>): void;

  setPostalAddresses(postalAddresses: NSArray<interop.Object> | Array<interop.Object>): void;

  setUrlAddresses(urlAddresses: NSArray<interop.Object> | Array<interop.Object>): void;

  setContactRelations(contactRelations: NSArray<interop.Object> | Array<interop.Object>): void;

  setSocialProfiles(socialProfiles: NSArray<interop.Object> | Array<interop.Object>): void;

  setInstantMessageAddresses(instantMessageAddresses: NSArray<interop.Object> | Array<interop.Object>): void;

  setBirthday(birthday: NSDateComponents | null): void;

  setNonGregorianBirthday(nonGregorianBirthday: NSDateComponents | null): void;

  setDates(dates: NSArray<interop.Object> | Array<interop.Object>): void;
}
...
declare class CNPostalAddressFormatter extends NSFormatter {
  ...
  setStyle(style: interop.Enum<typeof CNPostalAddressFormatterStyle>): void;
}
...
declare class CNContactFetchRequest extends CNFetchRequest implements NSSecureCoding {
  ...
  setKeysToFetch(keysToFetch: NSArray<interop.Object> | Array<interop.Object>): void;

  setMutableObjects(mutableObjects: boolean): void;

  setUnifyResults(unifyResults: boolean): void;

  setSortOrder(sortOrder: interop.Enum<typeof CNContactSortOrder>): void;
...
declare class CNChangeHistoryFetchRequest extends CNFetchRequest implements NSSecureCoding {
  ...
  setStartingToken(startingToken: NSData | null): void;

  setAdditionalContactKeyDescriptors(additionalContactKeyDescriptors: NSArray<interop.Object> | Array<interop.Object> | null): void;

  setShouldUnifyResults(shouldUnifyResults: boolean): void;

  setMutableObjects(mutableObjects: boolean): void;

  setIncludeGroupChanges(includeGroupChanges: boolean): void;

  setExcludedTransactionAuthors(excludedTransactionAuthors: NSArray<interop.Object> | Array<interop.Object> | null): void;
