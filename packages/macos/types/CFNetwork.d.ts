...
declare const kCFNetworkProxiesExceptionsList: interop.Pointer;

declare const kCFStreamSSLAllowsAnyRoot: interop.Pointer;

declare const kCFStreamSSLIsServer: interop.Pointer;

declare const kCFNetworkProxiesHTTPSProxy: interop.Pointer;

declare const kCFHTTPAuthenticationSchemeNTLM: interop.Pointer;

declare const kCFSOCKSVersionKey: interop.Pointer;

declare const kCFStreamPropertySSLPeerTrust: interop.Pointer;

declare const kCFNetworkProxiesRTSPPort: interop.Pointer;

declare const kCFStreamErrorDomainSystemConfiguration: number;

declare const kCFHTTPAuthenticationSchemeXMobileMeAuthToken: interop.Pointer;

declare const kCFNetworkProxiesFTPPassive: interop.Pointer;

declare const kCFNetworkProxiesGopherEnable: interop.Pointer;

declare const kCFNetworkProxiesProxyAutoConfigEnable: interop.Pointer;

declare const kCFProxyTypeHTTP: interop.Pointer;
...
declare const kCFStreamErrorDomainFTP: number;

declare const kCFStreamPropertyHTTPRequestBytesWrittenCount: interop.Pointer;

declare const kCFFTPResourceMode: interop.Pointer;

declare const kCFNetworkProxiesSOCKSEnable: interop.Pointer;

declare const kCFNetworkProxiesRTSPEnable: interop.Pointer;

declare const kCFNetworkProxiesHTTPSPort: interop.Pointer;

declare const kCFNetworkProxiesHTTPSEnable: interop.Pointer;

declare const kCFNetworkProxiesHTTPProxy: interop.Pointer;

declare const kCFNetworkProxiesHTTPPort: interop.Pointer;

declare const kCFNetworkProxiesGopherPort: interop.Pointer;

declare const kCFNetworkProxiesFTPProxy: interop.Pointer;

declare const kCFNetworkProxiesFTPPort: interop.Pointer;

declare const kCFNetworkProxiesExcludeSimpleHostnames: interop.Pointer;

declare const kCFProxyAutoConfigurationHTTPResponseKey: interop.Pointer;

declare const kCFProxyTypeAutoConfigurationJavaScript: interop.Pointer;

declare const kCFProxyTypeAutoConfigurationURL: interop.Pointer;

declare const kCFProxyTypeFTP: interop.Pointer;

declare const kCFProxyTypeNone: interop.Pointer;
...
declare const kCFProxyPortNumberKey: interop.Pointer;

declare const kCFHTTPAuthenticationPassword: interop.Pointer;

declare const kCFStreamPropertyHTTPAttemptPersistentConnection: interop.Pointer;

declare const kCFStreamPropertyHTTPSProxyPort: interop.Pointer;

declare const kCFStreamPropertyHTTPSProxyHost: interop.Pointer;

declare const kCFStreamPropertyHTTPProxyPort: interop.Pointer;

declare const kCFStreamPropertyHTTPProxy: interop.Pointer;

declare const kCFStreamPropertyHTTPResponseHeader: interop.Pointer;

declare const kCFStreamErrorDomainHTTP: number;

declare const kCFHTTPAuthenticationSchemeNegotiate2: interop.Pointer;
...
declare const kCFFTPResourceSize: interop.Pointer;

declare const kCFFTPResourceLink: interop.Pointer;

declare const kCFFTPResourceGroup: interop.Pointer;

declare const kCFFTPResourceOwner: interop.Pointer;

declare const kCFFTPResourceName: interop.Pointer;
...
declare const kCFStreamPropertyFTPAttemptPersistentConnection: interop.Pointer;

declare const kCFStreamPropertyFTPFetchResourceInfo: interop.Pointer;

declare const kCFStreamPropertyFTPResourceSize: interop.Pointer;

declare const kCFStreamPropertyFTPUsePassiveMode: interop.Pointer;

declare const kCFStreamPropertyFTPPassword: interop.Pointer;

declare const kCFStreamPropertyFTPUserName: interop.Pointer;
...
declare const kCFStreamPropertySocketRemoteHost: interop.Pointer;
...
declare const kCFStreamPropertyAllowConstrainedNetworkAccess: interop.Pointer;

declare const kCFStreamPropertyConnectionIsExpensive: interop.Pointer;

declare const kCFStreamPropertyAllowExpensiveNetworkAccess: interop.Pointer;

declare const kCFStreamPropertyConnectionIsCellular: interop.Pointer;

declare const kCFStreamNetworkServiceTypeAVStreaming: interop.Pointer;

declare const kCFStreamNetworkServiceTypeCallSignaling: interop.Pointer;

declare const kCFStreamNetworkServiceTypeResponsiveData: interop.Pointer;

declare const kCFStreamNetworkServiceTypeBackground: interop.Pointer;

declare const kCFStreamSSLPeerName: interop.Pointer;
...
declare const kCFFTPStatusCodeKey: interop.Pointer;

declare const kCFDNSServiceFailureKey: interop.Pointer;

declare const kCFSOCKSNegotiationMethodKey: interop.Pointer;

declare const kCFSOCKSStatusCodeKey: interop.Pointer;

declare const kCFGetAddrInfoFailureKey: interop.Pointer;
...
declare const kCFStreamNetworkServiceTypeResponsiveAV: interop.Pointer;

declare const kCFStreamPropertySocketExtendedBackgroundIdleMode: interop.Pointer;

declare const kCFErrorDomainCFNetwork: interop.Pointer;

declare const kCFProxyTypeHTTPS: interop.Pointer;

declare const kCFHTTPAuthenticationAccountDomain: interop.Pointer;

declare const kCFStreamPropertyHTTPShouldAutoredirect: interop.Pointer;
...
declare const kCFNetworkProxiesProxyAutoDiscoveryEnable: interop.Pointer;
...
declare const kCFStreamPropertyFTPProxy: interop.Pointer;

declare const kCFHTTPVersion1_1: interop.Pointer;
...
declare const kCFStreamNetworkServiceTypeVoIP: interop.Pointer;
...
declare const kCFURLErrorFailingURLStringErrorKey: interop.Pointer;

declare const kCFHTTPAuthenticationSchemeDigest: interop.Pointer;

declare const kCFNetworkProxiesFTPEnable: interop.Pointer;

declare const kCFNetworkProxiesProxyAutoConfigJavaScript: interop.Pointer;

declare const kCFStreamErrorSOCKSUnknownClientVersion: number;

declare const kCFHTTPAuthenticationSchemeKerberos: interop.Pointer;

declare const kCFNetworkProxiesHTTPEnable: interop.Pointer;

declare const kCFStreamPropertyNoCellular: interop.Pointer;

declare const kCFProxyTypeSOCKS: interop.Pointer;

declare const kCFStreamSSLCertificates: interop.Pointer;
...
declare const kCFNetworkProxiesSOCKSProxy: interop.Pointer;

declare const kCFNetworkProxiesGopherProxy: interop.Pointer;

declare const kCFNetworkProxiesSOCKSPort: interop.Pointer;

declare const kCFNetworkProxiesRTSPProxy: interop.Pointer;
...
declare const kCFErrorDomainWinSock: interop.Pointer;

declare const kCFHTTPAuthenticationSchemeNegotiate: interop.Pointer;

declare const kCFNetworkProxiesProxyAutoConfigURLString: interop.Pointer;

declare const kCFProxyPasswordKey: interop.Pointer;

declare const CFNetworkErrors: {
...
declare const CFNetDiagnosticStatusValues: {
  NoErr: 0,
  Err: -66560,
  ConnectionUp: -66559,
...
declare class _CFHTTPAuthentication {
  constructor(init?: _CFHTTPAuthentication);
}

declare class __CFNetServiceMonitor {
  constructor(init?: __CFNetServiceMonitor);
}

declare class __CFNetService {
  constructor(init?: __CFNetService);
}

declare class __CFHost {
  constructor(init?: __CFHost);
}

declare class __CFHTTPMessage {
  constructor(init?: __CFHTTPMessage);
}
...
declare class __CFNetDiagnostic {
  constructor(init?: __CFNetDiagnostic);
}
...
declare function CFNetServiceRegister(theService: interop.Object, error: interop.PointerConvertible): number;

declare function CFNetServiceResolve(theService: interop.Object, error: interop.PointerConvertible): number;
