...
declare function CTFontGetPlatformFont(font: interop.Object, attributes: interop.PointerConvertible): number;

declare function CTFontCreateWithPlatformFont(platformFont: number, size: number, matrix: interop.PointerConvertible, attributes: interop.Object): interop.Object;

declare function CTFontCreateWithQuickdrawInstance(name: interop.PointerConvertible, identifier: number, style: number, size: number): interop.Object;
...
declare function CTFontCollectionCreateMutableCopy(original: interop.Object): interop.Object;

declare function CTFontCollectionCopyQueryDescriptors(collection: interop.Object): interop.Object;

declare function CTFontCollectionSetQueryDescriptors(collection: interop.Object, descriptors: interop.Object): void;

declare function CTFontCollectionCopyExclusionDescriptors(collection: interop.Object): interop.Object;

declare function CTFontCollectionSetExclusionDescriptors(collection: interop.Object, descriptors: interop.Object): void;
...
declare function CTFontCollectionCreateMatchingFontDescriptorsForFamily(collection: interop.Object, familyName: interop.Object, options: interop.Object): interop.Object;
...
declare function CTFontManagerCopyAvailableFontURLs(): interop.Object;
...
declare function CTFontManagerEnableFontDescriptors(descriptors: interop.Object, enable: boolean): void;

declare function CTFontManagerGetScopeForURL(fontURL: interop.Object): interop.Enum<typeof CTFontManagerScope>;

declare function CTFontManagerIsSupportedFont(fontURL: interop.Object): boolean;

declare function CTFontManagerCreateFontRequestRunLoopSource(sourceOrder: number, createMatchesCallback: (p1: interop.PointerConvertible, p2: number) => interop.Pointer): interop.Object;

declare function CTFontManagerSetAutoActivationSetting(bundleIdentifier: interop.Object, setting: interop.Enum<typeof CTFontManagerAutoActivationSetting>): void;

declare function CTFontManagerGetAutoActivationSetting(bundleIdentifier: interop.Object): interop.Enum<typeof CTFontManagerAutoActivationSetting>;
