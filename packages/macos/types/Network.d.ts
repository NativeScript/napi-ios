...
declare const _nw_content_context_default_message: NSObject;

declare const kNWErrorDomainWiFiAware: interop.Pointer;

declare const kNWErrorDomainPOSIX: interop.Pointer;

declare const nw_browse_result_change_result_removed: number;

declare const nw_browse_result_change_invalid: number;

declare const _nw_parameters_configure_protocol_default_configuration: (p1: NSObject) => void;
...
declare const kNWErrorDomainDNS: interop.Pointer;
...
declare const nw_interface_radio_type_t: {
...
declare const nw_ip_ecn_flag_t: {
...
declare const nw_interface_type_t: {
...
declare const nw_connection_group_state_t: {
...
declare const nw_ip_version_t: {
  nw_ip_version_any: 0,
  nw_ip_version_4: 4,
  nw_ip_version_6: 6,
};

declare const nw_browser_state_t: {
...
declare const nw_ip_local_address_preference_t: {
...
declare const nw_ws_close_code_t: {
...
declare const nw_path_status_t: {
...
declare const nw_error_domain_t: {
...
declare const nw_connection_state_t: {
...
declare const nw_multipath_service_t: {
...
declare function nw_release(obj: interop.PointerConvertible): void;

declare function nw_txt_record_create_with_bytes(txt_bytes: interop.PointerConvertible, txt_len: number): NSObject;
...
declare function nw_txt_record_find_key(txt_record: NSObject, key: string): interop.Enum<typeof nw_txt_record_find_key_t>;

declare function nw_txt_record_access_key(txt_record: NSObject, key: string, access_value: (p1: string, p2: interop.Enum<typeof nw_txt_record_find_key_t>, p3: interop.PointerConvertible, p4: number) => boolean): boolean;

declare function nw_txt_record_set_key(txt_record: NSObject, key: string, value: interop.PointerConvertible, value_len: number): boolean;
...
declare function nw_txt_record_access_bytes(txt_record: NSObject, access_bytes: (p1: interop.PointerConvertible, p2: number) => boolean): boolean;

declare function nw_txt_record_apply(txt_record: NSObject, applier: (p1: string, p2: interop.Enum<typeof nw_txt_record_find_key_t>, p3: interop.PointerConvertible, p4: number) => boolean): boolean;
...
declare function nw_advertise_descriptor_set_txt_record(advertise_descriptor: NSObject, txt_record: interop.PointerConvertible, txt_length: number): void;
...
declare function nw_advertise_descriptor_create_application_service(application_service_name: string): NSObject;
...
declare function nw_interface_get_type(interface: NSObject): interop.Enum<typeof nw_interface_type_t>;
...
declare function nw_endpoint_get_type(endpoint: NSObject): interop.Enum<typeof nw_endpoint_type_t>;
...
declare function nw_endpoint_create_address(address: interop.PointerConvertible): NSObject;

declare function nw_endpoint_copy_address_string(endpoint: NSObject): string;

declare function nw_endpoint_get_address(endpoint: NSObject): interop.Pointer;
...
declare function nw_endpoint_get_signature(endpoint: NSObject, out_signature_length: interop.PointerConvertible): interop.Pointer;
...
declare function nw_relay_hop_create(http3_relay_endpoint: NSObject, http2_relay_endpoint: NSObject, relay_tls_options: NSObject): NSObject;

declare function nw_relay_hop_add_additional_http_header_field(relay_hop: NSObject, field_name: string, field_value: string): void;

declare function nw_proxy_config_create_relay(first_hop: NSObject, second_hop: NSObject): NSObject;

declare function nw_proxy_config_create_oblivious_http(relay: NSObject, relay_resource_path: string, gateway_key_config: interop.PointerConvertible, gateway_key_config_length: number): NSObject;

declare function nw_proxy_config_create_http_connect(proxy_endpoint: NSObject, proxy_tls_options: NSObject): NSObject;

declare function nw_proxy_config_create_socksv5(proxy_endpoint: NSObject): NSObject;

declare function nw_proxy_config_set_username_and_password(proxy_config: NSObject, username: string, password: string): void;

declare function nw_proxy_config_set_failover_allowed(proxy_config: NSObject, failover_allowed: boolean): void;

declare function nw_proxy_config_get_failover_allowed(proxy_config: NSObject): boolean;

declare function nw_proxy_config_add_match_domain(config: NSObject, match_domain: string): void;

declare function nw_proxy_config_clear_match_domains(config: NSObject): void;

declare function nw_proxy_config_add_excluded_domain(config: NSObject, excluded_domain: string): void;

declare function nw_proxy_config_clear_excluded_domains(config: NSObject): void;

declare function nw_proxy_config_enumerate_match_domains(config: NSObject, enumerator: (p1: string) => void): void;

declare function nw_proxy_config_enumerate_excluded_domains(config: NSObject, enumerator: (p1: string) => void): void;
...
declare function nw_privacy_context_add_proxy(privacy_context: NSObject, proxy_config: NSObject): void;

declare function nw_privacy_context_clear_proxies(privacy_context: NSObject): void;
...
declare function nw_parameters_create_custom_ip(custom_ip_protocol_number: number, configure_ip: (p1: NSObject) => void): NSObject;
...
declare function nw_parameters_set_attribution(parameters: NSObject, attribution: interop.Enum<typeof nw_parameters_attribution_t>): void;

declare function nw_parameters_get_attribution(parameters: NSObject): interop.Enum<typeof nw_parameters_attribution_t>;
...
declare function nw_parameters_set_required_interface_type(parameters: NSObject, interface_type: interop.Enum<typeof nw_interface_type_t>): void;

declare function nw_parameters_get_required_interface_type(parameters: NSObject): interop.Enum<typeof nw_interface_type_t>;

declare function nw_parameters_prohibit_interface_type(parameters: NSObject, interface_type: interop.Enum<typeof nw_interface_type_t>): void;

declare function nw_parameters_clear_prohibited_interface_types(parameters: NSObject): void;

declare function nw_parameters_iterate_prohibited_interface_types(parameters: NSObject, iterate_block: (p1: interop.Enum<typeof nw_interface_type_t>) => boolean): void;
...
declare function nw_parameters_set_service_class(parameters: NSObject, service_class: interop.Enum<typeof nw_service_class_t>): void;

declare function nw_parameters_get_service_class(parameters: NSObject): interop.Enum<typeof nw_service_class_t>;

declare function nw_parameters_set_multipath_service(parameters: NSObject, multipath_service: interop.Enum<typeof nw_multipath_service_t>): void;

declare function nw_parameters_get_multipath_service(parameters: NSObject): interop.Enum<typeof nw_multipath_service_t>;
...
declare function nw_parameters_set_expired_dns_behavior(parameters: NSObject, expired_dns_behavior: interop.Enum<typeof nw_parameters_expired_dns_behavior_t>): void;

declare function nw_parameters_get_expired_dns_behavior(parameters: NSObject): interop.Enum<typeof nw_parameters_expired_dns_behavior_t>;
...
declare function nw_browse_descriptor_create_application_service(application_service_name: string): NSObject;
...
declare function nw_error_get_error_domain(error: NSObject): interop.Enum<typeof nw_error_domain_t>;
...
declare function nw_browser_set_state_changed_handler(browser: NSObject, state_changed_handler: (p1: interop.Enum<typeof nw_browser_state_t>, p2: NSObject) => void): void;
...
declare function nw_path_get_status(path: NSObject): interop.Enum<typeof nw_path_status_t>;

declare function nw_path_get_unsatisfied_reason(path: NSObject): interop.Enum<typeof nw_path_unsatisfied_reason_t>;
...
declare function nw_path_uses_interface_type(path: NSObject, interface_type: interop.Enum<typeof nw_interface_type_t>): boolean;
...
declare function nw_connection_set_state_changed_handler(connection: NSObject, handler: (p1: interop.Enum<typeof nw_connection_state_t>, p2: NSObject) => void): void;
...
declare function nw_connection_group_set_state_changed_handler(group: NSObject, state_changed_handler: (p1: interop.Enum<typeof nw_connection_group_state_t>, p2: NSObject) => void): void;
...
declare function nw_resolution_report_get_source(resolution_report: NSObject): interop.Enum<typeof nw_report_resolution_source_t>;
...
declare function nw_resolution_report_get_protocol(resolution_report: NSObject): interop.Enum<typeof nw_report_resolution_protocol_t>;

declare function nw_establishment_report_enumerate_resolutions(report: NSObject, enumerate_block: (p1: interop.Enum<typeof nw_report_resolution_source_t>, p2: number, p3: number, p4: NSObject, p5: NSObject) => boolean): void;
...
declare function nw_data_transfer_report_get_state(report: NSObject): interop.Enum<typeof nw_data_transfer_report_state_t>;
...
declare function nw_data_transfer_report_get_path_radio_type(report: NSObject, path_index: number): interop.Enum<typeof nw_interface_radio_type_t>;

declare function nw_ethernet_channel_create(ether_type: number, interface: NSObject): NSObject;

declare function nw_ethernet_channel_create_with_parameters(ether_type: number, interface: NSObject, parameters: NSObject): NSObject;

declare function nw_ethernet_channel_set_state_changed_handler(ethernet_channel: NSObject, handler: (p1: interop.Enum<typeof nw_ethernet_channel_state_t>, p2: NSObject) => void): void;

declare function nw_ethernet_channel_set_queue(ethernet_channel: NSObject, queue: NSObject): void;

declare function nw_ethernet_channel_get_maximum_payload_size(ethernet_channel: NSObject): number;

declare function nw_ethernet_channel_start(ethernet_channel: NSObject): void;

declare function nw_ethernet_channel_cancel(ethernet_channel: NSObject): void;

declare function nw_ethernet_channel_set_receive_handler(ethernet_channel: NSObject, handler: (p1: NSObject, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): void;

declare function nw_ethernet_channel_send(ethernet_channel: NSObject, content: NSObject, vlan_tag: number, remote_address: interop.PointerConvertible, completion: (p1: NSObject) => void): void;
...
declare function nw_framer_message_set_value(message: NSObject, key: string, value: interop.PointerConvertible, dispose_value: (p1: interop.PointerConvertible) => void): void;

declare function nw_framer_message_access_value(message: NSObject, key: string, access_value: (p1: interop.PointerConvertible) => boolean): boolean;

declare function nw_framer_message_set_object_value(message: NSObject, key: string, value: interop.Object): void;

declare function nw_framer_message_copy_object_value(message: NSObject, key: string): interop.Object;

declare function nw_framer_create_definition(identifier: string, flags: number, start_handler: (p1: NSObject) => interop.Enum<typeof nw_framer_start_result_t>): NSObject;

declare function nw_framer_create_options(framer_definition: NSObject): NSObject;

declare function nw_framer_options_set_object_value(options: NSObject, key: string, value: interop.Object): void;

declare function nw_framer_options_copy_object_value(options: NSObject, key: string): interop.Object;
...
declare function nw_framer_parse_input(framer: NSObject, minimum_incomplete_length: number, maximum_length: number, temp_buffer: interop.PointerConvertible, parse: (p1: interop.PointerConvertible, p2: number, p3: boolean) => number): boolean;

declare function nw_framer_deliver_input(framer: NSObject, input_buffer: interop.PointerConvertible, input_length: number, message: NSObject, is_complete: boolean): void;
...
declare function nw_framer_parse_output(framer: NSObject, minimum_incomplete_length: number, maximum_length: number, temp_buffer: interop.PointerConvertible, parse: (p1: interop.PointerConvertible, p2: number, p3: boolean) => number): boolean;

declare function nw_framer_write_output(framer: NSObject, output_buffer: interop.PointerConvertible, output_length: number): void;
...
declare function nw_ip_options_set_version(options: NSObject, version: interop.Enum<typeof nw_ip_version_t>): void;
...
declare function nw_ip_options_set_local_address_preference(options: NSObject, preference: interop.Enum<typeof nw_ip_local_address_preference_t>): void;
...
declare function nw_ip_metadata_set_ecn_flag(metadata: NSObject, ecn_flag: interop.Enum<typeof nw_ip_ecn_flag_t>): void;

declare function nw_ip_metadata_get_ecn_flag(metadata: NSObject): interop.Enum<typeof nw_ip_ecn_flag_t>;

declare function nw_ip_metadata_set_service_class(metadata: NSObject, service_class: interop.Enum<typeof nw_service_class_t>): void;

declare function nw_ip_metadata_get_service_class(metadata: NSObject): interop.Enum<typeof nw_service_class_t>;
...
declare function nw_listener_create_with_launchd_key(parameters: NSObject, launchd_key: string): NSObject;
...
declare function nw_listener_set_state_changed_handler(listener: NSObject, handler: (p1: interop.Enum<typeof nw_listener_state_t>, p2: NSObject) => void): void;
...
declare function nw_path_monitor_create_with_type(required_interface_type: interop.Enum<typeof nw_interface_type_t>): NSObject;

declare function nw_path_monitor_create_for_ethernet_channel(): NSObject;

declare function nw_path_monitor_prohibit_interface_type(monitor: NSObject, interface_type: interop.Enum<typeof nw_interface_type_t>): void;
...
declare function nw_tcp_options_set_multipath_force_version(options: NSObject, multipath_force_version: interop.Enum<typeof nw_multipath_version_t>): void;
...
declare function nw_ws_create_options(version: interop.Enum<typeof nw_ws_version_t>): NSObject;
...
declare function nw_ws_create_metadata(opcode: interop.Enum<typeof nw_ws_opcode_t>): NSObject;

declare function nw_ws_metadata_get_opcode(metadata: NSObject): interop.Enum<typeof nw_ws_opcode_t>;

declare function nw_ws_metadata_set_close_code(metadata: NSObject, close_code: interop.Enum<typeof nw_ws_close_code_t>): void;

declare function nw_ws_metadata_get_close_code(metadata: NSObject): interop.Enum<typeof nw_ws_close_code_t>;
...
declare function nw_ws_response_create(status: interop.Enum<typeof nw_ws_response_status_t>, selected_subprotocol: string): NSObject;

declare function nw_ws_response_get_status(response: NSObject): interop.Enum<typeof nw_ws_response_status_t>;
...
declare class OS_nw_path extends NativeObject implements OS_nw_path {
}

declare interface OS_nw_establishment_report extends NSObjectProtocol {
}

declare class OS_nw_establishment_report extends NativeObject implements OS_nw_establishment_report {
}

declare interface OS_nw_browser extends NSObjectProtocol {
}

declare class OS_nw_browser extends NativeObject implements OS_nw_browser {
}
...
declare class OS_nw_data_transfer_report extends NativeObject implements OS_nw_data_transfer_report {
}

declare interface OS_nw_resolution_report extends NSObjectProtocol {
}

declare class OS_nw_resolution_report extends NativeObject implements OS_nw_resolution_report {
}

declare interface OS_nw_ws_response extends NSObjectProtocol {
}

declare class OS_nw_ws_response extends NativeObject implements OS_nw_ws_response {
}

declare interface OS_nw_ws_request extends NSObjectProtocol {
}

declare class OS_nw_ws_request extends NativeObject implements OS_nw_ws_request {
}

declare interface OS_nw_path_monitor extends NSObjectProtocol {
}

declare class OS_nw_path_monitor extends NativeObject implements OS_nw_path_monitor {
}

declare interface OS_nw_group_descriptor extends NSObjectProtocol {
}

declare class OS_nw_group_descriptor extends NativeObject implements OS_nw_group_descriptor {
}

declare interface OS_nw_connection extends NSObjectProtocol {
}

declare class OS_nw_connection extends NativeObject implements OS_nw_connection {
}

declare interface OS_nw_error extends NSObjectProtocol {
}

declare class OS_nw_error extends NativeObject implements OS_nw_error {
}

declare interface OS_nw_browse_descriptor extends NSObjectProtocol {
}

declare class OS_nw_browse_descriptor extends NativeObject implements OS_nw_browse_descriptor {
}

declare interface OS_nw_parameters extends NSObjectProtocol {
}

declare class OS_nw_parameters extends NativeObject implements OS_nw_parameters {
}
...
declare interface OS_nw_resolver_config extends NSObjectProtocol {
}

declare class OS_nw_resolver_config extends NativeObject implements OS_nw_resolver_config {
}

declare interface OS_nw_endpoint extends NSObjectProtocol {
}

declare class OS_nw_endpoint extends NativeObject implements OS_nw_endpoint {
}

declare interface OS_nw_interface extends NSObjectProtocol {
}

declare class OS_nw_interface extends NativeObject implements OS_nw_interface {
}

declare interface OS_nw_object extends NSObjectProtocol {
}

declare class OS_nw_object extends NativeObject implements OS_nw_object {
}

declare interface OS_nw_protocol_stack extends NSObjectProtocol {
}

declare class OS_nw_protocol_stack extends NativeObject implements OS_nw_protocol_stack {
}

declare interface OS_nw_browse_result extends NSObjectProtocol {
}

declare class OS_nw_browse_result extends NativeObject implements OS_nw_browse_result {
}

declare interface OS_nw_advertise_descriptor extends NSObjectProtocol {
}

declare class OS_nw_advertise_descriptor extends NativeObject implements OS_nw_advertise_descriptor {
}

declare interface OS_nw_privacy_context extends NSObjectProtocol {
}
...
declare class OS_nw_protocol_options extends NativeObject implements OS_nw_protocol_options {
}

declare interface OS_nw_connection_group extends NSObjectProtocol {
}

declare class OS_nw_connection_group extends NativeObject implements OS_nw_connection_group {
}

declare interface OS_nw_relay_hop extends NSObjectProtocol {
}

declare class OS_nw_relay_hop extends NativeObject implements OS_nw_relay_hop {
}

declare interface OS_nw_ethernet_channel extends NSObjectProtocol {
}
...
declare class OS_nw_protocol_definition extends NativeObject implements OS_nw_protocol_definition {
}
...
declare interface OS_nw_framer extends NSObjectProtocol {
}

declare class OS_nw_framer extends NativeObject implements OS_nw_framer {
}

declare interface OS_nw_protocol_metadata extends NSObjectProtocol {
}

declare class OS_nw_protocol_metadata extends NativeObject implements OS_nw_protocol_metadata {
}
