...
declare function CGFontCreateWithPlatformFont(platformFontReference: interop.PointerConvertible): interop.Object;
...
declare function CGPDFDocumentGetMediaBox(document: interop.Object, page: number): CGRect;

declare function CGPDFDocumentGetCropBox(document: interop.Object, page: number): CGRect;

declare function CGPDFDocumentGetBleedBox(document: interop.Object, page: number): CGRect;

declare function CGPDFDocumentGetTrimBox(document: interop.Object, page: number): CGRect;

declare function CGPDFDocumentGetArtBox(document: interop.Object, page: number): CGRect;

declare function CGPDFDocumentGetRotationAngle(document: interop.Object, page: number): number;
...
declare function CGWindowListCopyWindowInfo(option: interop.Enum<typeof CGWindowListOption>, relativeToWindow: number): interop.Object;

declare function CGWindowListCreate(option: interop.Enum<typeof CGWindowListOption>, relativeToWindow: number): interop.Object;

declare function CGWindowListCreateDescriptionFromArray(windowArray: interop.Object): interop.Object;

declare function CGWindowListCreateImage(screenBounds: CGRect, listOption: interop.Enum<typeof CGWindowListOption>, windowID: number, imageOption: interop.Enum<typeof CGWindowImageOption>): interop.Object;

declare function CGWindowListCreateImageFromArray(screenBounds: CGRect, windowArray: interop.Object, imageOption: interop.Enum<typeof CGWindowImageOption>): interop.Object;
...
declare function CGDisplayCopyAllDisplayModes(display: number, options: interop.Object): interop.Object;

declare function CGDisplayCopyDisplayMode(display: number): interop.Object;

declare function CGDisplaySetDisplayMode(display: number, mode: interop.Object, options: interop.Object): interop.Enum<typeof CGError>;

declare function CGDisplayModeGetWidth(mode: interop.Object): number;

declare function CGDisplayModeGetHeight(mode: interop.Object): number;

declare function CGDisplayModeCopyPixelEncoding(mode: interop.Object): interop.Object;

declare function CGDisplayModeGetRefreshRate(mode: interop.Object): number;

declare function CGDisplayModeGetIOFlags(mode: interop.Object): number;

declare function CGDisplayModeGetIODisplayModeID(mode: interop.Object): number;

declare function CGDisplayModeIsUsableForDesktopGUI(mode: interop.Object): boolean;

declare function CGDisplayModeGetTypeID(): number;

declare function CGDisplayModeRetain(mode: interop.Object): interop.Object;

declare function CGDisplayModeRelease(mode: interop.Object): void;

declare function CGDisplayModeGetPixelWidth(mode: interop.Object): number;

declare function CGDisplayModeGetPixelHeight(mode: interop.Object): number;
...
declare function CGDisplayCreateImage(displayID: number): interop.Object;

declare function CGDisplayCreateImageForRect(display: number, rect: CGRect): interop.Object;
...
declare function CGDisplayGetDrawingContext(display: number): interop.Object;

declare function CGDisplayAvailableModes(dsp: number): interop.Object;

declare function CGDisplayBestModeForParameters(display: number, bitsPerPixel: number, width: number, height: number, exactMatch: interop.PointerConvertible): interop.Object;

declare function CGDisplayBestModeForParametersAndRefreshRate(display: number, bitsPerPixel: number, width: number, height: number, refreshRate: number, exactMatch: interop.PointerConvertible): interop.Object;

declare function CGDisplayCurrentMode(display: number): interop.Object;

declare function CGDisplaySwitchToMode(display: number, mode: interop.Object): interop.Enum<typeof CGError>;
...
declare function CGConfigureDisplayWithDisplayMode(config: interop.PointerConvertible, display: number, mode: interop.Object, options: interop.Object): interop.Enum<typeof CGError>;
...
declare function CGDisplayCopyColorSpace(display: number): interop.Object;

declare function CGConfigureDisplayMode(config: interop.PointerConvertible, display: number, mode: interop.Object): interop.Enum<typeof CGError>;
...
declare function CGDisplayStreamUpdateGetRects(updateRef: interop.Object, rectType: interop.Enum<typeof CGDisplayStreamUpdateRectType>, rectCount: interop.PointerConvertible): interop.Pointer;

declare function CGDisplayStreamUpdateCreateMergedUpdate(firstUpdate: interop.Object, secondUpdate: interop.Object): interop.Object;

declare function CGDisplayStreamUpdateGetMovedRectsDelta(updateRef: interop.Object, dx: interop.PointerConvertible, dy: interop.PointerConvertible): void;

declare function CGDisplayStreamUpdateGetDropCount(updateRef: interop.Object): number;

declare function CGDisplayStreamGetTypeID(): number;

declare function CGDisplayStreamCreate(display: number, outputWidth: number, outputHeight: number, pixelFormat: number, properties: interop.Object, handler: (p1: interop.Enum<typeof CGDisplayStreamFrameStatus>, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): interop.Object;

declare function CGDisplayStreamCreateWithDispatchQueue(display: number, outputWidth: number, outputHeight: number, pixelFormat: number, properties: interop.Object, queue: NSObject, handler: (p1: interop.Enum<typeof CGDisplayStreamFrameStatus>, p2: number, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => void): interop.Object;

declare function CGDisplayStreamStart(displayStream: interop.Object): interop.Enum<typeof CGError>;

declare function CGDisplayStreamStop(displayStream: interop.Object): interop.Enum<typeof CGError>;

declare function CGDisplayStreamGetRunLoopSource(displayStream: interop.Object): interop.Object;
...
declare function CGWindowServerCreateServerPort(): interop.Object;
...
declare function CGWindowServerCFMachPort(): interop.Object;

declare function CGEventGetTypeID(): number;

declare function CGEventCreate(source: interop.Object): interop.Object;

declare function CGEventCreateData(allocator: interop.Object, event: interop.Object): interop.Object;

declare function CGEventCreateFromData(allocator: interop.Object, data: interop.Object): interop.Object;

declare function CGEventCreateMouseEvent(source: interop.Object, mouseType: interop.Enum<typeof CGEventType>, mouseCursorPosition: CGPoint, mouseButton: interop.Enum<typeof CGMouseButton>): interop.Object;

declare function CGEventCreateKeyboardEvent(source: interop.Object, virtualKey: number, keyDown: boolean): interop.Object;

declare function CGEventCreateScrollWheelEvent(source: interop.Object, units: interop.Enum<typeof CGScrollEventUnit>, wheelCount: number, wheel1: number): interop.Object;

declare function CGEventCreateScrollWheelEvent2(source: interop.Object, units: interop.Enum<typeof CGScrollEventUnit>, wheelCount: number, wheel1: number, wheel2: number, wheel3: number): interop.Object;

declare function CGEventCreateCopy(event: interop.Object): interop.Object;

declare function CGEventCreateSourceFromEvent(event: interop.Object): interop.Object;

declare function CGEventSetSource(event: interop.Object, source: interop.Object): void;

declare function CGEventGetType(event: interop.Object): interop.Enum<typeof CGEventType>;

declare function CGEventSetType(event: interop.Object, type: interop.Enum<typeof CGEventType>): void;

declare function CGEventGetTimestamp(event: interop.Object): number;

declare function CGEventSetTimestamp(event: interop.Object, timestamp: number): void;

declare function CGEventGetLocation(event: interop.Object): CGPoint;

declare function CGEventGetUnflippedLocation(event: interop.Object): CGPoint;

declare function CGEventSetLocation(event: interop.Object, location: CGPoint): void;

declare function CGEventGetFlags(event: interop.Object): interop.Enum<typeof CGEventFlags>;

declare function CGEventSetFlags(event: interop.Object, flags: interop.Enum<typeof CGEventFlags>): void;

declare function CGEventKeyboardGetUnicodeString(event: interop.Object, maxStringLength: number, actualStringLength: interop.PointerConvertible, unicodeString: interop.PointerConvertible): void;

declare function CGEventKeyboardSetUnicodeString(event: interop.Object, stringLength: number, unicodeString: interop.PointerConvertible): void;

declare function CGEventGetIntegerValueField(event: interop.Object, field: interop.Enum<typeof CGEventField>): number;

declare function CGEventSetIntegerValueField(event: interop.Object, field: interop.Enum<typeof CGEventField>, value: number): void;

declare function CGEventGetDoubleValueField(event: interop.Object, field: interop.Enum<typeof CGEventField>): number;

declare function CGEventSetDoubleValueField(event: interop.Object, field: interop.Enum<typeof CGEventField>, value: number): void;

declare function CGEventTapCreate(tap: interop.Enum<typeof CGEventTapLocation>, place: interop.Enum<typeof CGEventTapPlacement>, options: interop.Enum<typeof CGEventTapOptions>, eventsOfInterest: number, callback: (p1: interop.PointerConvertible, p2: interop.Enum<typeof CGEventType>, p3: interop.PointerConvertible, p4: interop.PointerConvertible) => interop.Pointer, userInfo: interop.PointerConvertible): interop.Object;
...
declare function CGEventTapEnable(tap: interop.Object, enable: boolean): void;

declare function CGEventTapIsEnabled(tap: interop.Object): boolean;

declare function CGEventTapPostEvent(proxy: interop.PointerConvertible, event: interop.Object): void;

declare function CGEventPost(tap: interop.Enum<typeof CGEventTapLocation>, event: interop.Object): void;

declare function CGEventPostToPSN(processSerialNumber: interop.PointerConvertible, event: interop.Object): void;

declare function CGEventPostToPid(pid: number, event: interop.Object): void;
...
declare function CGEventSourceCreate(stateID: interop.Enum<typeof CGEventSourceStateID>): interop.Object;

declare function CGEventSourceGetKeyboardType(source: interop.Object): number;

declare function CGEventSourceSetKeyboardType(source: interop.Object, keyboardType: number): void;

declare function CGEventSourceGetPixelsPerLine(source: interop.Object): number;

declare function CGEventSourceSetPixelsPerLine(source: interop.Object, pixelsPerLine: number): void;

declare function CGEventSourceGetSourceStateID(source: interop.Object): interop.Enum<typeof CGEventSourceStateID>;
...
declare function CGEventSourceSetUserData(source: interop.Object, userData: number): void;

declare function CGEventSourceGetUserData(source: interop.Object): number;

declare function CGEventSourceSetLocalEventsFilterDuringSuppressionState(source: interop.Object, filter: interop.Enum<typeof CGEventFilterMask>, state: interop.Enum<typeof CGEventSuppressionState>): void;

declare function CGEventSourceGetLocalEventsFilterDuringSuppressionState(source: interop.Object, state: interop.Enum<typeof CGEventSuppressionState>): interop.Enum<typeof CGEventFilterMask>;

declare function CGEventSourceSetLocalEventsSuppressionInterval(source: interop.Object, seconds: number): void;

declare function CGEventSourceGetLocalEventsSuppressionInterval(source: interop.Object): number;

declare function CGPSConverterCreate(info: interop.PointerConvertible, callbacks: interop.PointerConvertible, options: interop.Object): interop.Object;

declare function CGPSConverterConvert(converter: interop.Object, provider: interop.Object, consumer: interop.Object, options: interop.Object): boolean;

declare function CGPSConverterAbort(converter: interop.Object): boolean;

declare function CGPSConverterIsConverting(converter: interop.Object): boolean;

declare function CGPSConverterGetTypeID(): number;

declare function CGSessionCopyCurrentDictionary(): interop.Object;
