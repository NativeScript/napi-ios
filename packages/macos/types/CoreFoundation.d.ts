...
declare class CFXMLEntityInfo {
  ...
  replacementText: interop.Object | null;
  entityID: CFXMLExternalID;
  notationName: interop.Object | null;
}

declare class CFXMLDocumentInfo {
  constructor(init?: CFXMLDocumentInfo);
  sourceURL: interop.Object | null;
  encoding: number;
}

declare class CFXMLAttributeDeclarationInfo {
  constructor(init?: CFXMLAttributeDeclarationInfo);
  attributeName: interop.Object | null;
  typeString: interop.Object | null;
  defaultString: interop.Object | null;
}
...
declare class CFXMLElementTypeDeclarationInfo {
  ...
  contentDescription: interop.Object | null;
}
...
declare class CFXMLElementInfo {
  ...
  attributes: interop.Object | null;
  attributeOrder: interop.Object | null;
  isEmpty: number;
...
declare class CFXMLExternalID {
  ...
  systemID: interop.Object | null;
  publicID: interop.Object | null;
}
...
declare class CFXMLProcessingInstructionInfo {
  ...
  dataString: interop.Object | null;
}
...
declare function CFNotificationCenterGetDistributedCenter(): interop.Object;
...
declare function CFURLCreateBookmarkDataFromAliasRecord(allocatorRef: interop.Object, aliasRecordDataRef: interop.Object): interop.Object;
...
declare function CFBundleIsExecutableLoadable(bundle: interop.Object): number;

declare function CFBundleIsExecutableLoadableForURL(url: interop.Object): number;
...
declare function CFBundleOpenBundleResourceMap(bundle: interop.Object): number;

declare function CFBundleOpenBundleResourceFiles(bundle: interop.Object, refNum: interop.PointerConvertible, localizedRefNum: interop.PointerConvertible): number;

declare function CFBundleCloseBundleResourceMap(bundle: interop.Object, refNum: number): void;
...
declare function CFUserNotificationCreate(allocator: interop.Object, timeout: number, flags: number, error: interop.PointerConvertible, dictionary: interop.Object): interop.Object;

declare function CFUserNotificationReceiveResponse(userNotification: interop.Object, timeout: number, responseFlags: interop.PointerConvertible): number;

declare function CFUserNotificationGetResponseValue(userNotification: interop.Object, key: interop.Object, idx: number): interop.Object;

declare function CFUserNotificationGetResponseDictionary(userNotification: interop.Object): interop.Object;

declare function CFUserNotificationUpdate(userNotification: interop.Object, timeout: number, flags: number, dictionary: interop.Object): number;

declare function CFUserNotificationCancel(userNotification: interop.Object): number;

declare function CFUserNotificationCreateRunLoopSource(allocator: interop.Object, userNotification: interop.Object, callout: (p1: interop.PointerConvertible, p2: number) => void, order: number): interop.Object;

declare function CFUserNotificationDisplayNotice(timeout: number, flags: number, iconURL: interop.Object, soundURL: interop.Object, localizationURL: interop.Object, alertHeader: interop.Object, alertMessage: interop.Object, defaultButtonTitle: interop.Object): number;

declare function CFUserNotificationDisplayAlert(timeout: number, flags: number, iconURL: interop.Object, soundURL: interop.Object, localizationURL: interop.Object, alertHeader: interop.Object, alertMessage: interop.Object, defaultButtonTitle: interop.Object, alternateButtonTitle: interop.Object, otherButtonTitle: interop.Object, responseFlags: interop.PointerConvertible): number;

declare function CFXMLNodeGetTypeID(): number;

declare function CFXMLNodeCreate(alloc: interop.Object, xmlType: interop.Enum<typeof CFXMLNodeTypeCode>, dataString: interop.Object, additionalInfoPtr: interop.PointerConvertible, version: number): interop.Object;

declare function CFXMLNodeCreateCopy(alloc: interop.Object, origNode: interop.Object): interop.Object;

declare function CFXMLNodeGetTypeCode(node: interop.Object): interop.Enum<typeof CFXMLNodeTypeCode>;

declare function CFXMLNodeGetString(node: interop.Object): interop.Object;

declare function CFXMLNodeGetInfoPtr(node: interop.Object): interop.Pointer;

declare function CFXMLNodeGetVersion(node: interop.Object): number;

declare function CFXMLTreeCreateWithNode(allocator: interop.Object, node: interop.Object): interop.Object;

declare function CFXMLTreeGetNode(xmlTree: interop.Object): interop.Object;

declare function CFXMLParserGetTypeID(): number;

declare function CFXMLParserCreate(allocator: interop.Object, xmlData: interop.Object, dataSource: interop.Object, parseOptions: number, versionOfNodes: number, callBacks: interop.PointerConvertible, context: interop.PointerConvertible): interop.Object;

declare function CFXMLParserCreateWithDataFromURL(allocator: interop.Object, dataSource: interop.Object, parseOptions: number, versionOfNodes: number, callBacks: interop.PointerConvertible, context: interop.PointerConvertible): interop.Object;

declare function CFXMLParserGetContext(parser: interop.Object, context: interop.PointerConvertible): void;

declare function CFXMLParserGetCallBacks(parser: interop.Object, callBacks: interop.PointerConvertible): void;

declare function CFXMLParserGetSourceURL(parser: interop.Object): interop.Object;

declare function CFXMLParserGetLocation(parser: interop.Object): number;

declare function CFXMLParserGetLineNumber(parser: interop.Object): number;

declare function CFXMLParserGetDocument(parser: interop.Object): interop.Pointer;

declare function CFXMLParserGetStatusCode(parser: interop.Object): interop.Enum<typeof CFXMLParserStatusCode>;

declare function CFXMLParserCopyErrorDescription(parser: interop.Object): interop.Object;

declare function CFXMLParserAbort(parser: interop.Object, errorCode: interop.Enum<typeof CFXMLParserStatusCode>, errorDescription: interop.Object): void;

declare function CFXMLParserParse(parser: interop.Object): number;

declare function CFXMLTreeCreateFromData(allocator: interop.Object, xmlData: interop.Object, dataSource: interop.Object, parseOptions: number, versionOfNodes: number): interop.Object;

declare function CFXMLTreeCreateFromDataWithError(allocator: interop.Object, xmlData: interop.Object, dataSource: interop.Object, parseOptions: number, versionOfNodes: number, errorDict: interop.PointerConvertible): interop.Object;

declare function CFXMLTreeCreateWithDataFromURL(allocator: interop.Object, dataSource: interop.Object, parseOptions: number, versionOfNodes: number): interop.Object;

declare function CFXMLTreeCreateXMLData(allocator: interop.Object, xmlTree: interop.Object): interop.Object;

declare function CFXMLCreateStringByEscapingEntities(allocator: interop.Object, string: interop.Object, entitiesDictionary: interop.Object): interop.Object;

declare function CFXMLCreateStringByUnescapingEntities(allocator: interop.Object, string: interop.Object, entitiesDictionary: interop.Object): interop.Object;
